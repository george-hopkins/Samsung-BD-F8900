...
namespace gloox
{
  ...
  class GLOOX_API VCard
  {
    public:
       ...
       */
      void setFormattedname( const std::string& name1 ) { m_formattedname = name1; }
       ...
       */
      void setNickname( const std::string& nickname1 ) { m_nickname = nickname1; }
       ...
       * @param url The URL.
       */
      void setUrl( const std::string& url1 ) { m_url = url1; }
       ...
       */
      void setBday( const std::string& bday1 ) { m_bday = bday1; }
       ...
       */
      void setJabberid( const std::string& jabberid1 ) { m_jabberid = jabberid1; }
       ...
       */
      void setTitle( const std::string& title1 ) { m_title = title1; }
       ...
       * @param role The role.
       */
      void setRole( const std::string& role1 ) { m_role = role1; }
       ...
       * @param note The note.
       */
      void setNote( const std::string& note1 ) { m_note = note1; }
       ...
       */
      void setDesc( const std::string& desc1 ) { m_desc = desc1; }
       ...
       */
      void setMailer( const std::string& mailer1 ) { m_mailer = mailer1; }
       ...
       */
      void setRev( const std::string& rev1 ) { m_rev = rev1; }
       ...
       */
      void setUid( const std::string& uid1 ) { m_uid = uid1; }
       ...
       */
      void setTz( const std::string& tz1 ) { m_tz = tz1; }
       ...
       */
      void setProdid( const std::string& prodid1 ) { m_prodid = prodid1; }
       ...
       */
      void setSortstring( const std::string& sortstring1 ) { m_sortstring = sortstring1; }
