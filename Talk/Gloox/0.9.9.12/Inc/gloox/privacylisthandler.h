...
namespace gloox
{
  ...
  enum PrivacyListResult
  {
    ...
    ResultBlockSuccess,       		/**< Blocking was requested successfully. */
    ResultUnsetBlockSuccess,		/**< unBlocking was requested successfully. */
  ...
  class GLOOX_API PrivacyListHandler
  {
    public:
	  ...
	  virtual void handleBlockList( const StringList& lists ) = 0;
