...
namespace gloox
{
  ...
  class GLOOX_API Tag
  {
    public:
       ...
       * @since 0.9
       */
      virtual void setAttributes( const AttributeList& attributes1 ) { m_attribs = attributes1; }
       ...
       */
      virtual void setCData( const std::string& cdata1 )
        { m_cdata = m_incoming ? relax( cdata1 ) : cdata1; }

      /**
       * Adds the string to the existing XML character data for this Tag.
       * @param cdata The additional cdata.
       */
      virtual void addCData( const std::string& cdata1 )
        { m_cdata += m_incoming ? relax( cdata1 ) : cdata1; }
       ...
       */
      virtual inline bool hasChild( const std::string& name1, const std::string& attr = "",
                                    const std::string& value = "" ) const
        { return findChild( name1, attr, value ) ? true : false; }
