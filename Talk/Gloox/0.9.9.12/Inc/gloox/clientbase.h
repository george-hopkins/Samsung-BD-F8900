...
namespace gloox
{
                               ...
                               public CompressionDataHandler, public TLSHandler
  {
    ...
    public:
       ...
       */
      void setSasl( bool sasl1 ) { m_sasl = sasl1; }
       ...
       */
      GLOOX_DEPRECATED void setTls( bool tls1 ) { m_tls = (TLSPolicy)tls1; }
       ...
       */
      void setTls( TLSPolicy tls1 ) { m_tls = tls1; }
       ...
       */
      void setCompression( bool compression1 ) { m_compress = compression1; }
       ...
       */
      void setPort( int port1 ) { m_port = port1; }
       ...
       */
      void setPassword( const std::string &password1 ) { m_password = password1; }
    ...
    protected:
      ...
      void header();
      void setAuthed( bool authed1 ) { m_authed = authed1; }
