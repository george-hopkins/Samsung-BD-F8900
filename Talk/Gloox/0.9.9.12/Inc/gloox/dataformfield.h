...
namespace gloox
{
  ...
  class GLOOX_API DataFormField
  {
    public:
       ...
       */
      virtual void setName( const std::string& name1 ) { m_name = name1; }
       ...
       */
      virtual void setOptions( const StringMap& options1 ) { m_options = options1; }
       ...
       * @since 0.9.4
       */
      virtual void addOption( const std::string& label1, const std::string& value1 )
        { m_options.insert( std::make_pair( label1, value1 ) ); }
       ...
       */
      virtual void setRequired( bool required1 ) { m_required = required1; }
       ...
       */
      virtual void setLabel( const std::string& label1 ) { m_label = label1; }
       ...
       */
      virtual void setValue( const std::string& value1 ) { m_values.clear(); addValue( value1 ); }
       ...
       */
      virtual void setValues( const StringList& values1 ) { m_values = values1; }

      /**
       * Adds a single value to the list of values.
       * @param value The value to add.
       */
      virtual void addValue( const std::string& value1 ) { m_values.push_back( value1 ); }
