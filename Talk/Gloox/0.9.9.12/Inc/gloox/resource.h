  ...
  class GLOOX_API Resource
  {
    ...
    public:
      /**
        ...
        */
      Resource( int priority1, const std::string& msg, Presence presence1 )
        : m_priority( priority1 ), m_message( msg ), m_presence( presence1 ) {}
    ...
    private:
      void setPriority( int priority1 ) { m_priority = priority1; }
      void setMessage( std::string message1 ) { m_message = message1; }
      void setStatus( Presence presence1 ) { m_presence = presence1; }
