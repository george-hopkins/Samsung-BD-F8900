...
retry:
	...
	if (super->s_inodes_count < EXT2_FIRST_INODE(super)+1)
	  ...
	  /* 
	   * If number of default inodes is greater than 150000, 
	   * set the count to 150000 to avoid unnecessary checking
	   * in e2fsck even though the inodes were not used
	   */
        if(super->s_inodes_count > 150000 ) {
                printf("Default Inode count : %u,"
                       " Changed to 150000 \n", super->s_inodes_count);
                super->s_inodes_count = 150000;
        }
