...
#ifdef CONFIG_INFINITE_OOPS_DISPLAY

/* do_dtvlog() shoudn't be invoked : See do_dtvlog(5,NULL,0);*/
#undef CONFIG_DTVLOGD 
	...
	while(1)
	{
		...
		/* notice : while loop isn't closed */
#endif
	...
	spin_unlock_irq(&die_lock);
		...
		mdelay(1000 * 60 * 3); /* Delay : 3 minute */

		/* In while loop, die_counter shouldn't be increased */
		die_counter--;  
