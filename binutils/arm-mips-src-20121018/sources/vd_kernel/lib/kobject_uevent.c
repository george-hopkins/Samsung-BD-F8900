...
static const char *kobject_actions[] = {
 ...
 //kks
        ...
        [KOBJ_UMOUNT] = "umount",
 //   //hongyabi
        [KOBJ_USB_SIC_ADD] = "still_image_add",
        [KOBJ_USB_SIC_REMOVE] = "still_image_remove",
#endif
};
		       ...
		       char *envp_ext[])
{
	...
	**********************************************************************/
	...
	(strstr(devpath, "net/rausb") == NULL ) && 
	(strstr(devpath, "net/ra11n") == NULL ) &&
	(strstr(devpath, "bt_usb") == NULL ) && 
	(strstr(devpath, "csr_usb") == NULL ) && 
	strcmp(action_string, "still_image_add") && 
	strcmp(action_string, "still_image_remove")))
	{
