...
addr = ((PhyBase << GmiiDevShift) & GmiiDevMask) | ((RegOffset << GmiiRegShift) & GmiiRegMask) | s32MDC_CLOCK;
...
// jay hsu : set ahb clock by auto detect function @ 20100329
addr = ((PhyBase << GmiiDevShift) & GmiiDevMask) | ((RegOffset << GmiiRegShift) & GmiiRegMask) | GmiiWrite | s32MDC_CLOCK;
