		...
		unsigned int, flags)
{
	...
	strlcpy(last_unloaded_module, mod->name, sizeof(last_unloaded_module));
       ...
       if( mod->srcversion !=  NULL ){
               printk( KERN_EMERG "[VDLP] %s module unload!!(%s)\n", mod->name, mod->srcversion);
	}
       else{
               printk( KERN_EMERG "[VDLP] %s module unload!! (srcversion is NULL!)\n", mod->name );
	}
       printk( KERN_EMERG "====================================================================\n");
#endif
	free_module(mod);
...
"%s: loading module anyway...\n",
	...
	mutex_lock(&module_mutex);
       ...
       printk( KERN_EMERG "====================================================================\n");
       if( mod->srcversion !=  NULL ){
               printk( KERN_EMERG "[VDLP] %s module load!!(%s)\n", mod->name, mod->srcversion);
	}
       else{
               printk( KERN_EMERG "[VDLP] %s module load!! (srcversion is NULL!)\n", mod->name );
	}
       printk( KERN_EMERG "====================================================================\n");
#endif
