...
static const struct cl_enum_arg cl_enum_sched_pressure_algorithm_data[] = 
{
  { "model", SCHED_PRESSURE_MODEL, 0 },
  { "weighted", SCHED_PRESSURE_WEIGHTED, 0 },
  { NULL, 0, 0 }
};

static void
cl_enum_sched_pressure_algorithm_set (void *var, int value)
{
  *((enum sched_pressure_algorithm *) var) = (enum sched_pressure_algorithm) value;
}

static int
cl_enum_sched_pressure_algorithm_get (const void *var)
{
  return (int) *((const enum sched_pressure_algorithm *) var);
}
...
const struct cl_enum cl_enums[] =
{
  ...
  {
    NULL,
    "unknown %<fsched-pressure%> algorithm %qs",
    cl_enum_sched_pressure_algorithm_data,
    sizeof (enum sched_pressure_algorithm),
    cl_enum_sched_pressure_algorithm_set,
    cl_enum_sched_pressure_algorithm_get
  },
  {
    NULL,
...
const struct gcc_options global_options_init =
{
  ...
  SCHED_PRESSURE_WEIGHTED, /* flag_sched_pressure_algorithm */
...
const struct cl_option cl_options[] =
{
  ...
  { "-Wglobal-constructors",
    "Warn about uses of global constructors (static initializations).",
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 227,
    CL_COMMON | CL_WARNING,
    offsetof (struct gcc_options, x_warn_global_constructors), 0, CLVC_BOOLEAN, 0 },
  { "-Whiding",
    0,
    0,
    0,
  ...
  { "-fsched-pressure-algorithm=",
    ...
    CL_COMMON | CL_JOINED | CL_REJECT_NEGATIVE,
    offsetof (struct gcc_options, x_flag_sched_pressure_algorithm), 5, CLVC_ENUM, 0 },
