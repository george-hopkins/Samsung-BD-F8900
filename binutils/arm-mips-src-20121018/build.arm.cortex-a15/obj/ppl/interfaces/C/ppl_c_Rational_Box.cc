...
(ppl_const_Rational_Box_t pset) try {
  const Rational_Box& ppset
    = *static_cast<const Rational_Box*>(to_const(pset));
...
(ppl_const_Rational_Box_t pset_before, ppl_const_Rational_Box_t pset_after) try {
  const Rational_Box& ppset_before
    = *static_cast<const Rational_Box*>(to_const(pset_before));
  const Rational_Box& ppset_after
    = *static_cast<const Rational_Box*>(to_const(pset_after));
...
(ppl_const_Rational_Box_t pset_before,
