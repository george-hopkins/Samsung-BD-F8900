/* C Octagonal_Shape_mpz_class interface code: definitions.
...
int
ppl_delete_Octagonal_Shape_mpz_class(ppl_const_Octagonal_Shape_mpz_class_t ph) try {
  delete to_const(ph);
  return 0;
}
CATCH_ALL
...
(ppl_Octagonal_Shape_mpz_class_t* pph,
 ppl_dimension_type d,
 int empty) try {
  *pph = to_nonconst(new Octagonal_Shape<mpz_class>(d, empty ? EMPTY : UNIVERSE));
  return 0;
}
CATCH_ALL
...
(ppl_Octagonal_Shape_mpz_class_t* pph,
  ...
  *pph = to_nonconst(new Octagonal_Shape<mpz_class>(phh));
  return 0;
}
CATCH_ALL
...
(ppl_Octagonal_Shape_mpz_class_t* pph,
 ...
 int complexity) try {
  ...
  switch (complexity) {
  case 0:
    *pph = to_nonconst(new Octagonal_Shape<mpz_class>(phh, POLYNOMIAL_COMPLEXITY));
    break;
  case 1:
    *pph = to_nonconst(new Octagonal_Shape<mpz_class>(phh, SIMPLEX_COMPLEXITY));
    break;
  case 2:
    *pph = to_nonconst(new Octagonal_Shape<mpz_class>(phh, ANY_COMPLEXITY));
    break;
  }
  return 0;
}
...
(ppl_Octagonal_Shape_mpz_class_t* pph, ppl_const_Constraint_System_t cs) try {
  const Constraint_System& ccs = *to_const(cs);
  *pph = to_nonconst(new Octagonal_Shape<mpz_class>(ccs));
  return 0;
}
CATCH_ALL
...
(ppl_Octagonal_Shape_mpz_class_t* pph, ppl_const_Congruence_System_t cs) try {
...
(ppl_Octagonal_Shape_mpz_class_t* pph, ppl_const_Generator_System_t cs) try {
...
(ppl_const_Octagonal_Shape_mpz_class_t ph,
 ppl_const_Constraint_t c) try {
  const Octagonal_Shape<mpz_class>& pph = *to_const(ph);
...
int
ppl_Octagonal_Shape_mpz_class_is_empty(ppl_const_Octagonal_Shape_mpz_class_t ph) try {
  const Octagonal_Shape<mpz_class>& pph = *to_const(ph);
...
int
ppl_Octagonal_Shape_mpz_class_is_universe(ppl_const_Octagonal_Shape_mpz_class_t ph) try {
  const Octagonal_Shape<mpz_class>& pph = *to_const(ph);
...
int
ppl_Octagonal_Shape_mpz_class_is_bounded(ppl_const_Octagonal_Shape_mpz_class_t ph) try {
  const Octagonal_Shape<mpz_class>& pph = *to_const(ph);
...
int
ppl_Octagonal_Shape_mpz_class_contains_integer_point(ppl_const_Octagonal_Shape_mpz_class_t ph) try {
  const Octagonal_Shape<mpz_class>& pph = *to_const(ph);
...
int
ppl_Octagonal_Shape_mpz_class_is_topologically_closed(ppl_const_Octagonal_Shape_mpz_class_t ph) try {
  const Octagonal_Shape<mpz_class>& pph = *to_const(ph);
...
int
ppl_Octagonal_Shape_mpz_class_is_discrete(ppl_const_Octagonal_Shape_mpz_class_t ph) try {
  const Octagonal_Shape<mpz_class>& pph = *to_const(ph);
...
int
ppl_Octagonal_Shape_mpz_class_topological_closure_assign(ppl_Octagonal_Shape_mpz_class_t ph) try {
  Octagonal_Shape<mpz_class>& pph = *to_nonconst(ph);
...
(ppl_const_Octagonal_Shape_mpz_class_t x,
 ppl_const_Octagonal_Shape_mpz_class_t y) try {
  const Octagonal_Shape<mpz_class>& xx = *to_const(x);
  const Octagonal_Shape<mpz_class>& yy = *to_const(y);
...
int
ppl_Octagonal_Shape_mpz_class_OK(ppl_const_Octagonal_Shape_mpz_class_t ph) try {
...
(ppl_Octagonal_Shape_mpz_class_t x,
 ppl_const_Octagonal_Shape_mpz_class_t y) try {
  Octagonal_Shape<mpz_class>& xx = *to_nonconst(x);
  const Octagonal_Shape<mpz_class>& yy = *to_const(y);
...
(ppl_const_Octagonal_Shape_mpz_class_t ps,
 size_t* sz) try {
...
(ppl_Octagonal_Shape_mpz_class_t x,
 ppl_const_Octagonal_Shape_mpz_class_t y) try {
  return ppl_Octagonal_Shape_mpz_class_BHMZ05_widening_assign_with_tokens(x, y, 0);
}
CATCH_ALL
...
(ppl_Octagonal_Shape_mpz_class_t x,
 ppl_const_Octagonal_Shape_mpz_class_t y) try {
  return ppl_Octagonal_Shape_mpz_class_widening_assign_with_tokens(x, y, 0);
}
CATCH_ALL
...
(ppl_const_Octagonal_Shape_mpz_class_t x,
 ...
 ppl_Pointset_Powerset_NNC_Polyhedron_t* p_rest) try {
    const Octagonal_Shape<mpz_class>& xx
      = static_cast<const Octagonal_Shape<mpz_class>&>(*to_const(x));
    const Octagonal_Shape<mpz_class>& yy
      = static_cast<const Octagonal_Shape<mpz_class>&>(*to_const(y));
...
(ppl_Octagonal_Shape_mpz_class_t* pph, ppl_Constraint_System_t cs) try {
...
(ppl_Octagonal_Shape_mpz_class_t* pph, ppl_Congruence_System_t cs) try {
...
(ppl_Octagonal_Shape_mpz_class_t* pph, ppl_Generator_System_t cs) try {
...
(ppl_Octagonal_Shape_mpz_class_t dst,
 ppl_const_Octagonal_Shape_mpz_class_t src) try {
  const Octagonal_Shape<mpz_class>& ssrc
    = *static_cast<const Octagonal_Shape<mpz_class>*>(to_const(src));
  Octagonal_Shape<mpz_class>& ddst
    = *static_cast<Octagonal_Shape<mpz_class>*>(to_nonconst(dst));
  ddst = ssrc;
  return 0;
}
CATCH_ALL
...
(ppl_const_Octagonal_Shape_mpz_class_t pset) try {
  const Octagonal_Shape<mpz_class>& ppset
    = *static_cast<const Octagonal_Shape<mpz_class>*>(to_const(pset));
...
(ppl_const_Octagonal_Shape_mpz_class_t pset_before, ppl_const_Octagonal_Shape_mpz_class_t pset_after) try {
  const Octagonal_Shape<mpz_class>& ppset_before
    = *static_cast<const Octagonal_Shape<mpz_class>*>(to_const(pset_before));
  const Octagonal_Shape<mpz_class>& ppset_after
    = *static_cast<const Octagonal_Shape<mpz_class>*>(to_const(pset_after));
...
(ppl_const_Octagonal_Shape_mpz_class_t pset_before,
...
DEFINE_OUTPUT_FUNCTIONS(Octagonal_Shape_mpz_class)
