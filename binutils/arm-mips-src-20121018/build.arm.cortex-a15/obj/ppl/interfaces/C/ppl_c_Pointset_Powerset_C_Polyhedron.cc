/* C Pointset_Powerset_C_Polyhedron interface code: definitions.
...
typedef Pointset_Powerset<C_Polyhedron>::iterator
        Pointset_Powerset_C_Polyhedron_iterator;
typedef Pointset_Powerset<C_Polyhedron>::const_iterator
        Pointset_Powerset_C_Polyhedron_const_iterator;

DECLARE_CONVERSIONS(Pointset_Powerset_C_Polyhedron_iterator,
                    Pointset_Powerset_C_Polyhedron_iterator)
DECLARE_CONVERSIONS(Pointset_Powerset_C_Polyhedron_const_iterator,
                    Pointset_Powerset_C_Polyhedron_const_iterator)

int
ppl_new_Pointset_Powerset_C_Polyhedron_iterator
(ppl_Pointset_Powerset_C_Polyhedron_iterator_t* pit) try {
  *pit = to_nonconst(new Pointset_Powerset_C_Polyhedron_iterator());
  return 0;
}
CATCH_ALL
...
(ppl_Pointset_Powerset_C_Polyhedron_const_iterator_t* pit) try {
  *pit = to_nonconst(new Pointset_Powerset_C_Polyhedron_const_iterator());
  return 0;
}
CATCH_ALL
...
int
ppl_delete_Pointset_Powerset_C_Polyhedron(ppl_const_Pointset_Powerset_C_Polyhedron_t ph) try {
  delete to_const(ph);
  return 0;
}
CATCH_ALL
...
(ppl_Pointset_Powerset_C_Polyhedron_t* pph,
 ...
 int empty) try {
  *pph = to_nonconst(new Pointset_Powerset<C_Polyhedron>(d, empty ? EMPTY : UNIVERSE));
  return 0;
}
CATCH_ALL
...
(ppl_Pointset_Powerset_C_Polyhedron_t* pph,
 ppl_const_Pointset_Powerset_C_Polyhedron_t ph) try {
  const Pointset_Powerset<C_Polyhedron>& phh
    = *static_cast<const Pointset_Powerset<C_Polyhedron>*>(to_const(ph));
  *pph = to_nonconst(new Pointset_Powerset<C_Polyhedron>(phh));
  return 0;
}
CATCH_ALL
...
(ppl_Pointset_Powerset_C_Polyhedron_t* pph,
 ...
 int complexity) try {
  ...
  switch (complexity) {
  case 0:
    *pph = to_nonconst(new Pointset_Powerset<C_Polyhedron>(phh, POLYNOMIAL_COMPLEXITY));
    break;
  case 1:
    *pph = to_nonconst(new Pointset_Powerset<C_Polyhedron>(phh, SIMPLEX_COMPLEXITY));
    break;
  case 2:
    *pph = to_nonconst(new Pointset_Powerset<C_Polyhedron>(phh, ANY_COMPLEXITY));
    break;
  }
  return 0;
}
...
(ppl_Pointset_Powerset_C_Polyhedron_t* pph, ppl_const_Constraint_System_t cs) try {
  const Constraint_System& ccs = *to_const(cs);
  *pph = to_nonconst(new Pointset_Powerset<C_Polyhedron>(ccs));
  return 0;
}
CATCH_ALL
...
(ppl_Pointset_Powerset_C_Polyhedron_t* pph, ppl_const_Congruence_System_t cs) try {
...
(ppl_const_Pointset_Powerset_C_Polyhedron_t ph,
 ppl_const_Constraint_t c) try {
  const Pointset_Powerset<C_Polyhedron>& pph = *to_const(ph);
...
int
ppl_Pointset_Powerset_C_Polyhedron_is_empty(ppl_const_Pointset_Powerset_C_Polyhedron_t ph) try {
  const Pointset_Powerset<C_Polyhedron>& pph = *to_const(ph);
...
int
ppl_Pointset_Powerset_C_Polyhedron_is_universe(ppl_const_Pointset_Powerset_C_Polyhedron_t ph) try {
  const Pointset_Powerset<C_Polyhedron>& pph = *to_const(ph);
...
int
ppl_Pointset_Powerset_C_Polyhedron_is_bounded(ppl_const_Pointset_Powerset_C_Polyhedron_t ph) try {
  const Pointset_Powerset<C_Polyhedron>& pph = *to_const(ph);
...
int
ppl_Pointset_Powerset_C_Polyhedron_contains_integer_point(ppl_const_Pointset_Powerset_C_Polyhedron_t ph) try {
  const Pointset_Powerset<C_Polyhedron>& pph = *to_const(ph);
...
int
ppl_Pointset_Powerset_C_Polyhedron_is_topologically_closed(ppl_const_Pointset_Powerset_C_Polyhedron_t ph) try {
  const Pointset_Powerset<C_Polyhedron>& pph = *to_const(ph);
...
int
ppl_Pointset_Powerset_C_Polyhedron_is_discrete(ppl_const_Pointset_Powerset_C_Polyhedron_t ph) try {
  const Pointset_Powerset<C_Polyhedron>& pph = *to_const(ph);
...
int
ppl_Pointset_Powerset_C_Polyhedron_topological_closure_assign(ppl_Pointset_Powerset_C_Polyhedron_t ph) try {
  Pointset_Powerset<C_Polyhedron>& pph = *to_nonconst(ph);
...
int
ppl_Pointset_Powerset_C_Polyhedron_pairwise_reduce(ppl_Pointset_Powerset_C_Polyhedron_t ph) try {
  Pointset_Powerset<C_Polyhedron>& pph = *to_nonconst(ph);
  pph.pairwise_reduce();
  return 0;
}
...
int
ppl_Pointset_Powerset_C_Polyhedron_omega_reduce(ppl_Pointset_Powerset_C_Polyhedron_t ph) try {
  Pointset_Powerset<C_Polyhedron>& pph = *to_nonconst(ph);
  pph.omega_reduce();
  return 0;
}
...
(ppl_const_Pointset_Powerset_C_Polyhedron_t x,
 ppl_const_Pointset_Powerset_C_Polyhedron_t y) try {
  const Pointset_Powerset<C_Polyhedron>& xx = *to_const(x);
  const Pointset_Powerset<C_Polyhedron>& yy = *to_const(y);
...
int
ppl_Pointset_Powerset_C_Polyhedron_OK(ppl_const_Pointset_Powerset_C_Polyhedron_t ph) try {
...
(ppl_Pointset_Powerset_C_Polyhedron_t x,
 ppl_const_Pointset_Powerset_C_Polyhedron_t y) try {
  Pointset_Powerset<C_Polyhedron>& xx = *to_nonconst(x);
  const Pointset_Powerset<C_Polyhedron>& yy = *to_const(y);
...
(ppl_Pointset_Powerset_C_Polyhedron_iterator_t* px, ppl_const_Pointset_Powerset_C_Polyhedron_iterator_t y) try {
  const Pointset_Powerset_C_Polyhedron_iterator& yy
    = *static_cast<const Pointset_Powerset_C_Polyhedron_iterator*>(to_const(y));
  *px = to_nonconst(new Pointset_Powerset_C_Polyhedron_iterator(yy));
  return 0;
}
CATCH_ALL
...
(ppl_Pointset_Powerset_C_Polyhedron_const_iterator_t* px,
 ppl_const_Pointset_Powerset_C_Polyhedron_const_iterator_t y) try {
  const Pointset_Powerset_C_Polyhedron_const_iterator& yy
    = *static_cast<const Pointset_Powerset_C_Polyhedron_const_iterator*>(to_const(y));
  *px = to_nonconst(new Pointset_Powerset_C_Polyhedron_const_iterator(yy));
  return 0;
}
CATCH_ALL
...
(ppl_Pointset_Powerset_C_Polyhedron_t ps,
 ppl_Pointset_Powerset_C_Polyhedron_iterator_t psit) try {
  Pointset_Powerset<C_Polyhedron>::iterator& ppsit = *to_nonconst(psit);
...
(ppl_const_Pointset_Powerset_C_Polyhedron_t ps,
 ppl_Pointset_Powerset_C_Polyhedron_const_iterator_t psit) try {
  Pointset_Powerset<C_Polyhedron>::const_iterator& ppsit = *to_nonconst(psit);
...
(ppl_const_Pointset_Powerset_C_Polyhedron_iterator_t x,
 ppl_const_Pointset_Powerset_C_Polyhedron_iterator_t y) try {
...
(ppl_Pointset_Powerset_C_Polyhedron_iterator_t it)
  try {
    Pointset_Powerset<C_Polyhedron>::iterator& iit = *to_nonconst(it);
    ++iit;
    return 0;
}
CATCH_ALL
...
(ppl_Pointset_Powerset_C_Polyhedron_const_iterator_t it)
  try {
    Pointset_Powerset<C_Polyhedron>::const_iterator& iit = *to_nonconst(it);
    ++iit;
    return 0;
}
CATCH_ALL
...
(ppl_const_Pointset_Powerset_C_Polyhedron_iterator_t psit,
 ppl_const_Polyhedron_t* cd) try {
   const Pointset_Powerset<C_Polyhedron>::iterator& cpsit = *to_const(psit);
   const C_Polyhedron& d = cpsit->pointset();
   *cd = to_const(&d);
   return 0;
}
CATCH_ALL
...
(ppl_const_Pointset_Powerset_C_Polyhedron_const_iterator_t psit,
 ppl_const_Polyhedron_t* cd) try {
   const Pointset_Powerset<C_Polyhedron>::const_iterator& cpsit = *to_const(psit);
   const C_Polyhedron& d = cpsit->pointset();
   *cd = to_const(&d);
   return 0;
}
...
(ppl_Pointset_Powerset_C_Polyhedron_t ps,
 ppl_const_Polyhedron_t d) try {
  Pointset_Powerset<C_Polyhedron>& pps = *to_nonconst(ps);
  const C_Polyhedron& dd
     = *static_cast<const C_Polyhedron*>(to_const(d));
  pps.add_disjunct(dd);
  return 0;
}
CATCH_ALL
...
(ppl_Pointset_Powerset_C_Polyhedron_t ps,
 ...
 ppl_Pointset_Powerset_C_Polyhedron_iterator_t it) try {
  Pointset_Powerset<C_Polyhedron>& pps = *to_nonconst(ps);
  const Pointset_Powerset<C_Polyhedron>::iterator& ccit = *to_const(cit);
  Pointset_Powerset<C_Polyhedron>::iterator& iit = *to_nonconst(it);
...
(ppl_Pointset_Powerset_C_Polyhedron_t ps,
 ...
 ppl_const_Pointset_Powerset_C_Polyhedron_iterator_t last) try {
  Pointset_Powerset<C_Polyhedron>& pps = *to_nonconst(ps);
  const Pointset_Powerset<C_Polyhedron>::iterator& ffirst = *to_const(first);
  const Pointset_Powerset<C_Polyhedron>::iterator& llast = *to_const(last);
...
(ppl_Pointset_Powerset_C_Polyhedron_t x,
 ppl_const_Pointset_Powerset_C_Polyhedron_t y) try {
  ...
  xx.BHZ03_widening_assign<BHRZ03_Certificate>(yy,
       widen_fun_ref(
         &C_Polyhedron::BHRZ03_widening_assign));
  return 0;
}
CATCH_ALL
...
(ppl_Pointset_Powerset_C_Polyhedron_t x,
 ppl_const_Pointset_Powerset_C_Polyhedron_t y) try {
  ...
  xx.BHZ03_widening_assign<H79_Certificate>(yy,
       widen_fun_ref(
         &C_Polyhedron::H79_widening_assign));
  return 0;
}
CATCH_ALL
...
DEFINE_OUTPUT_FUNCTIONS(Pointset_Powerset_C_Polyhedron)
