/* C Double_Box interface code: definitions.
...
int
ppl_delete_Double_Box(ppl_const_Double_Box_t ph) try {
  delete to_const(ph);
  return 0;
}
CATCH_ALL
...
(ppl_Double_Box_t* pph,
 ppl_dimension_type d,
 int empty) try {
  *pph = to_nonconst(new Double_Box(d, empty ? EMPTY : UNIVERSE));
  return 0;
}
CATCH_ALL
...
(ppl_Double_Box_t* pph,
  ...
  *pph = to_nonconst(new Double_Box(phh));
  return 0;
}
CATCH_ALL
...
(ppl_Double_Box_t* pph,
 ...
 int complexity) try {
  ...
  switch (complexity) {
  case 0:
    *pph = to_nonconst(new Double_Box(phh, POLYNOMIAL_COMPLEXITY));
    break;
  case 1:
    *pph = to_nonconst(new Double_Box(phh, SIMPLEX_COMPLEXITY));
    break;
  case 2:
    *pph = to_nonconst(new Double_Box(phh, ANY_COMPLEXITY));
    break;
  }
  return 0;
}
...
(ppl_Double_Box_t* pph, ppl_const_Constraint_System_t cs) try {
  const Constraint_System& ccs = *to_const(cs);
  *pph = to_nonconst(new Double_Box(ccs));
  return 0;
}
CATCH_ALL
...
(ppl_Double_Box_t* pph, ppl_const_Congruence_System_t cs) try {
...
(ppl_Double_Box_t* pph, ppl_const_Generator_System_t cs) try {
...
(ppl_const_Double_Box_t ph,
 ppl_const_Constraint_t c) try {
  const Double_Box& pph = *to_const(ph);
...
int
ppl_Double_Box_is_empty(ppl_const_Double_Box_t ph) try {
  const Double_Box& pph = *to_const(ph);
...
int
ppl_Double_Box_is_universe(ppl_const_Double_Box_t ph) try {
  const Double_Box& pph = *to_const(ph);
...
int
ppl_Double_Box_is_bounded(ppl_const_Double_Box_t ph) try {
  const Double_Box& pph = *to_const(ph);
...
int
ppl_Double_Box_contains_integer_point(ppl_const_Double_Box_t ph) try {
  const Double_Box& pph = *to_const(ph);
...
int
ppl_Double_Box_is_topologically_closed(ppl_const_Double_Box_t ph) try {
  const Double_Box& pph = *to_const(ph);
...
int
ppl_Double_Box_is_discrete(ppl_const_Double_Box_t ph) try {
  const Double_Box& pph = *to_const(ph);
...
int
ppl_Double_Box_topological_closure_assign(ppl_Double_Box_t ph) try {
  Double_Box& pph = *to_nonconst(ph);
...
(ppl_const_Double_Box_t x,
 ppl_const_Double_Box_t y) try {
  const Double_Box& xx = *to_const(x);
  const Double_Box& yy = *to_const(y);
...
int
ppl_Double_Box_OK(ppl_const_Double_Box_t ph) try {
...
(ppl_Double_Box_t x,
 ppl_const_Double_Box_t y) try {
  return ppl_Double_Box_CC76_widening_assign_with_tokens(x, y, 0);
}
CATCH_ALL
...
(ppl_Double_Box_t x,
 ppl_const_Double_Box_t y) try {
  return ppl_Double_Box_widening_assign_with_tokens(x, y, 0);
}
CATCH_ALL
...
(ppl_const_Double_Box_t x,
 ...
 ppl_Pointset_Powerset_NNC_Polyhedron_t* p_rest) try {
    const Double_Box& xx
      = static_cast<const Double_Box&>(*to_const(x));
    const Double_Box& yy
      = static_cast<const Double_Box&>(*to_const(y));
...
(ppl_Double_Box_t* pph, ppl_Constraint_System_t cs) try {
...
(ppl_Double_Box_t* pph, ppl_Congruence_System_t cs) try {
...
(ppl_Double_Box_t* pph, ppl_Generator_System_t cs) try {
...
(ppl_Double_Box_t dst,
 ppl_const_Double_Box_t src) try {
  const Double_Box& ssrc
    = *static_cast<const Double_Box*>(to_const(src));
  Double_Box& ddst
    = *static_cast<Double_Box*>(to_nonconst(dst));
  ddst = ssrc;
  return 0;
}
CATCH_ALL
...
(ppl_const_Double_Box_t pset) try {
  const Double_Box& ppset
    = *static_cast<const Double_Box*>(to_const(pset));
...
(ppl_const_Double_Box_t pset_before, ppl_const_Double_Box_t pset_after) try {
  const Double_Box& ppset_before
    = *static_cast<const Double_Box*>(to_const(pset_before));
  const Double_Box& ppset_after
    = *static_cast<const Double_Box*>(to_const(pset_after));
...
(ppl_const_Double_Box_t pset_before,
...
DEFINE_OUTPUT_FUNCTIONS(Double_Box)
