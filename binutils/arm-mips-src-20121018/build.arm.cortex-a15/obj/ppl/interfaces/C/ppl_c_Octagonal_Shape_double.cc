...
(ppl_const_Octagonal_Shape_double_t pset) try {
  const Octagonal_Shape<double>& ppset
    = *static_cast<const Octagonal_Shape<double>*>(to_const(pset));
...
(ppl_const_Octagonal_Shape_double_t pset_before, ppl_const_Octagonal_Shape_double_t pset_after) try {
  const Octagonal_Shape<double>& ppset_before
    = *static_cast<const Octagonal_Shape<double>*>(to_const(pset_before));
  const Octagonal_Shape<double>& ppset_after
    = *static_cast<const Octagonal_Shape<double>*>(to_const(pset_after));
...
(ppl_const_Octagonal_Shape_double_t pset_before,
