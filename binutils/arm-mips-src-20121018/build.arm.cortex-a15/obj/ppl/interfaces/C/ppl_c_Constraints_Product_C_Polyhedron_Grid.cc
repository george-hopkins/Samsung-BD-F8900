/* C Constraints_Product_C_Polyhedron_Grid interface code: definitions.
...
int
ppl_delete_Constraints_Product_C_Polyhedron_Grid(ppl_const_Constraints_Product_C_Polyhedron_Grid_t ph) try {
  delete to_const(ph);
  return 0;
}
CATCH_ALL
...
(ppl_Constraints_Product_C_Polyhedron_Grid_t* pph,
 ppl_dimension_type d,
 int empty) try {
  *pph = to_nonconst(new Domain_Product<C_Polyhedron,Grid >::Constraints_Product(d, empty ? EMPTY : UNIVERSE));
  return 0;
}
CATCH_ALL
...
(ppl_Constraints_Product_C_Polyhedron_Grid_t* pph,
  ...
  *pph = to_nonconst(new Domain_Product<C_Polyhedron,Grid >::Constraints_Product(phh));
  return 0;
}
CATCH_ALL
...
(ppl_Constraints_Product_C_Polyhedron_Grid_t* pph,
 ppl_const_Constraints_Product_C_Polyhedron_Grid_t ph) try {
  const Domain_Product<C_Polyhedron,Grid >::Constraints_Product& phh
    = *static_cast<const Domain_Product<C_Polyhedron,Grid >::Constraints_Product*>(to_const(ph));
  *pph = to_nonconst(new Domain_Product<C_Polyhedron,Grid >::Constraints_Product(phh));
  return 0;
}
CATCH_ALL
...
(ppl_Constraints_Product_C_Polyhedron_Grid_t* pph,
 ...
 int complexity) try {
  ...
  switch (complexity) {
  case 0:
    *pph = to_nonconst(new Domain_Product<C_Polyhedron,Grid >::Constraints_Product(phh, POLYNOMIAL_COMPLEXITY));
    break;
  case 1:
    *pph = to_nonconst(new Domain_Product<C_Polyhedron,Grid >::Constraints_Product(phh, SIMPLEX_COMPLEXITY));
    break;
  case 2:
    *pph = to_nonconst(new Domain_Product<C_Polyhedron,Grid >::Constraints_Product(phh, ANY_COMPLEXITY));
    break;
  }
  return 0;
}
...
(ppl_Constraints_Product_C_Polyhedron_Grid_t* pph, ppl_const_Constraint_System_t cs) try {
  const Constraint_System& ccs = *to_const(cs);
  *pph = to_nonconst(new Domain_Product<C_Polyhedron,Grid >::Constraints_Product(ccs));
  return 0;
}
CATCH_ALL
...
(ppl_Constraints_Product_C_Polyhedron_Grid_t* pph, ppl_const_Congruence_System_t cs) try {
...
(ppl_const_Constraints_Product_C_Polyhedron_Grid_t ph,
 ppl_const_Constraint_t c) try {
  const Domain_Product<C_Polyhedron,Grid >::Constraints_Product& pph = *to_const(ph);
...
int
ppl_Constraints_Product_C_Polyhedron_Grid_is_empty(ppl_const_Constraints_Product_C_Polyhedron_Grid_t ph) try {
  const Domain_Product<C_Polyhedron,Grid >::Constraints_Product& pph = *to_const(ph);
...
int
ppl_Constraints_Product_C_Polyhedron_Grid_is_universe(ppl_const_Constraints_Product_C_Polyhedron_Grid_t ph) try {
  const Domain_Product<C_Polyhedron,Grid >::Constraints_Product& pph = *to_const(ph);
...
int
ppl_Constraints_Product_C_Polyhedron_Grid_is_bounded(ppl_const_Constraints_Product_C_Polyhedron_Grid_t ph) try {
  const Domain_Product<C_Polyhedron,Grid >::Constraints_Product& pph = *to_const(ph);
...
int
ppl_Constraints_Product_C_Polyhedron_Grid_is_topologically_closed(ppl_const_Constraints_Product_C_Polyhedron_Grid_t ph) try {
  const Domain_Product<C_Polyhedron,Grid >::Constraints_Product& pph = *to_const(ph);
...
int
ppl_Constraints_Product_C_Polyhedron_Grid_is_discrete(ppl_const_Constraints_Product_C_Polyhedron_Grid_t ph) try {
  const Domain_Product<C_Polyhedron,Grid >::Constraints_Product& pph = *to_const(ph);
...
int
ppl_Constraints_Product_C_Polyhedron_Grid_topological_closure_assign(ppl_Constraints_Product_C_Polyhedron_Grid_t ph) try {
  Domain_Product<C_Polyhedron,Grid >::Constraints_Product& pph = *to_nonconst(ph);
...
(ppl_const_Constraints_Product_C_Polyhedron_Grid_t x,
 ppl_const_Constraints_Product_C_Polyhedron_Grid_t y) try {
  const Domain_Product<C_Polyhedron,Grid >::Constraints_Product& xx = *to_const(x);
  const Domain_Product<C_Polyhedron,Grid >::Constraints_Product& yy = *to_const(y);
...
int
ppl_Constraints_Product_C_Polyhedron_Grid_OK(ppl_const_Constraints_Product_C_Polyhedron_Grid_t ph) try {
...
(ppl_Constraints_Product_C_Polyhedron_Grid_t x,
 ppl_const_Constraints_Product_C_Polyhedron_Grid_t y) try {
  Domain_Product<C_Polyhedron,Grid >::Constraints_Product& xx = *to_nonconst(x);
  const Domain_Product<C_Polyhedron,Grid >::Constraints_Product& yy = *to_const(y);
...
(ppl_const_Constraints_Product_C_Polyhedron_Grid_t ps,
 size_t* sz) try {
...
(ppl_Constraints_Product_C_Polyhedron_Grid_t x,
 ppl_const_Constraints_Product_C_Polyhedron_Grid_t y) try {
  return ppl_Constraints_Product_C_Polyhedron_Grid_widening_assign_with_tokens(x, y, 0);
}
CATCH_ALL
...
DEFINE_OUTPUT_FUNCTIONS(Constraints_Product_C_Polyhedron_Grid)
