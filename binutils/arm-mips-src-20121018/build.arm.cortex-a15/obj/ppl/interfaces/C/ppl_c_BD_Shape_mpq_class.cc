/* C BD_Shape_mpq_class interface code: definitions.
...
int
ppl_delete_BD_Shape_mpq_class(ppl_const_BD_Shape_mpq_class_t ph) try {
  delete to_const(ph);
  return 0;
}
CATCH_ALL
...
(ppl_BD_Shape_mpq_class_t* pph,
 ppl_dimension_type d,
 int empty) try {
  *pph = to_nonconst(new BD_Shape<mpq_class>(d, empty ? EMPTY : UNIVERSE));
  return 0;
}
CATCH_ALL
...
(ppl_BD_Shape_mpq_class_t* pph,
  ...
  *pph = to_nonconst(new BD_Shape<mpq_class>(phh));
  return 0;
}
CATCH_ALL
...
(ppl_BD_Shape_mpq_class_t* pph,
 ...
 int complexity) try {
  ...
  switch (complexity) {
  case 0:
    *pph = to_nonconst(new BD_Shape<mpq_class>(phh, POLYNOMIAL_COMPLEXITY));
    break;
  case 1:
    *pph = to_nonconst(new BD_Shape<mpq_class>(phh, SIMPLEX_COMPLEXITY));
    break;
  case 2:
    *pph = to_nonconst(new BD_Shape<mpq_class>(phh, ANY_COMPLEXITY));
    break;
  }
  return 0;
}
...
(ppl_BD_Shape_mpq_class_t* pph, ppl_const_Constraint_System_t cs) try {
  const Constraint_System& ccs = *to_const(cs);
  *pph = to_nonconst(new BD_Shape<mpq_class>(ccs));
  return 0;
}
CATCH_ALL
...
(ppl_BD_Shape_mpq_class_t* pph, ppl_const_Congruence_System_t cs) try {
...
(ppl_BD_Shape_mpq_class_t* pph, ppl_const_Generator_System_t cs) try {
...
(ppl_const_BD_Shape_mpq_class_t ph,
 ppl_const_Constraint_t c) try {
  const BD_Shape<mpq_class>& pph = *to_const(ph);
...
int
ppl_BD_Shape_mpq_class_is_empty(ppl_const_BD_Shape_mpq_class_t ph) try {
  const BD_Shape<mpq_class>& pph = *to_const(ph);
...
int
ppl_BD_Shape_mpq_class_is_universe(ppl_const_BD_Shape_mpq_class_t ph) try {
  const BD_Shape<mpq_class>& pph = *to_const(ph);
...
int
ppl_BD_Shape_mpq_class_is_bounded(ppl_const_BD_Shape_mpq_class_t ph) try {
  const BD_Shape<mpq_class>& pph = *to_const(ph);
...
int
ppl_BD_Shape_mpq_class_contains_integer_point(ppl_const_BD_Shape_mpq_class_t ph) try {
  const BD_Shape<mpq_class>& pph = *to_const(ph);
...
int
ppl_BD_Shape_mpq_class_is_topologically_closed(ppl_const_BD_Shape_mpq_class_t ph) try {
  const BD_Shape<mpq_class>& pph = *to_const(ph);
...
int
ppl_BD_Shape_mpq_class_is_discrete(ppl_const_BD_Shape_mpq_class_t ph) try {
  const BD_Shape<mpq_class>& pph = *to_const(ph);
...
int
ppl_BD_Shape_mpq_class_topological_closure_assign(ppl_BD_Shape_mpq_class_t ph) try {
  BD_Shape<mpq_class>& pph = *to_nonconst(ph);
...
(ppl_const_BD_Shape_mpq_class_t x,
 ppl_const_BD_Shape_mpq_class_t y) try {
  const BD_Shape<mpq_class>& xx = *to_const(x);
  const BD_Shape<mpq_class>& yy = *to_const(y);
...
int
ppl_BD_Shape_mpq_class_OK(ppl_const_BD_Shape_mpq_class_t ph) try {
...
(ppl_BD_Shape_mpq_class_t x,
 ppl_const_BD_Shape_mpq_class_t y) try {
  BD_Shape<mpq_class>& xx = *to_nonconst(x);
  const BD_Shape<mpq_class>& yy = *to_const(y);
...
(ppl_const_BD_Shape_mpq_class_t ps,
 size_t* sz) try {
...
(ppl_BD_Shape_mpq_class_t x,
 ppl_const_BD_Shape_mpq_class_t y) try {
  return ppl_BD_Shape_mpq_class_BHMZ05_widening_assign_with_tokens(x, y, 0);
}
CATCH_ALL
...
(ppl_BD_Shape_mpq_class_t x,
 ppl_const_BD_Shape_mpq_class_t y) try {
  return ppl_BD_Shape_mpq_class_H79_widening_assign_with_tokens(x, y, 0);
}
CATCH_ALL
...
(ppl_BD_Shape_mpq_class_t x,
 ppl_const_BD_Shape_mpq_class_t y) try {
  return ppl_BD_Shape_mpq_class_widening_assign_with_tokens(x, y, 0);
}
CATCH_ALL
...
(ppl_const_BD_Shape_mpq_class_t x,
 ...
 ppl_Pointset_Powerset_NNC_Polyhedron_t* p_rest) try {
    const BD_Shape<mpq_class>& xx
      = static_cast<const BD_Shape<mpq_class>&>(*to_const(x));
    const BD_Shape<mpq_class>& yy
      = static_cast<const BD_Shape<mpq_class>&>(*to_const(y));
...
(ppl_BD_Shape_mpq_class_t* pph, ppl_Constraint_System_t cs) try {
...
(ppl_BD_Shape_mpq_class_t* pph, ppl_Congruence_System_t cs) try {
...
(ppl_BD_Shape_mpq_class_t* pph, ppl_Generator_System_t cs) try {
...
(ppl_BD_Shape_mpq_class_t dst,
 ppl_const_BD_Shape_mpq_class_t src) try {
  const BD_Shape<mpq_class>& ssrc
    = *static_cast<const BD_Shape<mpq_class>*>(to_const(src));
  BD_Shape<mpq_class>& ddst
    = *static_cast<BD_Shape<mpq_class>*>(to_nonconst(dst));
  ddst = ssrc;
  return 0;
}
CATCH_ALL
...
(ppl_const_BD_Shape_mpq_class_t pset) try {
  const BD_Shape<mpq_class>& ppset
    = *static_cast<const BD_Shape<mpq_class>*>(to_const(pset));
...
(ppl_const_BD_Shape_mpq_class_t pset_before, ppl_const_BD_Shape_mpq_class_t pset_after) try {
  const BD_Shape<mpq_class>& ppset_before
    = *static_cast<const BD_Shape<mpq_class>*>(to_const(pset_before));
  const BD_Shape<mpq_class>& ppset_after
    = *static_cast<const BD_Shape<mpq_class>*>(to_const(pset_after));
...
(ppl_const_BD_Shape_mpq_class_t pset_before,
...
DEFINE_OUTPUT_FUNCTIONS(BD_Shape_mpq_class)
