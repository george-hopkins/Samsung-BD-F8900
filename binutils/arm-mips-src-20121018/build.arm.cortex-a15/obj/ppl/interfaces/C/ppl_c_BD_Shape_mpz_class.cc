...
(ppl_const_BD_Shape_mpz_class_t pset) try {
  const BD_Shape<mpz_class>& ppset
    = *static_cast<const BD_Shape<mpz_class>*>(to_const(pset));
...
(ppl_const_BD_Shape_mpz_class_t pset_before, ppl_const_BD_Shape_mpz_class_t pset_after) try {
  const BD_Shape<mpz_class>& ppset_before
    = *static_cast<const BD_Shape<mpz_class>*>(to_const(pset_before));
  const BD_Shape<mpz_class>& ppset_after
    = *static_cast<const BD_Shape<mpz_class>*>(to_const(pset_after));
...
(ppl_const_BD_Shape_mpz_class_t pset_before,
