...
# 1 "/home6/daewon2/Release/glibc/SP/SP_Linux/LP_Linux_Prj/REL/VDLinux.3.x.2012/toolchain/src/arm-mips-src-20121018/build.arm.cortex-a15/obj/glibc_0_final/config.h" 1
...
libc {
  GLIBC_2.0 {
    ...
    strtold; strtoll; strtoq; strtoul; strtoull; strtouq; system; setenv_r;
    unsetenv; unsetenv_r;
    wcstombs; wctomb;
  }
  GLIBC_2.1 {
...
libc {
  GLIBC_2.0 {
    ...
    vd_fprintf; vd_printf; vd_puts; vd_vfprintf; vd_vprintf;
  }
  GLIBC_2.1 {
...
libc {
  GLIBC_2.0 {
    _obstack;
    __libc_calloc; __libc_free; __libc_mallinfo; __libc_vd_mallinfo; __libc_malloc;
    ...
    calloc; cfree;
    free;
    mallinfo; vd_mallinfo; malloc; malloc_get_state; malloc_set_state; malloc_stats;
...
libc {
  GLIBC_2.0 {
    ...
    glob_pattern_p; globfree; group_member; getopt_r;
    nanosleep;
...
libc {
  GLIBC_2.0 {
    ...
    fts_open; fts_read; fts_set; ftw; ftw_r;
...
libpthread {
  ...
  GLIBC_2.2 {
    ...
    pthread_mutex_timedlock; pthread_mutex_timedlock_relative;
    pthread_rwlock_timedrdlock; pthread_rwlock_timedrdlock_relative;
    pthread_rwlock_timedwrlock; pthread_rwlock_timedwrlock_relative;
    ...
    sem_timedwait; sem_timedwait_relative;
    pthread_yield;
  ...
  GLIBC_2.3.3 {
    ...
    pthread_tryjoin_np; pthread_timedjoin_np; pthread_timedjoin_relative_np;
