...
/*       printk("kks test : %s %d\n", __FILE__,__LINE__);*/
     ...
     if (!sdkp->disk->part_tbl->part[0]){
/*      printk("kks test : %s %d\n", __FILE__,__LINE__);*/
      printk(KERN_ERR "FIXED VDLP: no partition Media Connected\n");
      isNoPartition = 1;
...
/*     printk("kks test : %s %d\n", __FILE__,__LINE__);*/
     printk(KERN_ERR "FIXED VDLP: no partition Media Disconnected\n");
