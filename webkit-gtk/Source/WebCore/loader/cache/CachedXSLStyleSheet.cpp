...
#ifdef ENABLE_HBBTV
    setAccept("text/xml, application/xml, application/xhtml+xml, application/ce-html+xml, application/vnd.hbbtv.xhtml+xml, application/vnd.oipf.xhtml+xml, text/xsl, application/rss+xml, application/atom+xml");
#else
