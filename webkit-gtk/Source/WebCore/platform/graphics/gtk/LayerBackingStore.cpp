...
PassOwnPtr<LayerContents> LayerBackingStore::create(GtkLayer* owner)
{
    return adoptPtr(new LayerBackingStore(owner));
}

LayerBackingStore::LayerBackingStore(GtkLayer* owner)
	: LayerContents(owner)
{
}

LayerBackingStore::~LayerBackingStore()
{
}

void LayerBackingStore::updateContents(LayerTextureManager* manager, const FloatSize& layerSize, const FloatRect& dirtyRect)
{
