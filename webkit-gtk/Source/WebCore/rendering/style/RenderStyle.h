...
#ifdef ENABLE_HBBTV
    const StyleNavigationValue& navDown() const { return rareNonInheritedData->m_nav.m_down; }
    const StyleNavigationValue& navLeft() const { return rareNonInheritedData->m_nav.m_left; }
    const StyleNavigationValue& navRight() const { return rareNonInheritedData->m_nav.m_right; }
    const StyleNavigationValue& navUp() const { return rareNonInheritedData->m_nav.m_up; }
#endif
    // End CSS3 Getters
...
#ifdef ENABLE_HBBTV
    void setNavDown(const StyleNavigationValue& v) { SET_VAR(rareNonInheritedData, m_nav.m_down, v); }
    void setNavLeft(const StyleNavigationValue& v) { SET_VAR(rareNonInheritedData, m_nav.m_left, v); }
    void setNavRight(const StyleNavigationValue& v) { SET_VAR(rareNonInheritedData, m_nav.m_right, v); }
    void setNavUp(const StyleNavigationValue& v) { SET_VAR(rareNonInheritedData, m_nav.m_up, v); }
#endif
    // End CSS3 Setters
...
#ifdef ENABLE_HBBTV
    static const StyleNavigationValue& initialStyleNavigation() { DEFINE_STATIC_LOCAL(StyleNavigationValue, navi, ()); return navi; }
#endif
