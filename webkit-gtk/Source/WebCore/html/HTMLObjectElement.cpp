...
#if ENABLE(WIDGET_ENGINE)
//3 WEBKIT_WIDGETENGINE
typedef HashMap<String, String> ClassIdToTypeMap;
static ClassIdToTypeMap* createClassIdToTypeMap()
{
    ClassIdToTypeMap* map = new ClassIdToTypeMap;

    map->add("clsid:SAMSUNG-INFOLINK-DEVICE", "application/device");
    map->add("clsid:SAMSUNG-INFOLINK-EXTERNALWIDGETINTERFACE", "application/externalwidgetinterface");
    map->add("clsid:SAMSUNG-INFOLINK-FILESYSTEM", "application/filesystem");
    map->add("clsid:SAMSUNG-INFOLINK-APPCOMMON", "application/appcommon");
    map->add("clsid:SAMSUNG-INFOLINK-AUDIO", "application/audio");
    map->add("clsid:SAMSUNG-INFOLINK-FRONTPANEL", "application/frontpanel");
    map->add("clsid:SAMSUNG-INFOLINK-IME", "application/ime");
    map->add("clsid:SAMSUNG-INFOLINK-IMAGEVIEWER", "application/imageviewer");
    map->add("clsid:SAMSUNG-INFOLINK-NETWORK", "application/network");
    map->add("clsid:SAMSUNG-INFOLINK-NNAVI", "application/nnavi");
    map->add("clsid:SAMSUNG-INFOLINK-PLAYER", "application/player");
    map->add("clsid:SAMSUNG-INFOLINK-SCREEN", "application/screen");
    map->add("clsid:SAMSUNG-INFOLINK-TASKMANAGER", "application/taskmanager");
    map->add("clsid:SAMSUNG-INFOLINK-TIME", "application/time");
    map->add("clsid:SAMSUNG-INFOLINK-TV", "application/tv");
    map->add("clsid:SAMSUNG-INFOLINK-TVMW", "application/tvmw");
    map->add("clsid:SAMSUNG-INFOLINK-VIDEO", "application/video");
    map->add("clsid:SAMSUNG-INFOLINK-WINDOW", "application/window");

    map->add("clsid:SAMSUNG-INFOLINK-DOWNLOAD", "application/download");
    map->add("clsid:SAMSUNG-INFOLINK-LOGGING", "application/logging");
    map->add("clsid:SAMSUNG-INFOLINK-MEMORY", "application/memory");
    map->add("clsid:SAMSUNG-INFOLINK-MSERVICE", "application/mservice");
    map->add("clsid:SAMSUNG-INFOLINK-SECURITY", "application/security");
    map->add("clsid:SAMSUNG-INFOLINK-STORAGE", "application/storage");
    map->add("clsid:SAMSUNG-INFOLINK-VUDU", "application/vudu");
    map->add("clsid:SAMSUNG-INFOLINK-SEF", "application/sefex");

	map->add("clsid:SAMSUNG-INFOLINK-DRM", "application/drm");
...
void HTMLObjectElement::parseMappedAttribute(Attribute* attr)
{
    if (attr->name() == typeAttr) {
        ...
        if (useWidgetEngine == true)
        {
            ...
            {
                m_serviceType = serviceTypeForClassId(this->classId());
                if (!m_serviceType.isEmpty())
                    m_classId = "";
            }
        }
