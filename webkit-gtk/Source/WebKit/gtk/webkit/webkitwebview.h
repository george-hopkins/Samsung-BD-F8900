...
#ifdef ENABLE_TVGG_BROWSER
#ifndef SFB_LINUX_API
#define SFB_LINUX_API  __attribute__((visibility("default")))
#endif /* SFB_LINUX_API */
...
SFB_LINUX_API void
webkit_web_view_full_page_to_png(WebKitWebView* webView, const gchar* fileName);
#endif /* TVGG_BROWSER */


#ifdef ENABLE_TVGG_BACKINGSTORE
SFB_LINUX_API void
webkit_backingstore_enable(bool bEnable);

SFB_LINUX_API void
webkit_backingstore_change_web_view(WebKitWebView* webView);

SFB_LINUX_API void
webkit_web_view_update_scroll(WebKitWebView* aWebView);
#endif /* ENABLE_TVGG_BACKINGSTORE */

#ifdef ENABLE_TVGG_CONTROL_SOUP_CACHE
WEBKIT_API bool
webkit_web_view_soup_cache_init(const char* aPathToCreate, bool isShared);
#endif /* ENABLE_TVGG_CONTROL_SOUP_CACHE */

#ifdef ENABLE_TVGG_HIDE_ALERT_POPUP_WINDOW
SFB_LINUX_API void set_debug_javascript();
SFB_LINUX_API void reset_debug_javascript();
#endif /* ENABLE_TVGG_HIDE_ALERT_POPUP_WINDOW */
