...
#if ENABLE(TVGG_USE_DEFAULT_GDK_DISPLAY)  // @20100902-shivamidow
	GtkClipboard* clipboard = gtk_clipboard_get_for_display(gdk_display_get_default(), GDK_SELECTION_PRIMARY);
#else
