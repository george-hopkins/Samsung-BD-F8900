...
struct libusb_device {
	...
	int refcnt;
#ifdef PATCH_FOR_WORKARROUND
	unsigned char MutexFlag;
#endif
...
static inline struct linux_transfer_priv * usbi_transfer_get_os_priv(struct usbi_transfer *transfer)
{
	return (( struct linux_transfer_priv *)(((void *)transfer) + sizeof(struct usbi_transfer)
