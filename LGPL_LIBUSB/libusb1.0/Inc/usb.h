...
extern int usb_device_removed; //vishal
extern int usb_device_added; //vishal
...
typedef struct usb_device* device_ptr_t;
...
typedef void (* usb_callback_t)(struct usb_device *dev, int is_removed);
/* Variables */
...
int usb_find_busses_m(void);
int usb_find_devices_m(void);
...
//int usb_poll_for_change(void);
int usb_poll_for_change(int*);
