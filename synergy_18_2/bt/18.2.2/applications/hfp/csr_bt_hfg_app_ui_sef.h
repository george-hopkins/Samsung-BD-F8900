...
#define CSR_BT_HFG_C2C_KEY                                  (CSR_BT_HFG_CALL_LIST_KEY + 0x01)
#define CSR_BT_HFG_SETTINGS_INDICATORS_KEY     (CSR_BT_HFG_C2C_KEY + 0x01)
...
/* key defines for C2C menu UI                    */
#define CSR_BT_HFG_CALLER_NAME_KEY                0x00
#define CSR_BT_HFG_TOGGLE_NAME_KEY                (CSR_BT_HFG_CALLER_NAME_KEY + 0x01)
#define CSR_BT_HFG_TOGGLE_TEXT_KEY                (CSR_BT_HFG_TOGGLE_NAME_KEY + 0x01)
#define CSR_BT_HFG_TOGGLE_SMS_KEY                (CSR_BT_HFG_TOGGLE_TEXT_KEY + 0x01)
#define CSR_BT_HFG_TOGGLE_BATTERY_KEY            (CSR_BT_HFG_TOGGLE_SMS_KEY + 0x01)
#define CSR_BT_HFG_TOGGLE_POWER_KEY                (CSR_BT_HFG_TOGGLE_BATTERY_KEY + 0x01)
#define CSR_BT_HFG_SEND_SMS_IND_KEY                (CSR_BT_HFG_TOGGLE_POWER_KEY + 0x01)
#define CSR_BT_HFG_SEND_TEXT_STRING_KEY            (CSR_BT_HFG_SEND_SMS_IND_KEY + 0x01)
#define CSR_BT_HFG_SETUP_AUDIO_CODEC_SR_KEY        (CSR_BT_HFG_SEND_TEXT_STRING_KEY + 0x01)
#define CSR_BT_HFG_ADPCM_SUPPORT_QUERY_KEY         (CSR_BT_HFG_SETUP_AUDIO_CODEC_SR_KEY + 0x01)

/* key defines for Audio codec and sample rate menu UI                    */
#define CSR_BT_HFG_CURRENT_CODEC_DETAILS_KEY    0x00
#define CSR_BT_HFG_CVSD_KEY                        (CSR_BT_HFG_CURRENT_CODEC_DETAILS_KEY + 0x01)
#define CSR_BT_HFG_ADPCM_2BIT_KEY                (CSR_BT_HFG_CVSD_KEY + 0x01)
#define CSR_BT_HFG_ADPCM_4BIT_KEY                (CSR_BT_HFG_ADPCM_2BIT_KEY + 0x01)
#define CSR_BT_HFG_8KHZ_SAMPLE_KEY                (CSR_BT_HFG_ADPCM_4BIT_KEY + 0x01)
#define CSR_BT_HFG_16KHZ_SAMPLE_KEY                (CSR_BT_HFG_8KHZ_SAMPLE_KEY + 0x01)
