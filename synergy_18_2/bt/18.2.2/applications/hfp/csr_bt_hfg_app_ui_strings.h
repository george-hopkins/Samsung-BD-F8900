...
/*C2C Options*/
/*Audio Codec and Sample Rate settings*/
#define TEXT_HFG_AUDIO_CODEC_MENU_UCS2    CONVERT_TEXT_STRING_2_UCS2("Audio Codec Menu")
#define TEXT_HFG_CURRENT_CODEC_DETAILS_UCS2    CONVERT_TEXT_STRING_2_UCS2("Current Codec details")
#define TEXT_HFG_CVSD_UCS2                        CONVERT_TEXT_STRING_2_UCS2("CVSD")
#define TEXT_HFG_ADPCM_2BIT_UCS2                CONVERT_TEXT_STRING_2_UCS2("ADPCM 2 bits/sample")
#define TEXT_HFG_ADPCM_4BIT_UCS2                CONVERT_TEXT_STRING_2_UCS2("ADPCM 4 bits/sample")
#define TEXT_HFG_8KHZ_SAMPLE_UCS2                CONVERT_TEXT_STRING_2_UCS2("8 Khz sample rate")
#define TEXT_HFG_16KHZ_SAMPLE_UCS2                CONVERT_TEXT_STRING_2_UCS2("16 Khz sample rate")

#define TEXT_HFG_C2C_MENU_UCS2                CONVERT_TEXT_STRING_2_UCS2("C2C Menu")
#define TEXT_HFG_C2C_ENTER_NAME_UCS2                CONVERT_TEXT_STRING_2_UCS2("Enter name of caller")
#define TEXT_HFG_C2C_TOGGLE_NAME_UCS2                CONVERT_TEXT_STRING_2_UCS2("Toggle name indicator")
#define TEXT_HFG_C2C_TOGGLE_TEXT_UCS2                CONVERT_TEXT_STRING_2_UCS2("Toggle text indicator")
#define TEXT_HFG_C2C_TOGGLE_SMS_UCS2                CONVERT_TEXT_STRING_2_UCS2("Toggle SMS indicator")
#define TEXT_HFG_C2C_TOGGLE_BATTERY_UCS2                CONVERT_TEXT_STRING_2_UCS2("Toggle battery indicator")
#define TEXT_HFG_C2C_TOGGLE_POWER_UCS2                CONVERT_TEXT_STRING_2_UCS2("Toggle power indicator")
#define TEXT_HFG_C2C_IN_SMS_IND_UCS2                CONVERT_TEXT_STRING_2_UCS2("Send incoming SMS indication")
#define TEXT_HFG_C2C_SEND_TEXT_UCS2                CONVERT_TEXT_STRING_2_UCS2("Send text string")
#define TEXT_HFG_C2C_SETUP_CODEC_SR_UCS2                CONVERT_TEXT_STRING_2_UCS2("Setup Audio Codec and sample rate")
#define TEXT_HFG_C2C_QUERY_ADPCM_UCS2                CONVERT_TEXT_STRING_2_UCS2("Query ADPCM audio support")
...
#define TEXT_HFG_MAIN_C2C_UCS2                CONVERT_TEXT_STRING_2_UCS2("C2C")
