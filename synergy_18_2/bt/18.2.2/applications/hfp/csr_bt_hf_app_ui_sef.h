...
/*Key for CSR_BT_CHANGE_AUDIO_CODEC_UI*/
#define CSR_BT_HF_ADPCM_OFF_KEY                     0x00
#define CSR_BT_HF_2_8KHZ_NO_SR_NEG_KEY              (CSR_BT_HF_ADPCM_OFF_KEY + 0x01)
#define CSR_BT_HF_2_8KHZ_SR_NEG_KEY                 (CSR_BT_HF_2_8KHZ_NO_SR_NEG_KEY + 0x01)
#define CSR_BT_HF_4_8KHZ_NO_SR_NEG_KEY              (CSR_BT_HF_2_8KHZ_SR_NEG_KEY + 0x01)
#define CSR_BT_HF_4_8KHZ_SR_NEG_KEY                 (CSR_BT_HF_4_8KHZ_NO_SR_NEG_KEY + 0x01)
#define CSR_BT_HF_2_16KHZ_SR_NEG_KEY                (CSR_BT_HF_4_8KHZ_SR_NEG_KEY + 0x01)
#define CSR_BT_HF_4_16KHZ_SR_NEG_KEY                (CSR_BT_HF_2_16KHZ_SR_NEG_KEY + 0x01)

/*Key for CSR_BT_C2C_MENU_UI*/
#define CSR_BT_HF_REM_C2C_SUPP_FEATURES_KEY         0x00
#define CSR_BT_HF_SEND_C2C_INIT_CMD_KEY             (CSR_BT_HF_REM_C2C_SUPP_FEATURES_KEY + 0x01)
#define CSR_BT_HF_REQ_SMS_KEY                       (CSR_BT_HF_SEND_C2C_INIT_CMD_KEY + 0x01)
#define CSR_BT_HF_INC_BAT_LEVEL_KEY                 (CSR_BT_HF_REQ_SMS_KEY + 0x01)
#define CSR_BT_HF_DEC_BAT_LEVEL_KEY                 (CSR_BT_HF_INC_BAT_LEVEL_KEY + 0x01)
#define CSR_BT_HF_SEND_PWR_STATUS_BAT_KEY           (CSR_BT_HF_DEC_BAT_LEVEL_KEY + 0x01)
#define CSR_BT_HF_SEND_PWR_STATUS_EXT_KEY           (CSR_BT_HF_SEND_PWR_STATUS_BAT_KEY + 0x01)
#define CSR_BT_HF_SEND_AT_CSR_ACT_KEY               (CSR_BT_HF_SEND_PWR_STATUS_EXT_KEY + 0x01)
#define CSR_BT_HF_SEND_AT_CSR_DEACT_KEY             (CSR_BT_HF_SEND_AT_CSR_ACT_KEY + 0x01)
#define CSR_BT_HF_SEND_AT_CSRFN_KEY                 (CSR_BT_HF_SEND_AT_CSR_DEACT_KEY + 0x01)
