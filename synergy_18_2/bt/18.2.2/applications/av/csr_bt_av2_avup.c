        ...
        case CSR_BT_AV_DEACTIVATE_CFM:
            {
                ...
                if((instData->selectedDevice.lap != 0) &&
        ...
        case CSR_BT_AV_GET_CHANNEL_INFO_CFM:
            {
                ...
                {
                    instData->avCon[instData->currentConnection].avDspmInst.remoteCid = prim->remoteCid;
                    instData->avCon[instData->currentConnection].avDspmInst.aclHandle = prim->aclHandle;
                }
#endif
                break;
            }
