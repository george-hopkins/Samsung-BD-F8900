...
#define CSR_BT_AV_CHOOSE_ENCODER_KEY                                   (0x003E)
#define CSR_BT_AV_CHOOSE_SBC_ENCODER_KEY                               (0x003F)
#define CSR_BT_AV_CHOOSE_APTX_ENCODER_KEY                              (0x0040)
#define CSR_BT_AV_CHOOSE_AUDIO_INPUT_KEY                               (0x0041)
#define CSR_BT_AV_CHOOSE_CODEC_AUDIO_INPUT_KEY                         (0x0042)
#define CSR_BT_AV_CHOOSE_PCM_AUDIO_INPUT_KEY                           (0x0043)
