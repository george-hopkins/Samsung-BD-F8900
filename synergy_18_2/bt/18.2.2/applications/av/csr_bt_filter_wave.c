...
typedef struct
{
    char        chunkId[4];                        /* Chunk format "RIFF" */
    CsrUint32    chunk_length;                      /* Full chunk size*/
    char        txt1[8];                           /* Format "WAVE" and SubChunk1ID "fmt" */
    ...
    char        txt2[4];                           /* SubChunk2ID -> Letters "data" */
