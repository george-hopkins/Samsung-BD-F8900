...
#ifdef CSR_USE_DSPM
#define   CSR_BT_AV_CHOOSE_ONCHIP_ENCODER_MENU_UI                    (0x09) + CSR_BT_AV_HIGEST_NO_OF_FILTER_MENU_UI
#define   CSR_BT_AV_CHOOSE_ONCHIP_INPUT_MENU_UI                      (0x0A) + CSR_BT_AV_HIGEST_NO_OF_FILTER_MENU_UI
#define   CSR_BT_AV_DEFAULT_INFO_UI                                  (0x0B) + CSR_BT_AV_HIGEST_NO_OF_FILTER_MENU_UI
#define   CSR_BT_AV_CON_SPECIFIC_DIALOG_UI                           (0x0C) + CSR_BT_AV_HIGEST_NO_OF_FILTER_MENU_UI
#define   CSR_BT_AV_OPEN_STREAM_SPECIFIC_DIALOG_UI                   (0x0D) + CSR_BT_AV_HIGEST_NO_OF_FILTER_MENU_UI
#define   CSR_BT_AV_START_STREAM_SPECIFIC_DIALOG_UI                  (0x0E) + CSR_BT_AV_HIGEST_NO_OF_FILTER_MENU_UI
#define   CSR_BT_AV_EVENT_NOTFCN_1_DIALOG_UI                         (0x0F) + CSR_BT_AV_HIGEST_NO_OF_FILTER_MENU_UI
#define   CSR_BT_AV_EVENT_NOTFCN_2_DIALOG_UI                         (0x10) + CSR_BT_AV_HIGEST_NO_OF_FILTER_MENU_UI
#define   CSR_BT_AV_EVENT_NOTFCN_3_DIALOG_UI                         (0x11) + CSR_BT_AV_HIGEST_NO_OF_FILTER_MENU_UI
#define   NUMBER_OF_CSR_BT_AV_APP_UI                                 (0x12) + CSR_BT_AV_HIGEST_NO_OF_FILTER_MENU_UI
#else
...
#define PROFILE_AV CsrUtf8StrDup("AV")
...
#define CSR_BT_AV2_FIRST_PCM_INSTANCE     0x0000

/* For PCM we need to give the PCM Slot in the form 0x8n00, where n is the PCM slot*/
#define CSR_BT_AV2_DSPM_RIGHT_CHANNEL     0x0001
#define CSR_BT_AV2_DSPM_LEFT_CHANNEL      0x0000


/* Configuration key definitions */
#define CSR_BT_AV2_DSPM_ATU_SIZE                     0x0800
#define CSR_BT_AV2_DSPM_AUTOFLUSH                    0x0801
#define CSR_BT_AV2_DSPM_NUM_TOKENS                   0x0802
#define CSR_BT_AV2_DSPM_PCM_SYNC_RATE                0x0100
#define CSR_BT_AV2_DSPM_PCM_MASTER_CLOCK_RATE        0x0101

#define CSR_BT_AV2_DSPM_OP_MESSAGE_SBC_SETTINGS      0x0001
#define CSR_BT_AV2_DSPM_OP_MESSAGE_ATU_SIZE          0x0002
#define CSR_BT_AV2_DSPM_OP_MESSAGE_ENABLE_FADE_OUT   0x0004
#define CSR_BT_AV2_DSPM_OP_MESSAGE_DISABLE_FADE_OUT  0x0005

#define CSR_BT_AV2_DSPM_DEFAULT_NUM_TOKENS           3
#define CSR_BT_AV2_DSPM_RTP_HEADER_LENGTH            13

typedef struct
{
    CsrUint16                    remoteCid;                  /* Remote CID */
    CsrUint16                    aclHandle;                  /* ACL channel ID */
    CsrDspmCpType                endPointType;               /* Type of endpoint to use: PCM, CODEC, I2S,... Per default: Codec */
    CsrUint16                    pcmInstance;                /* next PCM instance to use for an A2DP connection */                        
    CsrUint16                    frame_size;                 /* frame size used for the stream */
    CsrUint16                    framesPerPacket;            /* number of SBC frames per packet to send */
    CsrUint16                    num_tokens;                 /* number of tokens needed to send a given number of SBC frames per packet */
    CsrUint16                    shuntId;                    /* ID of the sink allocated through the DSPM for the stream */
    CsrUint16                    operatorEncoder;            /* Operator to use as encoder */
    CsrUint16                    pcmLeftHandle;              /* Handle for the left side of the PCM */
    CsrUint16                    pcmRightHandle;             /* Handle for the right side of the PCM */
    CsrUint16                    connIdLeftEncoder;          /* Connection ID for left side to SBC encoder */
    CsrUint16                    connIdRightEncoder;         /* Connection ID for right side to SBC encoder */
    CsrUint16                    connIdEncoderShunt;         /* Connection ID for SBC encoder to shunt */
    CsrBool                      readyToStart;               /* Boolean to decide whether the stream should start yet */
    CsrUint16                    encoderToUse;               /* Which on-chip encoder shall be used? Default: SBC */
} AvDspmType;
...
typedef void (AvDspmCBFunction)(struct av2instance_t* instData);
...
#ifdef CSR_USE_DSPM
    CsrDspmCpType        nextEndPointType;                 /* Type of endpoint to use: PCM, CODEC, I2S,... Per default: Codec */
    CsrUint16            nextEncoderToUse;                 /* Which on-chip encoder shall be used? Default: SBC */
    AvDspmCBFunction     *av2DspmCallBack;                 /* Call back function for DSPM messages */
#endif
