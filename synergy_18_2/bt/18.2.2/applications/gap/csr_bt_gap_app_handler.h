...
#define HIGHEST_NUM_OF_SC_UI                            0x0A + HIGHEST_NUM_OF_SD_UI
...
#define CSR_BT_GAP_MAIN_MENU_UI                         0x00 + HIGHEST_NUM_OF_CM_UI
#define CSR_BT_GAP_DEFAULT_INFO_UI                      0x01 + HIGHEST_NUM_OF_CM_UI
#define NUMBER_OF_CSR_BT_GAP_APP_UI                     0x02 + HIGHEST_NUM_OF_CM_UI
...
typedef struct
{
	...
	CsrSchedTid                 timeDelayId;
	CsrSchedTid                 timeSendMessageId;
	CsrBool                     isInit;
} CsrBtGapCmInstData;
