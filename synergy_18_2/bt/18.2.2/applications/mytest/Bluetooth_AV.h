...
#define SsAvStateAvConnected            (SsAvStatesAvType) 0x01
#define SsAvStateAvConnectedOpen        (SsAvStatesAvType) 0x02
#define SsAvStateAvConnectedStreaming   (SsAvStatesAvType) 0x03

typedef	enum 	
{
	BT_SAMPLE_RATE_44	= 	44100,
	BT_SAMPLE_RATE_48	= 	48000
}BT_SAMPLE_RATE;
...
extern void handleAv2Prim(Av2AppInst  *inst);
