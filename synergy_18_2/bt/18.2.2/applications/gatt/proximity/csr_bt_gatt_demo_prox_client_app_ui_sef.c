...
CsrUtf16String *commonProxcGetValueString(CsrBtProxcAppInstData *inst, CsrUint16 uuid)
{
    ...
    if(pElem != NULL)
    {
            ...
            case CSR_BT_GATT_APP_IALERT_UUID: 
                {
                    CsrBtGattAppDbCharacElement *cElem = CSR_BT_GATT_APP_DB_FIND_CHARAC_BY_UUID(pElem->characList, 
                                                                                                CsrBtProxcAppUuid16ToUuid128(CSR_BT_GATT_APP_ALERT_LEVEL_CHARAC_UUID));
        ...
        case CSR_BT_GATT_APP_TX_POWER_UUID:
            {
                CsrBtGattAppDbCharacElement *cElem = CSR_BT_GATT_APP_DB_FIND_CHARAC_BY_UUID(pElem->characList, 
                                                                                            CsrBtProxcAppUuid16ToUuid128(CSR_BT_GATT_APP_TX_POWER_CHARAC_UUID));
                if(cElem != NULL && cElem->value != NULL)
                {
                    ret =  CsrPmemAlloc(20);
                    sprintf(ret, "TX: %d RSSI: %d", (CsrInt8)cElem->value[0], (CsrInt8)inst->rssiLevel);
        ...
        case CSR_BT_GATT_APP_BATTERY_UUID:
            {
                CsrBtGattAppDbCharacElement *cElem = CSR_BT_GATT_APP_DB_FIND_CHARAC_BY_UUID(pElem->characList, 
                                                                                            CsrBtProxcAppUuid16ToUuid128(CSR_BT_GATT_APP_BATT_LEVEL_CHARAC_UUID));
                if(cElem != NULL && cElem->value != NULL)
                {
                    ret = CsrPmemAlloc(12);
...
void CsrBtGattAppHandleProxcCsrUiMenuUpdate(CsrBtProxcAppInstData *inst)
{
    ...
    if(inst->btConnId != 0xff)
    {
        ...
        CsrUiMenuSetitemReqSend(csrUiVar->hMainMenu, 
                                ...
                                commonProxcGetValueString(inst, CSR_BT_GATT_APP_LINKLOSS_UUID),
                                csrUiVar->hSk1Event, 
                                csrUiVar->hSk2Event, 
                                csrUiVar->hBackEvent, 
                                0);
        CsrUiMenuSetitemReqSend(csrUiVar->hMainMenu, 
                                ...
                                commonProxcGetValueString(inst, CSR_BT_GATT_APP_IALERT_UUID),
                                csrUiVar->hSk1Event, 
                                csrUiVar->hSk2Event, 
                                csrUiVar->hBackEvent, 
                                0);
        CsrUiMenuSetitemReqSend(csrUiVar->hMainMenu, 
                                ...
                                commonProxcGetValueString(inst, CSR_BT_GATT_APP_TX_POWER_UUID),
                                csrUiVar->hSk1Event, 
                                csrUiVar->hSk2Event, 
                                csrUiVar->hBackEvent, 
                                0);
        CsrUiMenuSetitemReqSend(csrUiVar->hMainMenu, 
                                ...
                                commonProxcGetValueString(inst, CSR_BT_GATT_APP_BATTERY_UUID),
                                csrUiVar->hSk1Event, 
                                csrUiVar->hSk2Event, 
                                csrUiVar->hBackEvent, 
                                0);
...
void CsrBtGattAppHandleProxcCsrUiShowBattInfo(CsrBtProxcAppInstData *inst)
{
    ...
    pElem = CSR_BT_GATT_APP_DB_FIND_PRIM_SERVICE_BY_UUID(inst->dbElement->dbPrimServices,CsrBtProxcAppUuid16ToUuid128(CSR_BT_GATT_APP_BATTERY_UUID));
            ...
            case CSR_BT_PROXC_APP_WRITE_LINKLOSS_KEY:
                {
                    ...
                    else
                    {
                        ...
                        CsrBtProxcAppStartWriteValue(inst, CSR_BT_GATT_APP_LINKLOSS_UUID, CSR_BT_GATT_APP_ALERT_LEVEL_CHARAC_UUID);
                    }
                    break;
                }
            case CSR_BT_PROXC_APP_WRITE_IMMEDIATE_ALERT_KEY :
                {
                    ...
                    else
                    {
                        ...
                        commonProxcPopupShow(inst);
                        CsrBtProxcAppStartWriteValue(inst, CSR_BT_GATT_APP_IALERT_UUID, CSR_BT_GATT_APP_ALERT_LEVEL_CHARAC_UUID);
                    }
                    break;
                }
            case CSR_BT_PROXC_APP_READ_TX_POWER_KEY:
                {
                    ...
                    {
                     /* done automatically during traversal now  CsrBtProxcAppStartReadValue(inst, CSR_BT_GATT_APP_TX_POWER_UUID, CSR_BT_GATT_APP_TX_POWER_CHARAC_UUID);*/
                    }
                    break;
                }
