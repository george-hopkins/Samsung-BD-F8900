...
void CsrSchedTaskInit(void *data)
{
    ...
    CsrSchedRegisterTask(&CSR_BT_SYNCS_IFACEQUEUE, CSR_BT_SYNCS_INIT, CSR_BT_SYNCS_DEINIT, CSR_BT_SYNCS_HANDLER, "CSR_BT_SYNCS", data, ID_STACK);
    CsrSchedRegisterTask(&CSR_BT_SYNCC_IFACEQUEUE, CSR_BT_SYNCC_INIT, CSR_BT_SYNCC_DEINIT, CSR_BT_SYNCC_HANDLER, "CSR_BT_SYNCC", data, ID_STACK);
