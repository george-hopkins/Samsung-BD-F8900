...
#define CSR_BT_SEND_SEARCH_CIMMAND_KEY                                    (0x0018)
...
#define CSR_BT_AVRCP_DEACTIVATE_KEY                                       (0x0040)
#define CSR_BT_AVRCP_SIMULATE_TRACK_CHG_TO_CT_KEY                         (0x0041) 
#define CSR_BT_AVRCP_PASS_THR_FORWARD_KEY                                 (0x0042)
#define CSR_BT_AVRCP_PASS_THR_BACK_KEY                                    (0x0043)
#define CSR_BT_AVRCP_PASS_THR_PAUSE_KEY                                   (0x0044)
