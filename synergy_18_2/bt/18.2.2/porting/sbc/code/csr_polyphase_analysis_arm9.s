...
;;               All rights reserved
;;
;;FILE:          csr_polyphase_analysis_arm9.s
;;
;;DESCRIPTION:   Sub-Band Codec (decoder and encoder). This file
;;       is specially designed for the ARM9 standard processor
;;
;;REVISION:      #1 $hn02 $This file is and optimized version of
;;             "csr_polyphase_analysis.c" rev. 3 
;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    CODE32  
...
loop_SB4
    ...
    SUB r6,r11,#0x1BC0  ; r6 = cos(4*pi/16) = cos4 (= cos2 - 0x1BC0)
    MOV r6,r6,LSL #16   ; r6 = cos4 << 16
    MOV r11,r11,LSL #16 ; r11 = cos2 << 16
    MOV r12,r12,LSL #16 ; r12 = cos6 << 16

    SMULL   r3,r5,r7,r6 ; r5 = y0_cos4

    ;; Calculates   sptr[0] = r7 = ((y0_cos4 + y[2])>>1 + (y1_cos2 + y5_cos6)>>1)
    SMULL   r3,r6,r8,r11    ; r6 = y1_cos2
    SMLAL   r3,r6,r10,r12   ; r6 = y1_cos2 + y5_cos6

    ;; Now we're freeing r8, r10 and r12
    SMULL   r3,r12,r8,r12   ; r12 = y1_cos6 (this is done to free r8)
    SMULL   r3,r11,r10,r11  ; r11 = y5_cos2 (this is done to free r10)
    ...
    ;; Total of 134 instructions between STMFD and LDMFD (this is ?? more than the C implementation (96))
    ;; but this is with unrolled for loops
    ;; 
    ;; So in total this yields 4+135*2 = 274 linies of instructions with 2 channels which should be 
    ;; compared to (7+2+4*2+26*8*2+18*2+40*2+1) = 550 linies of instructions for the C implementation
    ;;
    ;; In short Assembly    = 274 instructions (this is 6 more than for the ARM9E processors)
    ;;      C       = 550 instructions
...
loop_SB8
    ...
    ;; First we calculates y[0] = r7 = (y[0] + y[8]) >> 16
    LDRSH   r5,[r4,#0x20]   ; r5 = C_SB8[16]
    LDRSH   r6,[r2,#0x20]   ; r6 = audio_window[0][16]
    MUL r7,r5,r6    ; r7 = C_SB8[16]*audio_window[0][16]
    LDRSH   r5,[r4,#0x40]   ; r5 = C_SB8[32]
    LDRSH   r6,[r2,#0x40]   ; r6 = audio_window[0][32]
    MLA r7,r5,r6,r7 ; r7 += C_SB8[32]*audio_window[0][32]
    LDRSH   r5,[r4,#0x60]   ; r5 = C_SB8[48]
    LDRSH   r6,[r2,#0x60]   ; r6 = audio_window[0][48]
    MLA r7,r5,r6,r7 ; r7 += C_SB8[48]*audio_window[0][48]
    LDRSH   r5,[r4,#0x80]   ; r5 = C_SB8[64]
    LDRSH   r6,[r2,#0x80]   ; r6 = audio_window[0][64]
    MLA r7,r5,r6,r7 ; r7 += C_SB8[64]*audio_window[0][64]
    MOV r11,r7,ASR #1   ; r11 = y[0] >> 1

    LDRSH   r5,[r4,#0x10]   ; r5 = C_SB8[8]
    LDRSH   r6,[r2,#0x10]   ; r6 = audio_window[0][8]
    MUL r7,r5,r6    ; r7 += C_SB8[8]*audio_window[0][8]
    LDRSH   r5,[r4,#0x30]   ; r5 = C_SB8[24]
    LDRSH   r6,[r2,#0x30]   ; r6 = audio_window[0][24]
    MLA r7,r5,r6,r7 ; r7 += C_SB8[24]*audio_window[0][24]
    LDRSH   r5,[r4,#0x50]   ; r5 = C_SB8[40]
    LDRSH   r6,[r2,#0x50]   ; r6 = audio_window[0][40]
    MLA r7,r5,r6,r7 ; r7 += C_SB8[40]*audio_window[0][40]
    LDRSH   r5,[r4,#0x70]   ; r5 = C_SB8[54]
    LDRSH   r6,[r2,#0x70]   ; r6 = audio_window[0][54]
    MLA r7,r5,r6,r7 ; r7 += C_SB8[54]*audio_window[0][54]
    LDRSH   r5,[r4,#0x90]   ; r5 = C_SB8[72]
    LDRSH   r6,[r2,#0x90]   ; r6 = audio_window[0][72]
    MLA r7,r5,r6,r7 ; r7 += C_SB8[72]*audio_window[0][72]
    MOV r7,r7,ASR #1    ; r7 = y[8] >> 1
    ADD r7,r7,r11   ; r7 = (y[0] + y[8]) >> 1
    
    ;; Second we calculates y[1] = r8 = (y[1] + y[7]) >> 16
    LDRSH   r5,[r4,#0x02]   ; r5 = C_SB8[1]
    LDRSH   r6,[r2,#0x02]   ; r6 = audio_window[0][1]
    MUL r8,r5,r6    ; r8 = C_SB8[1]*audio_window[0][1]
    LDRSH   r5,[r4,#0x22]   ; r5 = C_SB8[17]
    LDRSH   r6,[r2,#0x22]   ; r6 = audio_window[0][17]
    MLA r8,r5,r6,r8 ; r8 += C_SB8[17]*audio_window[0][17]
    LDRSH   r5,[r4,#0x42]   ; r5 = C_SB8[33]
    LDRSH   r6,[r2,#0x42]   ; r6 = audio_window[0][33]
    MLA r8,r5,r6,r8 ; r8 += C_SB8[33]*audio_window[0][33]
    LDRSH   r5,[r4,#0x62]   ; r5 = C_SB8[49]
    LDRSH   r6,[r2,#0x62]   ; r6 = audio_window[0][49]
    MLA r8,r5,r6,r8 ; r8 += C_SB8[49]*audio_window[0][49]
    LDRSH   r5,[r4,#0x82]   ; r5 = C_SB8[65]
    LDRSH   r6,[r2,#0x82]   ; r6 = audio_window[0][65]
    MLA r8,r5,r6,r8 ; r8 += C_SB8[65]*audio_window[0][65]
    MOV r11,r8,ASR #1   ; r11 = y[1] >> 1

    LDRSH   r5,[r4,#0x0e]   ; r5 = C_SB8[7]
    LDRSH   r6,[r2,#0x0e]   ; r6 = audio_window[0][7]
    MUL r8,r5,r6    ; r8 += C_SB8[7]*audio_window[0][7]
    LDRSH   r5,[r4,#0x2e]   ; r5 = C_SB8[23]
    LDRSH   r6,[r2,#0x2e]   ; r6 = audio_window[0][23]
    MLA r8,r5,r6,r8 ; r8 += C_SB8[23]*audio_window[0][23]
    LDRSH   r5,[r4,#0x4e]   ; r5 = C_SB8[39]
    LDRSH   r6,[r2,#0x4e]   ; r6 = audio_window[0][39]
    MLA r8,r5,r6,r8 ; r8 += C_SB8[39]*audio_window[0][39]
    LDRSH   r5,[r4,#0x6e]   ; r5 = C_SB8[55]
    LDRSH   r6,[r2,#0x6e]   ; r6 = audio_window[0][55]
    MLA r8,r5,r6,r8 ; r8 += C_SB8[55]*audio_window[0][55]
    LDRSH   r5,[r4,#0x8e]   ; r5 = C_SB8[71]
    LDRSH   r6,[r2,#0x8e]   ; r6 = audio_window[0][71]
    MLA r8,r5,r6,r8 ; r8 += C_SB8[71]*audio_window[0][71]
    MOV r8,r8,ASR #1    ; r8 = y[7] >> 1
    ADD r0,r8,r11   ; r0 = (y[1] + y[7]) >> 1

    ;; Theird we calculates y[2] = r9 = (y[2] + y[6]) >> 16
    LDRSH   r5,[r4,#0x04]   ; r5 = C_SB8[2]
    LDRSH   r6,[r2,#0x04]   ; r6 = audio_window[0][2]
    MUL r9,r5,r6    ; r9 = C_SB8[2]*audio_window[0][2]
    LDRSH   r5,[r4,#0x24]   ; r5 = C_SB8[18]
    LDRSH   r6,[r2,#0x24]   ; r6 = audio_window[0][18]
    MLA r9,r5,r6,r9 ; r9 += C_SB8[18]*audio_window[0][18]
    LDRSH   r5,[r4,#0x44]   ; r5 = C_SB8[34]
    LDRSH   r6,[r2,#0x44]   ; r6 = audio_window[0][34]
    MLA r9,r5,r6,r9 ; r9 += C_SB8[33]*audio_window[0][34]
    LDRSH   r5,[r4,#0x64]   ; r5 = C_SB8[50]
    LDRSH   r6,[r2,#0x64]   ; r6 = audio_window[0][50]
    MLA r9,r5,r6,r9 ; r9 += C_SB8[50]*audio_window[0][50]
    LDRSH   r5,[r4,#0x84]   ; r5 = C_SB8[66]
    LDRSH   r6,[r2,#0x84]   ; r6 = audio_window[0][66]
    MLA r9,r5,r6,r9 ; r9 += C_SB8[66]*audio_window[0][66]
    MOV r11,r9,ASR #1   ; r11 = y[2] >> 1

    LDRSH   r5,[r4,#0x0c]   ; r5 = C_SB8[6]
    LDRSH   r6,[r2,#0x0c]   ; r6 = audio_window[0][6]
    MUL r9,r5,r6    ; r9 += C_SB8[6]*audio_window[0][6]
    LDRSH   r5,[r4,#0x2c]   ; r5 = C_SB8[22]
    LDRSH   r6,[r2,#0x2c]   ; r6 = audio_window[0][22]
    MLA r9,r5,r6,r9 ; r9 += C_SB8[22]*audio_window[0][22]
    LDRSH   r5,[r4,#0x4c]   ; r5 = C_SB8[38]
    LDRSH   r6,[r2,#0x4c]   ; r6 = audio_window[0][38]
    MLA r9,r5,r6,r9 ; r9 += C_SB8[38]*audio_window[0][38]
    LDRSH   r5,[r4,#0x6c]   ; r5 = C_SB8[54]
    LDRSH   r6,[r2,#0x6c]   ; r6 = audio_window[0][54]
    MLA r9,r5,r6,r9 ; r9 += C_SB8[54]*audio_window[0][54]
    LDRSH   r5,[r4,#0x8c]   ; r5 = C_SB8[70]
    LDRSH   r6,[r2,#0x8c]   ; r6 = audio_window[0][70]
    MLA r9,r5,r6,r9 ; r9 += C_SB8[70]*audio_window[0][70]
    MOV r9,r9,ASR #1    ; r9 = y[6] >> 1
    ADD r9,r9,r11   ; r9 = (y[2] + y[6]) >> 1
    
    ;; Fourth we calculates y[3] = r10 = (y[3] + y[5]) >> 16
    LDRSH   r5,[r4,#0x06]   ; r5 = C_SB8[3]
    LDRSH   r6,[r2,#0x06]   ; r6 = audio_window[0][3]
    MUL r10,r5,r6   ; r10 = C_SB8[3]*audio_window[0][3]
    LDRSH   r5,[r4,#0x26]   ; r5 = C_SB8[19]
    LDRSH   r6,[r2,#0x26]   ; r6 = audio_window[0][19]
    MLA r10,r5,r6,r10   ; r10 += C_SB8[19]*audio_window[0][19]
    LDRSH   r5,[r4,#0x46]   ; r5 = C_SB8[35]
    LDRSH   r6,[r2,#0x46]   ; r6 = audio_window[0][35]
    MLA r10,r5,r6,r10   ; r10 += C_SB8[35]*audio_window[0][35]
    LDRSH   r5,[r4,#0x66]   ; r5 = C_SB8[51]
    LDRSH   r6,[r2,#0x66]   ; r6 = audio_window[0][51]
    MLA r10,r5,r6,r10   ; r10 += C_SB8[51]*audio_window[0][51]
    LDRSH   r5,[r4,#0x86]   ; r5 = C_SB8[67]
    LDRSH   r6,[r2,#0x86]   ; r6 = audio_window[0][67]
    MLA r10,r5,r6,r10   ; r10 += C_SB8[67]*audio_window[0][67]
    MOV r11,r10,ASR #1  ; r11 = y[3] >> 1

    LDRSH   r5,[r4,#0x0a]   ; r5 = C_SB8[5]
    LDRSH   r6,[r2,#0x0a]   ; r6 = audio_window[0][5]
    MUL r10,r5,r6   ; r10 += C_SB8[5]*audio_window[0][5]
    LDRSH   r5,[r4,#0x2a]   ; r5 = C_SB8[21]
    LDRSH   r6,[r2,#0x2a]   ; r6 = audio_window[0][21]
    MLA r10,r5,r6,r10   ; r10 += C_SB8[21]*audio_window[0][21]
    LDRSH   r5,[r4,#0x4a]   ; r5 = C_SB8[37]
    LDRSH   r6,[r2,#0x4a]   ; r6 = audio_window[0][37]
    MLA r10,r5,r6,r10   ; r10 += C_SB8[37]*audio_window[0][37]
    LDRSH   r5,[r4,#0x6a]   ; r5 = C_SB8[53]
    LDRSH   r6,[r2,#0x6a]   ; r6 = audio_window[0][53]
    MLA r10,r5,r6,r10   ; r10 += C_SB8[53]*audio_window[0][53]
    LDRSH   r5,[r4,#0x8a]   ; r5 = C_SB8[69]
    LDRSH   r6,[r2,#0x8a]   ; r6 = audio_window[0][69]
    MLA r10,r5,r6,r10   ; r10 += C_SB8[69]*audio_window[0][69]
    MOV r10,r10,ASR #1  ; r10 = y[5] >> 1
    ADD r1,r10,r11  ; r1 = (y[3] + y[5]) >> 1
    
    ;; Fifth we calculates y[4] = r11 = y[4] >> 15
    LDRSH   r5,[r4,#0x08]   ; r5 = C_SB8[4]
    LDRSH   r6,[r2,#0x08]   ; r6 = audio_window[0][4]
    MUL r11,r5,r6   ; r11 = C_SB8[4]*audio_window[0][4]
    LDRSH   r5,[r4,#0x28]   ; r5 = C_SB8[20]
    LDRSH   r6,[r2,#0x28]   ; r6 = audio_window[0][20]
    MLA r11,r5,r6,r11   ; r11 += C_SB8[20]*audio_window[0][20]
    LDRSH   r5,[r4,#0x48]   ; r5 = C_SB8[36]
    LDRSH   r6,[r2,#0x48]   ; r6 = audio_window[0][36]
    MLA r11,r5,r6,r11   ; r11 += C_SB8[36]*audio_window[0][36]
    LDRSH   r5,[r4,#0x68]   ; r5 = C_SB8[52]
    LDRSH   r6,[r2,#0x68]   ; r6 = audio_window[0][52]
    MLA r11,r5,r6,r11   ; r11 += C_SB8[52]*audio_window[0][52]
    LDRSH   r5,[r4,#0x88]   ; r5 = C_SB8[68]
    LDRSH   r6,[r2,#0x88]   ; r6 = audio_window[0][68]
    MLA r11,r5,r6,r11   ; r11 += C_SB8[68]*audio_window[0][68]
    ...
    MOV r11,r11,LSL #16 ; r11 = cos1 << 16
    MOV r12,r12,LSL #16 ; r12 = cos7 << 16
    MOV r5,r5,LSL #16   ; r5 = cos3 << 16
    MOV r6,r6,LSL #16   ; r6 = cos5 << 16
    ...
    ;; t11 = (((y1_cos3 + y9_cos5) >> 1) + ((y3_cos1 + y11_cos7) >> 1)) >> 1
    ;; t12 = (((y1_cos5 - y9_cos3) >> 1) - ((y3_cos7 - y11_cos1) >> 1)) >> 1
    SMULL   r14,r9,r1,r11   ; r9 = y[3] * cos1
    SMLAL   r14,r9,r4,r12   ; r9 = y[3] * cos1 + y[11] * cos7
    MOV r9,r9,ASR #1    ; r9 = (y[3] * cos1 + y[11] * cos7) >> 1

    SMULL   r14,r10,r1,r12  ; r10 = y[3] * cos7
    SMULL   r14,r11,r4,r11  ; r11 = y[11] * cos1
    SUB r10,r10,r11 ; r10 = y[3] * cos7 - y[11] * cos1
    MOV r10,r10,ASR #1  ; r10 = (y[3] * cos7 - y[11] * cos1) >> 1

    LDR r11,A_SB8_cos1
    MOV r11,r11,LSL #16

    SMULL   r14,r8,r0,r5    ; r8 = y[1] * cos3
    SMLAL   r14,r8,r3,r6    ; r8 = y[1] * cos3 + y[9] * cos5
    MOV r8,r8,ASR #1    ; r8 = (y[1] * cos3 + y[9] * cos5) >> 1
    ADD r7,r8,r9    ; r7 = ((y[1] * cos3 + y[9] * cos5) >> 1) + ((y3_cos1 + y11_cos7) >> 1)
    MOV r7,r7,ASR #1    ; r7 = t11 = (((y[1] * cos3 + y[9] * cos5) >> 1) + ((y3_cos1 + y11_cos7) >> 1)) >> 1
    
    SMULL   r14,r9,r0,r6    ; r9 = y[1] * cos5
    SMULL   r14,r8,r3,r5    ; r8 = y[9] * cos3
    ...
    ;; t13 = (((y1_cos7 + y9_cos1) >> 1) - ((y3_cos3 - y11_cos5) >> 1)) >> 1
    ;; t14 = (((y1_cos1 - y9_cos7) >> 1) - ((y3_cos5 + y11_cos3) >> 1)) >> 1
    SMULL   r14,r9,r1,r5    ; r9 = y[3] * cos3
    SMULL   r14,r10,r4,r6   ; r10 = y[11] * cos5
    SUB r9,r9,r10   ; r9 = y[3] * cos3 - y[11] * cos5
    MOV r9,r9,ASR #1    ; r9 = (y[3] * cos3 - y[11] * cos5) >> 1
    
    SMULL   r14,r10,r0,r12  ; r10 = y[1] * cos7
    SMLAL   r14,r10,r3,r11  ; r10 = y[1] * cos7 + y[9] * cos1
    ...
    SMULL   r14,r10,r0,r11  ; r10 = y[1] * cos1
    SMULL   r14,r12,r3,r12  ; r12 = y[9] * cos7
    SUB r10,r10,r12 ; r10 = y[1] * cos1 - y[9] * cos7
    MOV r10,r10,ASR #1  ; r10 = (y[1] * cos1 - y[9] * cos7) >> 1

    SMULL   r14,r11,r1,r6   ; r11 = y[3] * cos5
    SMLAL   r14,r11,r4,r5   ; r11 = y[3] * cos5 + y[11] * cos3
    ...
    ;; t01 = (y2_cos2 + y10_cos6) >> 1
    ;; t02 = (y2_cos6 - y10_cos2) >> 1
    SMULL   r14,r5,r3,r12   ; r5 = y[2] * cos6
    SMULL   r14,r6,r4,r11   ; r6 = y[10] * cos2
    SUB r6,r5,r6    ; r6 = y[2] * cos6 - y[10] * cos2
    MOV r6,r6,ASR #1    ; r6 = t02 = (y[2] * cos6 - y[10] * cos2) >> 1

    SMULL   r14,r5,r3,r11   ; r5 = y[2] * cos2
    SMLAL   r14,r5,r4,r12   ; r5 = y[2] * cos2 + y[10] * cos6
    MOV r5,r5,ASR #1    ; r5 = t01 = (y[2] * cos2 + y[10] * cos6) >> 1

    ;; now we calculate s01 and s02:
    ;; s01  = (y[4] + y0_cos4) >> 1
    ;; s02  = (y[4] - y0_cos4) >> 1
    MOV r11,r11,LSR #16 ; r11 = cos2 >> 16
    SUB r12,r11,#0x1BC0 ; r12 = cos(4*pi/16) = cos4
    MOV r12,r12,LSL #16 ; r12 = cos4 << 16
    SMULL   r14,r3,r0,r12   ; r3 = y[0] * cos4
    ADD r3,r3,r1    ; r3 = y[4] + y[0] * cos4
    MOV r3,r3,ASR #1    ; r3 = s01 = (y[4] + y[0] * cos4) >> 1

    SMULL   r14,r4,r0,r12   ; r4 = y[0] * cos4
    ...
    ;; Total of 317 instructions between STMFD and LDMFD (this is ???46 more than the C implementation (264))
    ;; but this is with unrolled for loops
    ;; 
    ;; So in total this yields 4+312*2+1 = 629 linies of instructions with 2 channels which should be 
    ;; compared to (5+3*2+5*2+27*16*2+(33+64+64+61)*2+1 = 1331 linies of instructions for the C implementation
    ;;
    ;; In short Assembly    = 629 instructions (this is 14 more than for the ARM9E processors)
    ;;      C       = 1331 instructions
