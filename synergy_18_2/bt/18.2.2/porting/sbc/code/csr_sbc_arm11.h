...
typedef struct
{
    ...
    CsrInt16 **audio_window1; /* array of elements [CSR_SBC_MAX_CHANNELS][CSR_SBC_MAX_WINDOW];*/ /* encoder */
    CsrInt16 **audio_window2; /* array of elements [CSR_SBC_MAX_CHANNELS][CSR_SBC_MAX_WINDOW];*/ /* encoder */
...
extern void polyPhaseAnalysisSB4(
    SbcHandle_t *hdl,
    CsrUint16 nof_channels_and_current_block,
    CsrInt16 **audio_window1,
    CsrInt16 **audio_window2);
