...
#if defined(ON_CHIP_DEBUG) && defined(XAP) && defined(FSM_DEBUG)
...
*/
extern void csrfsmlogentry(const char * name, CsrUint16 oldstate, CsrUint16 oldevt,
              CsrUint16 newstate, CsrUint16 func);
extern void csrfsmlogexit(const char * name, CsrUint16 newevt);
#else
