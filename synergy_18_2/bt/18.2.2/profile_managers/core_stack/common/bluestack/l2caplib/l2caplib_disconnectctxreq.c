...
\file   l2caplib_DisconnectCtxReq.c

\brief  Build and send an L2CA_DISCONNECT_REQ primitive to L2CAP.
*/
...
/*! \brief Send L2CA_DISCONNECT_REQ
    ...
    See \ref L2CA_DISCONNECT_REQ_T for more details.
*/
void L2CA_DisconnectCtxReq(CsrUint16 con_ctx)
{
