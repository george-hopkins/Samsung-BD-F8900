...
\file   l2caplib_GetChannelInfoReq.c

\brief  Build and send a L2CA_GET_CHANNEL_INFO_REQ primitive to L2CAP.
*/
...
/*! \brief Send L2CA_GET_CHANNEL_INFO_REQ
    ...
    See \ref L2CA_GET_CHANNEL_INFO_REQ_T for more details.
*/
