...
typedef CsrUint16  RFC_RESPONSE_T;
...
*----------------------------------------------------------------------------*/
typedef CsrUint8   RFC_LINE_STATUS_T;
...
typedef struct
{
    ...
    CsrSchedQid  phandle;           /*!< Protocol handle for callback */
    CsrUint8    flags;             /*!< Not currently used */
    CsrUint16   context;           /*!< User specified context */
    CsrUint8    loc_serv_chan_req; /*!< Serv. chan num the app would like to register */
...
typedef struct
{
    ...
    CsrSchedQid     phandle;          /*!< Protocol handle */
    CsrUint8       loc_serv_chan;    /*!< Local server channel */
    CsrBool        accept;           /*!< Accept flag */
    CsrUint16      context;          /*!< Echoed back from REQ */
...
typedef struct
{
    ...
    CsrUint8     loc_serv_chan;   /*!< The local server channel to be unregistered */
...
typedef struct
{
    ...
    CsrSchedQid        phandle;         /*!< Protocol handle */
    CsrUint8          loc_serv_chan;   /*!< The local server channel unregistered */
    RFC_RESPONSE_T   status;          /*!< Status of the request */
    CsrUint16         context;         /*!< Previously stored for this channel */
...
/*!
    ...
    \{
*/
#define RFC_CONNFLAG_BASIC          ((CsrUint16)0x0000)
#define RFC_CONNFLAG_ERTM           ((CsrUint16)0x0001)
#define RFC_CONNFLAG_REQUIRE_MODE   ((CsrUint16)0x0002)
/* \} */
...
typedef struct
{
    ...
    CsrSchedQid         phandle;              /*!< phandle for all messages associated with this channel */
    BD_ADDR_T         bd_addr;              /*!< Bluetooth address of remote device */
    CsrUint8           rem_serv_chan;        /*!< The remote server channel to connect as a client to */
    ...
    */
    CsrUint8           flags;
    CsrUint16          context;              /*!< Host specified context */

    /* Requested connection parameters.
    */
    CsrUint16          client_security_chan; /*!< Client chan id used for validating security access */
    CsrUint16          max_payload_size;     /*!< Maximum over the air RFCOMM data size */
    CsrUint8           priority;             /*!< Required but not used */
    CsrUint16          total_credits;        /*!< Credits available to the peer */
    ...
    CsrUint16          reserved_length;      /*!< Reserved for future use */
    CsrUint16          *reserved;            /*!< Reserved for future use */

    CsrUint8           modem_signal;         /*!< See Modem Status Request */
    CsrUint8           break_signal;         /*!< See Modem Status Request */
    CsrUint16          msc_timeout;          /*!< See Modem Status Request */
...
typedef struct
{
    ...
    CsrSchedQid          phandle;             /*!< phandle for all messages associated with this channel */
    BD_ADDR_T          bd_addr;             /*!< Bluetooth address of remote device */
    CsrUint8            loc_serv_chan;       /*!< The local server channel to which a client connection has been requested */
    CsrUint8            flags;               /*!< Currently unused, must be 0 */
    CsrUint16           conn_id;             /*!< Allocated connection id */
    CsrUint16           context;             /*!< Previously registered for this channel */
...
typedef struct
{
    ...
    CsrUint8           flags;                /*!< Additional options that can be set. */
    CsrUint16          conn_id;              /*!< Connection identifier. Unique whether the connection is a stream or not. */
...
typedef struct
{
    ...
    CsrSchedQid         phandle;              /*!< phandle for all messages associated with this channel */
    BD_ADDR_T         bd_addr;              /*!< Bluetooth address of remote device */
    CsrUint8           serv_chan;            /*!< server channel connected */
    CsrUint8           flags;                /*!< Additional options that were set. */
    CsrUint16          conn_id;              /*!< Connection identifier. Unique whether the connection is a stream or not. */
...
typedef struct
{
    ...
    CsrUint16   conn_id; /*!< Connection id */
...
typedef struct
{
    ...
    CsrUint8  data_bits;        /*!< As per #defines above */
    CsrUint8  stop_bits;        /*!< As per #defines above */
    CsrUint8  parity;           /*!< As per #defines above */
    CsrUint8  parity_type;      /*!< As per #defines above */
    CsrUint8  flow_ctrl_mask;   /*!< 6 bits - As per #defines above */
    CsrUint8  xon;              /*!< xon character  (default DC1) */
    CsrUint8  xoff;             /*!< xoff character (default DC3) */
    CsrUint16 parameter_mask;   /*!< As per #defines above (NB. top two bits reserved) */
...
typedef struct
{
    ...
    CsrUint16              conn_id;     /*!< Connection id */
    CsrBool                request;     /*!< Request for remote parameters */
...
typedef struct
{
    ...
    CsrSchedQid             phandle;     /*!< Routing phandle */
    CsrUint16              conn_id;     /*!< Connection id */
    RFC_PORTNEG_VALUES_T  port_pars;   /*!< Port Parameters */
...
typedef struct
{
    ...
    CsrSchedQid       phandle;          /*!< Routing phandle */
    CsrUint16        conn_id;          /*!< Connection id */
    CsrBool          request;          /*!< a request (See TS07.10 5.4.3.6.9) */
    RFC_PORTNEG_VALUES_T  port_pars;  /*!< Port Parameters */
...
typedef struct
{
    ...
    CsrUint16        conn_id;          /* Connection id - either stream or channel depending on flags */
    RFC_PORTNEG_VALUES_T  port_pars;   /* Port Parameters */
...
typedef struct
{
    ...
    CsrUint16   conn_id;       /*!< Connection id */
    CsrUint8    modem_signal;  /*!< modem signal - see #defines above */
    CsrUint8    break_signal;  /*!< Bit 0: 1 if break signal encoded, 0 otherwise */
                              /*!< Bits 1-2: Reserved */
...
typedef struct
{
    ...
    CsrUint16       conn_id;          /*!< Connection id */
    CsrUint16       payload_length;   /*!< Length of the payload */
    CsrMblk         *payload;         /*!< Pointer to the data */
    CsrUint16       rx_credits;       /*!< Normally the host would be expected to set
...
typedef struct
{
    ...
    CsrUint16      conn_id;          /*!< Connection id */
    CsrBool        error_flag;       /*!< error flag - TRUE if error */
...
typedef struct
{
    ...
    BD_ADDR_T  bd_addr;          /*!< Bluetooth address of remote device */
    CsrUint16   test_data_length; /*!< Length of the test data */
    CsrMblk     *test_data;       /*!< Pointer to the data */
...
typedef struct
{
    ...
    CsrSchedQid  phandle;          /*!< Routing phandle */
    BD_ADDR_T  bd_addr;          /*!< Bluetooth address of remote device */
    CsrUint8    command_type;     /*!< NSC command type */
    CsrUint8    cmd_res;          /*!< C/R bit value */
