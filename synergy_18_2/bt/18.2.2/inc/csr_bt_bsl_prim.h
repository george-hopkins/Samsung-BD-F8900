...
#define CSR_BT_BSL_ID_DEST_ADDR                  ((CsrUint16) (0x01) )
#define CSR_BT_BSL_ID_MULTI_TO_LOCAL             ((CsrUint16) (0x01) )
#define CSR_BT_BSL_ID_MULTI_NO_LOCAL             ((CsrUint16) (0x00) )
...
#define CSR_BT_BSL_PRIM_UPSTREAM_HIGHEST                      (0x0008 + CSR_BT_BSL_PRIM_UPSTREAM_LOWEST)
