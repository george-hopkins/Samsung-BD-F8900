...
#define CSR_BT_NUMBER_OF_CSR_BT_EVENTS            (0x0134 - CSR_BT_CPL_PRIM_BASE + 1)
...
#define CSR_BT_LINK_STATUS_PARK                           (CSR_BT_PARK_MODE)
#endif
...
/* Low Energy advertisement/EIR types (BT4.0) */
#define CSR_BT_EIR_DATA_TYPE_SLAVE_CONN_INTERVAL           (0x12)
#define CSR_BT_EIR_DATA_TYPE_SERVICE_LIST_16               (0x14)
#define CSR_BT_EIR_DATA_TYPE_SERVICE_LIST_128              (0x15)
#define CSR_BT_EIR_DATA_TYPE_SERVICE_DATA                  (0x16)
...
/* Extended invalid attribute handle use by GATT */
#define CSR_BT_GATT_SERVICE_CHANGED_NOT_FOUND 0x00000000
