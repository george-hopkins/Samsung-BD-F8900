...
typedef enum dm_prim_tag
{
    /* DM_AM_REGISTER_REQ for old API.
       ...
       the firmware will reply with CSR_SCHED_QID_INVALID.*/
...
#ifdef CSR_ONLY
    /* TODO no ENUM_DM_HCI_CHANGE_CONN_PKT_TYPE_CFM */
#endif
...
#ifdef CSR_ONLY
    /* TODO no USER (CONFIRMATION|PASSKEY) COMPLETE */
#endif
...
typedef CsrUint16                amp_link_id_t;

/* primitive type for dm */
typedef CsrUint16                 dm_prim_t;
...
typedef struct
{
    ...
    CsrUint8             status;             /* Success or failure - See Note1 */
...
typedef struct
{
    ...
    CsrUint16                flags;          /* Reserved - set to 0 */
...
typedef struct
{
    ...
    CsrSchedQid               phandle;        /* destination phandle */
    CsrUint16                version;        /* Bluestack version */
    CsrUint16                patch_level;    /* Bluestack patch level */
...
typedef struct
{
    ...
    CsrUint8                 version;        /* Requested version */
...
typedef struct
{
    ...
    CsrSchedQid               phandle;        /* destination phandle */
    CsrUint8                 version;        /* Requested version if success, */
    CsrUint8                 status;         /* or current version if failure */
...
/* Reasons */
#define DM_BAD_MESSAGE_NO_PHANDLE       ((CsrUint16)0x0001)
#define DM_BAD_MESSAGE_NOT_RECOGNISED   ((CsrUint16)0x0002)

typedef struct
{
    dm_prim_t               type;           /* Always DM_BAD_MESSAGE_IND */
    CsrSchedQid               phandle;        /* destination phandle */
    CsrUint16                reason;         /* What went wrong */
    CsrUint8                 protocol;       /* L2CAP_PRIM/RFCOMM_PRIM/etc */
    CsrUint16                request_type;   /* Enumerated type within protocol*/
    CsrUint16                message_length; /* Length of returned message */
    CsrUint8                 *message;       /* Returned message */
...
typedef struct
{
    ...
    CsrUint16 scan_interval;         /* These six parameters correspond to */
    CsrUint16 scan_window;           /* those in HCI_ULP_CREATE_CONNECTION_T */
    CsrUint16 conn_interval_min;     /* and are used to fill that primitive */
    CsrUint16 conn_interval_max;     /* when it is created. If they are not */
    CsrUint16 conn_latency;          /* set explicitly here then the Device */
    CsrUint16 supervision_timeout;   /* Manager will choose defaults. */
    CsrUint16 conn_attempt_timeout;  /* Equivalent of Page Timeout in BR/EDR */
    CsrUint16 adv_interval_min;      /* Used when setting parameters for */
    CsrUint16 adv_interval_max;      /* undirected connect-as-slave advertising*/
    CsrUint16 conn_latency_max;        /* The 3 parameters are used to define the conditions */
    CsrUint16 supervision_timeout_min; /* to accept a  */
    CsrUint16 supervision_timeout_max; /* L2CA_CONNECTION_PAR_UPDATE_REQ_T*/
...
typedef struct
{
    ...
    CsrSchedQid               phandle;        /* client phandle */
    CsrUint16                pv_cbarg;
} DM_SYNC_UNREGISTER_REQ_T;

#define DM_SYNC_UNREGISTER_SUCCESS          ((CsrUint8)0)
#define DM_SYNC_UNREGISTER_NOT_FOUND        ((CsrUint8)1)
#define DM_SYNC_UNREGISTER_BUSY             ((CsrUint8)2)
typedef struct
{
...
typedef union
{
    ...
    CsrUint16            *conftab;       /* Not currently used. */
...
typedef struct
{
    ...
    CsrUint16                length;         /* Reserved. Shall be set to zero.*/
...
typedef struct
{
    ...
    CsrUint16                pv_cbarg;
    BD_ADDR_T               bd_addr;        /* Bluetooth device address */
    CsrUint8                 link_type;      /* HCI_LINK_TYPE_SCO/ESCO */
    CsrUint24                dev_class;
...
typedef struct
{
    ...
    BD_ADDR_T               bd_addr;        /* Bluetooth device address */
    CsrUint8                 response;       /* HCI_SUCCESS or appropriate HCI_ERROR_ code */
...
typedef CsrUint8 dm_security_mode_t;
...
typedef CsrUint16 dm_security_level_t;
...
typedef struct
{
    ...
    CsrSchedQid           phandle;        /* destination phandle */
    CsrUint16            context;        /* Opaque context */
    DM_SM_SERVICE_T     service;        /* Protocol and channel */
    CsrBool              outgoing_ok;    /* TRUE if applies to outgoing */
...
typedef struct
{
    ...
    CsrUint8             max_enc_key_size_thres; /* Maximun enc key size threshold param */
    CsrUint8             min_enc_key_size_thres; /* Minimum enc key size threshold param */
} DM_SM_INIT_REQ_T;
...
#define DM_SM_INIT_FAIL_UNSUPPORTED_SECURITY_MODE           ((CsrUint16)0x0001)
/* HCI_WRITE_SIMPLE_PAIRING_MODE failed. Can't start Security Mode 4 */
#define DM_SM_INIT_FAIL_WRITE_SIMPLE_PAIRING_MODE           ((CsrUint16)0x0002)
/* HCI_WRITE_SIMPLE_PAIRING_DEBUG_MODE failed. Can't debug Security Mode 4 */
#define DM_SM_INIT_FAIL_WRITE_SIMPLE_PAIRING_DEBUG_MODE     ((CsrUint16)0x0004)
/* HCI_WRITE_AUTH_ENABLE failed. Can't enter/exit Security Mode 3 */
#define DM_SM_INIT_FAIL_WRITE_AUTHENTICATION_ENABLE         ((CsrUint16)0x0008)
/* HCI_WRITE_ENC_MODE failed. Can't change Security Mode 3 encryption mode */
#define DM_SM_INIT_FAIL_WRITE_ENCRYPTION_MODE               ((CsrUint16)0x0010)
typedef struct
{
...
typedef struct
{
    ...
    CsrBool              authenticated;  /* TRUE if we need authenticated key */
    /* TRUE if this is security for an outgoing connection that we've initiated */
    CsrBool              initiated_outgoing;
    CsrUint16            rhsf;           /* Remote host's supported features */
...
/* key_type */
#define DM_SM_LINK_KEY_NONE                 ((CsrUint8) 0xFE)
...
typedef struct
{
    ...
    CsrBool              initiator;          /* TRUE if we initiated pairing */
...
typedef struct
{
    ...
    CsrUint8             pin_length;
    CsrUint8             pin[HCI_MAX_PIN_LENGTH];
...
typedef struct
{
    ...
    DM_CONNECTION_SETUP_T   cs;         /* Protocol, channel, bd_addr and direction */
    CsrUint16                authorisation;  /* Nature of authorisation */
...
typedef struct
{
    ...
    CsrUint16                flags;  /* See flags field in DM_COMMON_IND_T */
...
#define DM_SM_OOB_DATA_BOTH        0x01  /* When both Hash c and Rand r present
                                            OOB data for BR/EDR only */
#define DM_SM_OOB_DATA_HASHC_ONLY  0x02  /* OOB data for BLE only */
...
typedef struct
{
    ...
    CsrUint8                 *oob_hash_c;
    CsrUint8                 *oob_rand_r;
    CsrUint16                key_distribution;   /* BLE only */
...
typedef struct
{
    ...
    CsrUint32                numeric_value;      /* Value to compare */
    CsrUint8                 io_cap_local;       /* Effective IO capabilities of local device. */
    CsrUint8                 io_cap_remote;      /* Effective IO capabilities of remote device. */
    CsrUint16                flags;              /* See DM_COMMON_IND_T */
 ...
 *--------------------------------------------------------------------------*/
#define DM_SM_CONVERT_SM_ERROR(sm_error) ((CsrUint8)((sm_error) == 0 ? HCI_SUCCESS : (sm_error) + SM_ERROR_BASE))
...
typedef struct
{
    ...
    CsrUint16                flags;      /* Reserved and shall be set to 0 */
} DM_SM_BONDING_REQ_T;
...
typedef struct
{
    ...
    TYPED_BD_ADDR_T         addrt;      /* Remote device address */
    CsrUint16                flags;      /* See DM_ACL_OPEN_REQ */
...
typedef struct
{
    CsrUint16 link_key_type;
    CsrUint16 link_key[8];
...
typedef union
{
    DM_SM_KEY_ENC_BREDR_T *enc_bredr;
    DM_SM_KEY_ENC_CENTRAL_T *enc_central;
    CsrUint16 div;   /* Allows peripheral to reconstruct LTK and CSRK given to central */
    DM_SM_KEY_ID_T *id;
    DM_SM_KEY_SIGN_T *sign;
    void *none;
} DM_SM_UKEY_T;
...
typedef struct
{
    ...
    CsrUint16 connection_flags;      /* See l2ca_conflags_t in l2cap_prim.h */
    CsrUint16 context;               /* Opaque context returned in CFM */
    CsrUint16 security_requirements;
...
typedef struct
{
    ...
    CsrSchedQid phandle;              /* destination phandle */
    TYPED_BD_ADDR_T addrt;          /* Peer's address */
    CsrUint16 security_requirements; /* Security requirements of requested key */
    ...
    /* If (key_type == DM_SM_KEY_ENC_BREDR) then this primitive is being
       ...
       be ignored by the application. */
    CsrUint24            dev_class; /* Valid for incoming requests 0 otherwise */
    CsrBool              initiated_outgoing;
    CsrUint16            rhsf;           /* Remote host's supported features */
...
typedef struct
{
    ...
    CsrSchedQid           phandle;    /* phandle for response */
...
typedef struct
{
    ...
    CsrSchedQid phandle; /* am_phandle */
    CsrUint8 status;
    CsrUint8 permanent_address_type;
    TYPED_BD_ADDR_T static_addrt;
    DM_SM_PRIVACY_T privacy;
...
typedef struct
{
    ...
    BD_ADDR_T           bd_addr;            /* Bluetooth device address */
    CsrUint16            clock_offset;       /* the clock offset */
...
typedef struct
{
    ...
    CsrUint16               flags;             /*  Additional falgs ADD/REMOVE/REMOVE ALL */
...
typedef struct
{
    ...
    TYPED_BD_ADDR_T         addrt;          /* Remote device address */
    CsrUint16                flags;          /* Bitfield of options */
} DM_ACL_OPEN_REQ_T;
...
typedef struct
{
    ...
    CsrSchedQid               phandle;        /* Destination phandle */
    TYPED_BD_ADDR_T         addrt;          /* Remote device address */
    CsrBool                  success;        /* TRUE if open, FALSE if not */
} DM_ACL_OPEN_CFM_T;
...
typedef struct
{
    ...
    TYPED_BD_ADDR_T         addrt;     /* Remote device address */
    CsrUint16                flags;     /* See definitions for DM_ACL_OPEN_REQ */
    CsrUint8                 reason;    /* Only used if 'FORCE' flag set */
} DM_ACL_CLOSE_REQ_T;
...
typedef struct
{
    ...
    CsrSchedQid       phandle;    /* AMPM Message Queue ID */
...
*/
#ifdef CSR_ONLY
/*   TODO Do we need bd_addr and amp_id? Will AMPM have already made
   a note of the cid and just reference by that?
...
typedef struct
{
    ...
    CsrUint8             physical_link_id;/* AMP physical handle */
    amp_link_id_t       logical_link_id; /* AMP logical handle */
    CsrSchedQid           hci_data_queue;  /* Where L2CAP sends to-air data */
    L2CA_FLOWSPEC_T     tx_flowspec;     /* TX QOS parameters */
    L2CA_FLOWSPEC_T     rx_flowspec;     /* RX QOS parameters */
    hci_return_t        status;          /* Anything other than 0 is failure */
...
*/
#ifdef CSR_ONLY
/*   TODO Do we need all of the parameters? Presumably we could dispense with
   the AMP ID if we want. And is it possible for this command to fail? If
   not then do we need a status in the response, or can we dispense with the
   response altogether?
...
typedef struct
{
    ...
    CsrUint8             active_links;   /* Number of active links remaining */
...
typedef struct
{
    ...
    CsrSchedQid           phandle;    /* AMPM Message Queue ID */
    CsrUint8             status;     /* Anything other than 0 is failure */
...
typedef struct
{
    ...
    CsrSchedQid           phandle;      /* AMPM Message Queue ID */
    BD_ADDR_T           bd_addr;      /* Remote Bluetooth address */
    CsrUint16            identifier;   /* Request identifier to match up with CFM */
...
typedef struct
{
    ...
    BD_ADDR_T           bd_addr;      /* Remote Bluetooth address */
    CsrUint16            identifier;   /* Identifier given in the REQ */
    CsrBool              exists;       /* TRUE if link exists, FALSE if not */
...
typedef struct
{
    ...
    l2ca_controller_t   local_amp_id;               /* Local AMP controller ID */
    CsrUint8             status;                     /* Anything other than 0 is failure */
    CsrBool              fragmentable;               /* Whether we can fragment packets over HCI */
    CsrUint16            max_pdu_length;             /* Maximum l2cap PDU size */
    CsrUint16            max_acl_data_packet_length; /* Maximum size of ACL data packets over HCI */
    CsrUint16            data_block_length;          /* Size of data blocks */
    CsrUint16            total_num_data_blocks;      /* Total number of data blocks */
...
typedef struct
{
    ...
    CsrUint16            num_of_completed_packets;
    CsrUint16            num_of_completed_blocks;
...
typedef struct
{
    ...
    l2ca_controller_t   local_amp_id;               /* Local AMP controller ID */
    CsrUint16            total_num_data_blocks;      /* Change total number of credits. Maximum reduction equal to credits
                                                       returned by this primitive. 0 means: Send me a new
                                                       DM_AMPM_READ_DATA_BLOCK_SIZE_IND */
    CsrUint8             number_of_handles;          /* Total number of handles referenced by this primitive */
...
typedef struct
{
    ...
    CsrUint16 flags;                     /* Feature bitfield. See above. */
...
typedef struct {
    ...
    CsrUint8 physical_handle;            /* AMP physical link handle. Not used for BR/EDR */
    CsrUint16 logical_handle;            /* AMP logical link handle or BR/EDR ACL handle */
...
typedef struct
{
    ...
    CsrSchedQid           phandle;            /* destination phandle */
    CsrUint8             num_keys;           /* Number of link keys */
...
typedef struct
{
    ...
    CsrSchedQid           phandle;            /* destination phandle */
    CsrUint8             status;             /* Success or failure - See Note1 */
    CsrUint8             key_flag;           /* Regular/Temporary link key */
...
typedef struct
{
    ...
    CsrUint8             status;             /* Success or failure - See Note1 */
    BD_ADDR_T           bd_addr;            /* Bluetooth device address */
    CsrUint16            features[4];        /* LMP features */
...
typedef struct
{
    ...
    CsrUint8             status;             /* Success or failure - See Note1 */
    TYPED_BD_ADDR_T     addrt;              /* Bluetooth device address */
    CsrUint8             LMP_version;        /* Version of LMP */
    CsrUint16            manufacturer_name;  /* Name of manufacturer */
    CsrUint16            LMP_subversion;     /* Subversion of LMP */
...
typedef struct
{
    ...
    CsrUint8             status;             /* Success or failure - See Note1 */
    BD_ADDR_T           bd_addr;            /* Bluetooth device address */
    CsrUint16            clock_offset;       /* Device's clock offset */
...
typedef struct
{
    ...
    CsrUint8             status;             /* Success or failure - See Note1 */
    BD_ADDR_T           bd_addr;            /* Bluetooth device address */
    CsrUint8             mode;               /* Current mode */
    CsrUint16            length;             /* Length of mode (or similar) */
...
typedef struct
{
    ...
    CsrUint8             status;             /* status */
    BD_ADDR_T           bd_addr;            /* bd_addr of link */
    CsrUint16            link_policy;        /* link policy settings */
 ...
 *
 *----------------------------------------------------------------------------*/
typedef CsrUint8 lp_powermode_t;
...
typedef struct
{
    ...
    CsrUint16 attempt;
    CsrUint16 timeout;
    CsrUint16 duration; /* time to spend in this mode */
...
typedef struct
{
    dm_prim_t       type;
    BD_ADDR_T       bd_addr;    /* Bluetooth Device Address */
    CsrUint16        num_states; /* Number of states in list */
 ...
 *
 *----------------------------------------------------------------------------*/
#define LP_POWERSTATES_SUCCESS          ((CsrUint8)0) /* powerstates set successfully */
#define LP_POWERSTATES_UNSUPPORTED_MODE ((CsrUint8)1) /* unrecognised LP_POWERMODE */
#define LP_POWERSTATES_UNKNOWN_DEVICE   ((CsrUint8)2) /* unknown Bluetooth device */
#define LP_POWERSTATES_BAD_TERMINATION  ((CsrUint8)3) /* last state duration not zero */
#define LP_POWERSTATES_ERROR            ((CsrUint8)4) /* error described above */
typedef struct
{
    dm_prim_t   type;
    CsrSchedQid   phandle;            /* destination phandle */
 ...
 *
 *      Encoding
 *      Each 'row' in the table is encoded into a single CsrUint16.
...
typedef struct
{
    ...
    CsrUint16            version;            /* Must be set to 0 */
    CsrUint16            length;             /* Number of CsrUint16s in table */
    CsrUint16            *rs_table;          /* Pointer to role-switch table */
...
#define DM_LP_WRITE_ROLESWITCH_POLICY_SUCCESS               ((CsrUint8)0)
#define DM_LP_WRITE_ROLESWITCH_POLICY_ILLEGAL               ((CsrUint8)1)
#define DM_LP_WRITE_ROLESWITCH_POLICY_UNSUPPORTED           ((CsrUint8)2)
#define DM_LP_WRITE_ROLESWITCH_POLICY_NOT_ZERO_TERMINATED   ((CsrUint8)3)
typedef struct
{
    dm_prim_t           type;               /* Always DM_LP_WRITE_ROLESWITCH_POLICY_CFM */
    CsrSchedQid           phandle;            /* destination phandle */
    CsrUint8             status;             /* Indication of success or failure */
...
typedef struct
{
    ...
    CsrUint16            operation;      /* ADD, DELETE, CLEAR. */
...
typedef struct
{
    ...
    CsrSchedQid           phandle;            /* destination phandle */
    CsrUint8             status;             /* status */
    CsrUint16            conn_accept_timeout;/* the timeout value */
...
typedef struct
{
    ...
    CsrSchedQid           phandle;            /* destination phandle */
    CsrUint8             status;             /* status */
    CsrUint16            page_timeout;       /* the timeout value */
...
typedef struct
{
    ...
    CsrSchedQid           phandle;            /* destination phandle */
    CsrUint8             status;             /* status */
    CsrUint8             scan_enable;        /* return parameter */
...
typedef struct
{
    ...
    CsrUint16            FlushTimeout;       /* 11 bits of this number * 0.625ms */
...
/*! \brief DM LE primitives for master to accept/reject connection update param req

 *  Provides an indication to application to accept/reject connection parameters
 *  update request from a peripheral.
 *
 *  RETURNS
 *     A RSP
*/
