...
#define CSR_BT_AVRCP_TG_PRIM_DOWNSTREAM_HIGHEST                   (0x0012 + CSR_BT_AVRCP_TG_PRIM_DOWNSTREAM_LOWEST)
...
#define CSR_BT_AVRCP_CT_SET_SS_VOLUME_REQ          ((CsrBtAvrcpPrim) (0x0019 + CSR_BT_AVRCP_CT_PRIM_DOWNSTREAM_LOWEST))
...
#define CSR_BT_AVRCP_TG_PRIM_UPSTREAM_HIGHEST                     (0x0014 + CSR_BT_AVRCP_TG_PRIM_UPSTREAM_LOWEST)
...
#define CSR_BT_AVRCP_CT_PRIM_CFM_HIGHEST                          (0x0015 + CSR_BT_AVRCP_CT_PRIM_UPSTREAM_LOWEST)

#define CSR_BT_AVRCP_CT_PAS_ATT_TXT_IND            ((CsrBtAvrcpPrim) (0x0016 + CSR_BT_AVRCP_CT_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_AVRCP_CT_PAS_VAL_TXT_IND            ((CsrBtAvrcpPrim) (0x0017 + CSR_BT_AVRCP_CT_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_AVRCP_CT_PAS_SET_IND                ((CsrBtAvrcpPrim) (0x0018 + CSR_BT_AVRCP_CT_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_AVRCP_CT_NOTI_UIDS_IND              ((CsrBtAvrcpPrim) (0x0019 + CSR_BT_AVRCP_CT_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_AVRCP_CT_NOTI_VOLUME_IND            ((CsrBtAvrcpPrim) (0x001A + CSR_BT_AVRCP_CT_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_AVRCP_CT_NOTI_BATTERY_STATUS_IND    ((CsrBtAvrcpPrim) (0x001B + CSR_BT_AVRCP_CT_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_AVRCP_CT_NOTI_PLAYBACK_POS_IND      ((CsrBtAvrcpPrim) (0x001C + CSR_BT_AVRCP_CT_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_AVRCP_CT_NOTI_SYSTEM_STATUS_IND     ((CsrBtAvrcpPrim) (0x001D + CSR_BT_AVRCP_CT_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_AVRCP_CT_NOTI_TRACK_CHANGED_IND     ((CsrBtAvrcpPrim) (0x001E + CSR_BT_AVRCP_CT_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_AVRCP_CT_NOTI_TRACK_END_IND         ((CsrBtAvrcpPrim) (0x001F + CSR_BT_AVRCP_CT_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_AVRCP_CT_NOTI_TRACK_START_IND       ((CsrBtAvrcpPrim) (0x0020 + CSR_BT_AVRCP_CT_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_AVRCP_CT_NOTI_PLAYBACK_STATUS_IND   ((CsrBtAvrcpPrim) (0x0021 + CSR_BT_AVRCP_CT_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_AVRCP_CT_NOTI_AVAILABLE_PLAYERS_IND ((CsrBtAvrcpPrim) (0x0022 + CSR_BT_AVRCP_CT_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_AVRCP_CT_NOTI_NOW_PLAYING_IND       ((CsrBtAvrcpPrim) (0x0023 + CSR_BT_AVRCP_CT_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_AVRCP_CT_GET_ATTRIBUTES_IND         ((CsrBtAvrcpPrim) (0x0024 + CSR_BT_AVRCP_CT_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_AVRCP_CT_SET_ADDRESSED_PLAYER_IND   ((CsrBtAvrcpPrim) (0x0025 + CSR_BT_AVRCP_CT_PRIM_UPSTREAM_LOWEST))

#define CSR_BT_AVRCP_CT_PRIM_UPSTREAM_HIGHEST                     (0x0025 + CSR_BT_AVRCP_CT_PRIM_UPSTREAM_LOWEST)
...
#define CSR_BT_AVRCP_CONFIG_SR_FEAT_CAT1_PLAY_REC  ((CsrBtAvrcpConfigSrFeatureMask)(0x0001))  /**< Player/recorder */
#define CSR_BT_AVRCP_CONFIG_SR_FEAT_CAT2_MON_AMP   ((CsrBtAvrcpConfigSrFeatureMask)(0x0002))  /**< Monitor/amplifier */
#define CSR_BT_AVRCP_CONFIG_SR_FEAT_CAT3_TUNER     ((CsrBtAvrcpConfigSrFeatureMask)(0x0004))  /**< Tuner */
#define CSR_BT_AVRCP_CONFIG_SR_FEAT_CAT4_MENU      ((CsrBtAvrcpConfigSrFeatureMask)(0x0008))  /**< Menu */
#define CSR_BT_AVRCP_CONFIG_SR_FEAT_PAS            ((CsrBtAvrcpConfigSrFeatureMask)(0x0010))  /**< Player Application Settings */
#define CSR_BT_AVRCP_CONFIG_SR_FEAT_GROUP_NAV      ((CsrBtAvrcpConfigSrFeatureMask)(0x0020))  /**< Group Navigation */
#define CSR_BT_AVRCP_CONFIG_SR_FEAT_BROWSING       ((CsrBtAvrcpConfigSrFeatureMask)(0x0040))  /**< Browsing */
#define CSR_BT_AVRCP_CONFIG_SR_FEAT_MULTIPLE_MP    ((CsrBtAvrcpConfigSrFeatureMask)(0x0080))  /**< Multiple media players */
/*@}*/
...
#define CSR_BT_AVRCP_SECURITY_CONFIG_ALL           ((CsrBtAvrcpSecurityConfig)(CSR_BT_AVRCP_SECURITY_CONFIG_CONTROL | CSR_BT_AVRCP_SECURITY_CONFIG_BROWSING))
...
#define CSR_BT_AVRCP_ITEM_ATT_COUNT                (7)
...
#define CSR_BT_AVRCP_ITEM_ATT_MASK_ALL             ((CsrBtAvrcpItemAttMask)0x0000007F)
