...
/* --------------------------------------------------------------------
   ...
   in the Slave Role. The Peripheral role only supports
   one LE physical connection.
...
/* --------------------------------------------------------------------
   ...
   CsrBtGattAdvChannel _advChannelMap - Advertising Tx channel map
   -------------------------------------------------------------------- */
...
#define CsrBtGattParamAdvertiseReqSend(_gattId,_advIntervalMin,         \
                                       _advIntervalMax,_advChannelMap) { \
        CsrBtGattParamAdvertiseReq *msg__;                              \
        msg__ = CsrBtGattParamAdvertiseReq_struct(_gattId,_advIntervalMin, \
                                                  _advIntervalMax,_advChannelMap); \
        CsrBtGattMsgTransport(msg__);}
...
/* --------------------------------------------------------------------
   ...
   Description:
   Change default parameters for future connections
...
#define CsrBtGattWriteClientConfigurationReqSend(_gattId,_btConnId,_cliConfHdl, \
        ...
        msg__=CsrBtGattWriteClientConfigurationReq_struct(_gattId,_btConnId,_adrzero, \
                                                          _cliConfHdl,_valueHdl,_configBits); \
        CsrBtGattMsgTransport(msg__);}
...
#define CsrBtGattWriteClientConfigurationConnLessReqSend(_gattId,_address, \
        ...
        msg__=CsrBtGattWriteClientConfigurationReq_struct(_gattId,CSR_BT_GATT_LOCAL_BT_CONN_ID, \
                                                          _address,0,_valueHdl,_configBits); \
        CsrBtGattMsgTransport(msg__);}
...
#define CsrBtGattSubscribeReqSend(_gattId,_address,_handle) {           \
        ...
        msg__=CsrBtGattSubscriptionReq_struct(_gattId,_address,_handle,TRUE); \
        CsrBtGattMsgTransport(msg__);}
...
#define CsrBtGattUnsubscribeReqSend(_gattId,_address,_handle) {         \
        CsrBtGattSubscriptionReq *msg__;                                \
        msg__=CsrBtGattSubscriptionReq_struct(_gattId,_address,_handle,FALSE); \
        CsrBtGattMsgTransport(msg__);}
