...
#endif
#define HCI_REVISION    ((CsrUint16) 0x00)  /* HCI Revision in hardware */

/******************************************************************************
   Type Definitions
 *****************************************************************************/
typedef CsrUint16 hci_packet_boundary_flag_t;
typedef CsrUint16 hci_connection_handle_t;
typedef CsrUint16 hci_op_code_t;            /* used for commands  */
typedef CsrUint8  hci_event_code_t;         /* used for events    */
typedef CsrUint8  hci_return_t;             /* return value (error if !success) */
typedef CsrUint8  hci_error_t;
typedef CsrUint16 hci_pkt_type_t;
typedef CsrUint8  hci_role_t;               /* whether host controller is master or slave */
typedef CsrUint8  hci_key_flag_t;           /* type of link key */
typedef CsrUint8  hci_link_enc_t;           /* whether link encryption on or off */
typedef CsrUint8  hci_qos_type_t;           /* service type for QoS */
typedef CsrUint32 hci_event_mask_t;         /* event mask type.  This is 8 bytes in fact
                                              declared as an array[2].  Only 4 ls bytes used */
typedef CsrUint8  hci_version_t;            /* version info */
typedef CsrUint8  hci_bt_mode_t;            /* used for indicating state change */
typedef CsrUint8  hci_reason_t;             /* Reason for command */
typedef CsrUint8  page_scan_rep_mode_t;     /* Page scan repetition mode */
typedef CsrUint16 clock_offset_t;           /* Clock offset */
typedef CsrUint16 link_policy_settings_t;   /* Link policy settings */
typedef CsrUint8  filter_type_t;            /* Event filter type */
typedef CsrUint8  filter_condition_type_t;  /* Inquiry Result Filter Condition Type */
typedef CsrUint8  pin_type_t;               /* Pin Type */
typedef CsrUint8  read_all_flag_t;
typedef CsrUint8  delete_all_flag_t;
typedef CsrUint8  auto_accept_t;
typedef CsrUint8  flushable_packet_type_t;  /* Type of packet to be flushed during
                                              enhanced flush operation */
#ifdef INSTALL_AMP_SUPPORT
typedef CsrUint32 l2ca_hci_buffer_size_t; /*!< Buffer size with AMP */
#else
typedef CsrUint16 l2ca_hci_buffer_size_t; /*!< Buffer size */
#endif
...
/******************************************************************************
   ...
   hence the values
 *****************************************************************************/
#define HCI_OGF_BIT_OFFSET             ((CsrUint8)10) /* Number of bit shifts */
...
#define HCI_MAX_EVENT_OPCODE                    ((CsrUint8)0x3E)

/* ULP main event opcode*/
#define HCI_EV_ULP                              ((CsrUint8)0x3E)
/* Sub-opcodes */
#define HCI_EV_ULP_CONNECTION_COMPLETE          ((CsrUint8)0x01)
#define HCI_EV_ULP_ADVERTISING_REPORT           ((CsrUint8)0x02)
#define HCI_EV_ULP_CONNECTION_UPDATE_COMPLETE   ((CsrUint8)0x03)
#define HCI_EV_ULP_READ_REMOTE_USED_FEATURES_COMPLETE   ((CsrUint8)0x04)
#define HCI_EV_ULP_LONG_TERM_KEY_REQUESTED      ((CsrUint8)0x05)

/*
 * Note:
 * The HCI_EV_MANUFACTURER_EXTENSION definition below, uses CsrUint8 instead of
 ...
 */
#define HCI_EV_MANUFACTURER_EXTENSION           ((CsrUint8)0xFF)
...
#define HCI_INQUIRY_PARAM_LEN                    ((CsrUint8) 5)
#define HCI_INQUIRY_CANCEL_PARAM_LEN             ((CsrUint8) 0)
#define HCI_PERIODIC_INQUIRY_MODE_PARAM_LEN      ((CsrUint8) 9)
#define HCI_EXIT_PERIODIC_INQUIRY_MODE_PARAM_LEN ((CsrUint8) 0)
#define HCI_CREATE_CONNECTION_PARAM_LEN          ((CsrUint8) 13)
#define HCI_DISCONNECT_PARAM_LEN                 ((CsrUint8) 3)
#define HCI_ADD_SCO_CONNECTION_PARAM_LEN         ((CsrUint8) 4)
#define HCI_CREATE_CONNECTION_CANCEL_PARAM_LEN   ((CsrUint8) 6)
#define HCI_ACCEPT_CONNECTION_REQ_PARAM_LEN      ((CsrUint8) 7)
#define HCI_REJECT_CONNECTION_REQ_PARAM_LEN      ((CsrUint8) 7)
#define HCI_LINK_KEY_REQ_REPLY_PARAM_LEN         ((CsrUint8) 22)
#define HCI_LINK_KEY_REQ_NEG_REPLY_PARAM_LEN     ((CsrUint8) 6)
#define HCI_PIN_CODE_REQ_REPLY_PARAM_LEN         ((CsrUint8) 23)
#define HCI_PIN_CODE_REQ_NEG_REPLY_PARAM_LEN     ((CsrUint8) 6)
#define HCI_CHANGE_CONN_PKT_TYPE_PARAM_LEN       ((CsrUint8) 4)
#define HCI_AUTH_REQ_PARAM_LEN                   ((CsrUint8) 2)
#define HCI_SET_CONN_ENCRYPTION_PARAM_LEN        ((CsrUint8) 3)
#define HCI_CHANGE_CONN_LINK_KEY_PARAM_LEN       ((CsrUint8) 2)
#define HCI_MASTER_LINK_KEY_PARAM_LEN            ((CsrUint8) 1)
#define HCI_REMOTE_NAME_REQ_PARAM_LEN            ((CsrUint8) 10)
#define HCI_REMOTE_NAME_REQ_CANCEL_PARAM_LEN     ((CsrUint8) 6)
#define HCI_READ_REMOTE_SUPP_FEATURES_PARAM_LEN  ((CsrUint8) 2)
#define HCI_READ_REMOTE_EXT_FEATURES_PARAM_LEN   ((CsrUint8) 3)
#define HCI_READ_REMOTE_VER_INFO_PARAM_LEN       ((CsrUint8) 2)
#define HCI_READ_CLOCK_OFFSET_PARAM_LEN          ((CsrUint8) 2)
#define HCI_READ_LMP_HANDLE_PARAM_LEN            ((CsrUint8) 2)
#define HCI_EXCHANGE_FIXED_INFO_PARAM_LEN        ((CsrUint8) 2)
#define HCI_EXCHANGE_ALIAS_INFO_PARAM_LEN        ((CsrUint8) 8)
#define HCI_PRIVATE_PAIRING_REQ_REPLY_PARAM_LEN  ((CsrUint8) 2)
#define HCI_PRIVATE_PAIRING_REQ_NEG_REPLY_PARAM_LEN ((CsrUint8) 2)
#define HCI_GENERATED_ALIAS_PARAM_LEN            ((CsrUint8) 8)
#define HCI_ALIAS_ADDRESS_REQ_REPLY_PARAM_LEN    ((CsrUint8) 12)
#define HCI_ALIAS_ADDRESS_REQ_NEG_REPLY_PARAM_LEN ((CsrUint8) 6)
#define HCI_SETUP_SYNCHRONOUS_CONN_PARAM_LEN     ((CsrUint8) 17)
#define HCI_ACCEPT_SYNCHRONOUS_CONN_REQ_PARAM_LEN ((CsrUint8) 21)
#define HCI_REJECT_SYNCHRONOUS_CONN_REQ_PARAM_LEN ((CsrUint8) 7)
#define HCI_IO_CAPABILITY_RESPONSE_LEN           ((CsrUint8) 9)
#define HCI_USER_CONFIRMATION_REQUEST_REPLY_LEN  ((CsrUint8) 6)
#define HCI_USER_CONFIRMATION_REQEST_NEG_REPLY_LEN ((CsrUint8) 6)
#define HCI_USER_PASSKEY_REQUEST_REPLY_LEN       ((CsrUint8) 10)
#define HCI_USER_PASSKEY_REQUEST_NEG_REPLY_LEN   ((CsrUint8) 6)
#define HCI_REMOTE_OOB_DATA_REQUEST_REPLY_LEN    ((CsrUint8) 38)
#define HCI_REMOTE_OOB_DATA_REQUEST_NEG_REPLY_LEN ((CsrUint8) 6)
#define HCI_IO_CAPABILITY_REQUEST_NEG_REPLY_LEN  ((CsrUint8) 7)


/* Link Policy (HCI_POLICY) */
#define HCI_HOLD_MODE_PARAM_LEN                  ((CsrUint8) 6)
#define HCI_SNIFF_MODE_PARAM_LEN                 ((CsrUint8) 10)
#define HCI_EXIT_SNIFF_MODE_PARAM_LEN            ((CsrUint8) 2)
#define HCI_PARK_MODE_PARAM_LEN                  ((CsrUint8) 6)
#define HCI_EXIT_PARK_MODE_PARAM_LEN             ((CsrUint8) 2)
#define HCI_QOS_SETUP_PARAM_LEN                  ((CsrUint8) 20)
#define HCI_ROLE_DISCOVERY_PARAM_LEN             ((CsrUint8) 2)
#define HCI_SWITCH_ROLE_PARAM_LEN                ((CsrUint8) 7)
#define HCI_READ_LINK_POLICY_SETTINGS_PARAM_LEN  ((CsrUint8) 2)
#define HCI_WRITE_LINK_POLICY_SETTINGS_PARAM_LEN ((CsrUint8) 4)
#define HCI_READ_DEFAULT_LINK_POLICY_SETTINGS_PARAM_LEN  ((CsrUint8) 0)
#define HCI_WRITE_DEFAULT_LINK_POLICY_SETTINGS_PARAM_LEN ((CsrUint8) 2)
#define HCI_FLOW_SPEC_PARAM_LEN             ((CsrUint8) 21)
#define HCI_SNIFF_SUB_RATE_PARAM_LEN             ((CsrUint8) 8)

/* Controller And Baseband (HCI_HOST_BB) */
#define HCI_SET_EVENT_MASK_PARAM_LEN             ((CsrUint8) 8)
#define HCI_RESET_PARAM_LEN                      ((CsrUint8) 0)
#define HCI_SET_EVENT_FILTER_PARAM_LEN           ((CsrUint8) 8) /* Variable */
#define HCI_FLUSH_PARAM_LEN                      ((CsrUint8) 2)
#define HCI_READ_PIN_TYPE_PARAM_LEN              ((CsrUint8) 0)
#define HCI_WRITE_PIN_TYPE_PARAM_LEN             ((CsrUint8) 1)
#define HCI_CREATE_NEW_UNIT_KEY_PARAM_LEN        ((CsrUint8) 0)
#define HCI_READ_STORED_LINK_KEY_PARAM_LEN       ((CsrUint8) 7)
#define HCI_WRITE_STORED_LINK_KEY_PARAM_LEN      ((CsrUint8) 23) /* Variable */
#define HCI_DELETE_STORED_LINK_KEY_PARAM_LEN     ((CsrUint8) 7)
#define HCI_CHANGE_LOCAL_NAME_PARAM_LEN          ((CsrUint8) 248)
#define HCI_READ_LOCAL_NAME_PARAM_LEN            ((CsrUint8) 0)
#define HCI_READ_CONN_ACCEPT_TIMEOUT_PARAM_LEN   ((CsrUint8) 0)
#define HCI_WRITE_CONN_ACCEPT_TIMEOUT_PARAM_LEN  ((CsrUint8) 2)
#define HCI_READ_PAGE_TIMEOUT_PARAM_LEN          ((CsrUint8) 0)
#define HCI_WRITE_PAGE_TIMEOUT_PARAM_LEN         ((CsrUint8) 2)
#define HCI_READ_SCAN_ENABLE_PARAM_LEN           ((CsrUint8) 0)
#define HCI_WRITE_SCAN_ENABLE_PARAM_LEN          ((CsrUint8) 1)
#define HCI_READ_PAGESCAN_ACTIVITY_PARAM_LEN     ((CsrUint8) 0)
#define HCI_WRITE_PAGESCAN_ACTIVITY_PARAM_LEN    ((CsrUint8) 4)
#define HCI_READ_INQUIRYSCAN_ACTIVITY_PARAM_LEN  ((CsrUint8) 0)
#define HCI_WRITE_INQUIRYSCAN_ACTIVITY_PARAM_LEN ((CsrUint8) 4)
#define HCI_READ_AUTH_ENABLE_PARAM_LEN           ((CsrUint8) 0)
#define HCI_WRITE_AUTH_ENABLE_PARAM_LEN          ((CsrUint8) 1)
#define HCI_READ_ENC_MODE_PARAM_LEN              ((CsrUint8) 0)
#define HCI_WRITE_ENC_MODE_PARAM_LEN             ((CsrUint8) 1)
#define HCI_READ_CLASS_OF_DEVICE_PARAM_LEN       ((CsrUint8) 0)
#define HCI_WRITE_CLASS_OF_DEVICE_PARAM_LEN      ((CsrUint8) 3)
#define HCI_READ_VOICE_SETTING_PARAM_LEN         ((CsrUint8) 0)
#define HCI_WRITE_VOICE_SETTING_PARAM_LEN        ((CsrUint8) 2)
#define HCI_READ_AUTO_FLUSH_TIMEOUT_PARAM_LEN    ((CsrUint8) 2)
#define HCI_WRITE_AUTO_FLUSH_TIMEOUT_PARAM_LEN   ((CsrUint8) 4)
#define HCI_READ_NUM_BCAST_RETXS_PARAM_LEN       ((CsrUint8) 0)
#define HCI_WRITE_NUM_BCAST_RETXS_PARAM_LEN      ((CsrUint8) 1)
#define HCI_READ_HOLD_MODE_ACTIVITY_PARAM_LEN    ((CsrUint8) 0)
#define HCI_WRITE_HOLD_MODE_ACTIVITY_PARAM_LEN   ((CsrUint8) 1)
#define HCI_READ_TX_POWER_LEVEL_PARAM_LEN        ((CsrUint8) 3)
#define HCI_READ_SCO_FLOW_CON_ENABLE_PARAM_LEN   ((CsrUint8) 0)
#define HCI_WRITE_SCO_FLOW_CON_ENABLE_PARAM_LEN  ((CsrUint8) 1)
#define HCI_SET_HCTOHOST_FLOW_CONTROL_PARAM_LEN  ((CsrUint8) 1)
#define HCI_HOST_BUFFER_SIZE_PARAM_LEN           ((CsrUint8) 7)
#define HCI_HOST_NUM_COMPLETED_PACKETS_PARAM_LEN ((CsrUint8) 5) /* Variable */
#define HCI_READ_LINK_SUPERV_TIMEOUT_PARAM_LEN   ((CsrUint8) 2)
#define HCI_WRITE_LINK_SUPERV_TIMEOUT_PARAM_LEN  ((CsrUint8) 4)
#define HCI_READ_NUM_SUPPORTED_IAC_PARAM_LEN     ((CsrUint8) 0)
#define HCI_READ_CURRENT_IAC_LAP_PARAM_LEN       ((CsrUint8) 0)
#define HCI_WRITE_CURRENT_IAC_LAP_PARAM_LEN      ((CsrUint8) 4) /* Variable */
#define HCI_READ_PAGESCAN_PERIOD_MODE_PARAM_LEN  ((CsrUint8) 0)
#define HCI_WRITE_PAGESCAN_PERIOD_MODE_PARAM_LEN ((CsrUint8) 1)
#define HCI_READ_PAGESCAN_MODE_PARAM_LEN         ((CsrUint8) 0)
#define HCI_WRITE_PAGESCAN_MODE_PARAM_LEN        ((CsrUint8) 1)
#define HCI_SET_AFH_CHANNEL_CLASS_PARAM_LEN      ((CsrUint8) 10)
#define HCI_READ_INQUIRY_SCAN_TYPE_PARAM_LEN     ((CsrUint8) 0)
#define HCI_WRITE_INQUIRY_SCAN_TYPE_PARAM_LEN    ((CsrUint8) 1)
#define HCI_READ_INQUIRY_MODE_PARAM_LEN          ((CsrUint8) 0)
#define HCI_WRITE_INQUIRY_MODE_PARAM_LEN         ((CsrUint8) 1)
#define HCI_READ_PAGE_SCAN_TYPE_PARAM_LEN        ((CsrUint8) 0)
#define HCI_WRITE_PAGE_SCAN_TYPE_PARAM_LEN       ((CsrUint8) 1)
#define HCI_READ_AFH_CHANNEL_CLASS_M_PARAM_LEN   ((CsrUint8) 0)
#define HCI_WRITE_AFH_CHANNEL_CLASS_M_PARAM_LEN  ((CsrUint8) 1)
#define HCI_READ_ANON_MODE_PARAM_LEN             ((CsrUint8) 0)
#define HCI_WRITE_ANON_MODE_PARAM_LEN            ((CsrUint8) 1)
#define HCI_READ_ALIAS_AUTH_ENABLE_PARAM_LEN     ((CsrUint8) 0)
#define HCI_WRITE_ALIAS_AUTH_ENABLE_PARAM_LEN    ((CsrUint8) 1)
#define HCI_READ_ANON_ADDR_CHANGE_PARAMS_PARAM_LEN         ((CsrUint8) 0)
#define HCI_WRITE_ANON_ADDR_CHANGE_PARAMS_PARAM_LEN        ((CsrUint8) 6)
#define HCI_RESET_FIXED_ADDRESS_ATTEMPTS_COUNTER_PARAM_LEN ((CsrUint8) 1)
#define HCI_READ_EXTENDED_INQUIRY_RESPONSE_DATA_PARAM_LEN  ((CsrUint8) 0)
#define HCI_WRITE_EXTENDED_INQUIRY_RESPONSE_DATA_PARAM_LEN ((CsrUint8) 241)
#define HCI_REFRESH_ENCRYPTION_KEY_PARAM_LEN               ((CsrUint8) 2)
#define HCI_READ_INQUIRY_RESPONSE_TX_POWER_LEVEL_PARAM_LEN ((CsrUint8) 0)
#define HCI_WRITE_INQUIRY_TRANSMIT_POWER_LEVEL_PARAM_LEN   ((CsrUint8) 1)
#define HCI_ENHANCED_FLUSH_PARAM_LEN             ((CsrUint8) 3)
#define HCI_SEND_KEYPRESS_NOTIFICATION_PARAM_LEN ((CsrUint8) 7)
#define HCI_READ_SIMPLE_PAIRING_MODE_PARAM_LEN   ((CsrUint8) 0)
#define HCI_WRITE_SIMPLE_PAIRING_MODE_PARAM_LEN  ((CsrUint8) 1)
#define HCI_READ_LOCAL_OOB_DATA_PARAM_LEN        ((CsrUint8) 0)
#define HCI_READ_ENH_TX_POWER_LEVEL_PARAM_LEN    ((CsrUint8) 3)
#define HCI_READ_LE_HOST_SUPPORT_PARAM_LEN       ((CsrUint8) 0)
#define HCI_WRITE_LE_HOST_SUPPORT_PARAM_LEN      ((CsrUint8) 2)

/* Informational Parameters (HCI_INFO) */
#define HCI_READ_LOCAL_VER_INFO_PARAM_LEN        ((CsrUint8) 0)
#define HCI_READ_LOCAL_SUPP_COMMANDS_PARAM_LEN   ((CsrUint8) 0)
#define HCI_READ_LOCAL_SUPP_FEATURES_PARAM_LEN   ((CsrUint8) 0)
#define HCI_READ_LOCAL_EXT_FEATURES_PARAM_LEN    ((CsrUint8) 1)
#define HCI_READ_BUFFER_SIZE_PARAM_LEN           ((CsrUint8) 0)
#define HCI_READ_COUNTRY_CODE_PARAM_LEN          ((CsrUint8) 0)
#define HCI_READ_BD_ADDR_PARAM_LEN               ((CsrUint8) 0)

/* Status (HCI_STATUS) */
#define HCI_READ_FAILED_CONTACT_COUNT_PARAM_LEN  ((CsrUint8) 2)
#define HCI_RESET_FAILED_CONTACT_COUNT_PARAM_LEN ((CsrUint8) 2)
#define HCI_GET_LINK_QUALITY_PARAM_LEN           ((CsrUint8) 2)
#define HCI_READ_RSSI_PARAM_LEN                  ((CsrUint8) 2)
#define HCI_READ_AFH_CHANNEL_MAP_PARAM_LEN       ((CsrUint8) 2)
#define HCI_READ_CLOCK_PARAM_LEN                 ((CsrUint8) 3)
#define HCI_READ_ENCRYPTION_KEY_SIZE_PARAM_LEN   ((CsrUint8) 2)

/* Testing (HCI_TEST) */
#define HCI_READ_LOOPBACK_MODE_PARAM_LEN               ((CsrUint8) 0)
#define HCI_WRITE_LOOPBACK_MODE_PARAM_LEN              ((CsrUint8) 1)
#define HCI_ENABLE_DUT_MODE_PARAM_LEN                  ((CsrUint8) 0)
#define HCI_WRITE_SIMPLE_PAIRING_DEBUG_MODE_PARAM_LEN  ((CsrUint8) 1)

#define HCI_DEBUG_REQUEST_PARAM_LEN              ((CsrUint8) 2)

/* ULP */
#define HCI_ULP_SET_EVENT_MASK_PARAM_LEN                  ((CsrUint8)  8)
#define HCI_ULP_READ_BUFFER_SIZE_PARAM_LEN                ((CsrUint8)  0)
#define HCI_ULP_READ_LOCAL_SUPPORTED_FEATURES_PARAM_LEN   ((CsrUint8)  0)
#define HCI_ULP_SET_RANDOM_ADDRESS_PARAM_LEN              ((CsrUint8)  6)
#define HCI_ULP_SET_ADVERTISING_PARAMETERS_PARAM_LEN      ((CsrUint8) 15)
#define HCI_ULP_READ_ADVERTISING_CHANNEL_TX_POWER_PARAM_LEN ((CsrUint8) 0)
#define HCI_ULP_SET_ADVERTISING_DATA_PARAM_LEN            ((CsrUint8) 32)
#define HCI_ULP_SET_SCAN_RESPONSE_DATA_PARAM_LEN          ((CsrUint8) 32)
#define HCI_ULP_SET_ADVERTISE_ENABLE_PARAM_LEN            ((CsrUint8)  1)
#define HCI_ULP_SET_SCAN_PARAMETERS_PARAM_LEN             ((CsrUint8)  7)
#define HCI_ULP_SET_SCAN_ENABLE_PARAM_LEN                 ((CsrUint8)  2)
#define HCI_ULP_CREATE_CONNECTION_PARAM_LEN               ((CsrUint8) 25)
#define HCI_ULP_CREATE_CONNECTION_CANCEL_PARAM_LEN        ((CsrUint8)  0)
#define HCI_ULP_READ_WHITE_LIST_SIZE_PARAM_LEN            ((CsrUint8)  0)
#define HCI_ULP_CLEAR_WHITE_LIST_PARAM_LEN                ((CsrUint8)  0)
#define HCI_ULP_ADD_DEVICE_TO_WHITE_LIST_PARAM_LEN        ((CsrUint8)  7)
#define HCI_ULP_REMOVE_DEVICE_FROM_WHITE_LIST_PARAM_LEN   ((CsrUint8)  7)
#define HCI_ULP_CONNECTION_UPDATE_PARAM_LEN               ((CsrUint8) 14)
#define HCI_ULP_SET_HOST_CHANNEL_CLASSIFICATION_PARAM_LEN ((CsrUint8)  5)
#define HCI_ULP_READ_CHANNEL_MAP_PARAM_LEN                ((CsrUint8)  2)
#define HCI_ULP_READ_REMOTE_USED_FEATURES_PARAM_LEN       ((CsrUint8)  2)
#define HCI_ULP_ENCRYPT_PARAM_LEN                         ((CsrUint8) 32)
#define HCI_ULP_RAND_PARAM_LEN                            ((CsrUint8)  0)
#define HCI_ULP_START_ENCRYPTION_PARAM_LEN                ((CsrUint8) 28)
#define HCI_ULP_LONG_TERM_KEY_REQUESTED_REPLY_PARAM_LEN   ((CsrUint8) 18)
#define HCI_ULP_LONG_TERM_KEY_REQUESTED_NEGATIVE_REPLY_PARAM_LEN   ((CsrUint8) 2)
#define HCI_ULP_READ_SUPPORTED_STATES_PARAM_LEN           ((CsrUint8)  0)
#define HCI_ULP_RECEIVER_TEST_PARAM_LEN                   ((CsrUint8)  1)
#define HCI_ULP_TRANSMITTER_TEST_PARAM_LEN                ((CsrUint8)  3)
#define HCI_ULP_TEST_END_PARAM_LEN                        ((CsrUint8)  0)


/******************************************************************************
        Event Parameter Lengths
 *****************************************************************************/
#define HCI_EV_INQUIRY_COMPLETE_PARAM_LEN                 ((CsrUint8) 1)
#define HCI_EV_INQUIRY_RESULT_PARAM_LEN                   ((CsrUint8) 15) /* Variable */
#define HCI_EV_CONN_COMPLETE_PARAM_LEN                    ((CsrUint8) 11)
#define HCI_EV_CONN_REQUEST_PARAM_LEN                     ((CsrUint8) 10)
#define HCI_EV_DISCONNECT_COMPLETE_PARAM_LEN              ((CsrUint8) 4)
#define HCI_EV_AUTH_COMPLETE_PARAM_LEN                    ((CsrUint8) 3)
#define HCI_EV_REMOTE_NAME_REQ_COMPLETE_MAX_LEN           ((CsrUint8) 255)
#define HCI_EV_REMOTE_NAME_REQ_COMPLETE_BASIC_LEN         ((CsrUint8) 7)
#define HCI_EV_ENCRYPTION_CHANGE_PARAM_LEN                ((CsrUint8) 4)
#define HCI_EV_CHANGE_CONN_LINK_KEY_COMPLETE_PARAM_LEN    ((CsrUint8) 3)
#define HCI_EV_MASTER_LINK_KEY_COMPLETE_PARAM_LEN         ((CsrUint8) 4)
#define HCI_EV_READ_REM_SUPP_FEATURES_COMPLETE_PARAM_LEN  ((CsrUint8) 11)
#define HCI_EV_READ_REMOTE_VER_INFO_COMPLETE_PARAM_LEN    ((CsrUint8) 8)
#define HCI_EV_QOS_SETUP_COMPLETE_PARAM_LEN               ((CsrUint8) 21)
#define HCI_EV_COMMAND_COMPLETE_PARAM_LEN                 ((CsrUint8) 3) /* Variable see below */
#define HCI_EV_COMMAND_STATUS_PARAM_LEN                   ((CsrUint8) 4)
#define HCI_EV_HARDWARE_ERROR_PARAM_LEN                   ((CsrUint8) 1)
#define HCI_EV_FLUSH_OCCURRED_PARAM_LEN                   ((CsrUint8) 2)
#define HCI_EV_ROLE_CHANGE_PARAM_LEN                      ((CsrUint8) 8)
#define HCI_EV_NUMBER_COMPLETED_PKTS_PARAM_LEN            ((CsrUint8) 5) /* Variable */
#define HCI_EV_MODE_CHANGE_PARAM_LEN                      ((CsrUint8) 6)
#define HCI_EV_RETURN_LINK_KEYS_PARAM_LEN                 ((CsrUint8) 23) /* Variable */
#define HCI_EV_PIN_CODE_REQ_PARAM_LEN                     ((CsrUint8) 6)
#define HCI_EV_LINK_KEY_REQ_PARAM_LEN                     ((CsrUint8) 6)
#define HCI_EV_LINK_KEY_NOTIFICATION_PARAM_LEN            ((CsrUint8) 23)
#define HCI_EV_LOOPBACK_COMMAND_PARAM_LEN                 ((CsrUint8) 0) /* Variable */
#define HCI_EV_DATA_BUFFER_OVERFLOW_PARAM_LEN             ((CsrUint8) 1)
#define HCI_EV_MAX_SLOTS_CHANGE_PARAM_LEN                 ((CsrUint8) 3)
#define HCI_EV_READ_CLOCK_OFFSET_COMPLETE_PARAM_LEN       ((CsrUint8) 5)
#define HCI_EV_CONN_PACKET_TYPE_CHANGED_PARAM_LEN         ((CsrUint8) 5)
#define HCI_EV_QOS_VIOLATION_PARAM_LEN                    ((CsrUint8) 2)
#define HCI_EV_PAGE_SCAN_MODE_CHANGE_PARAM_LEN            ((CsrUint8) 7)
#define HCI_EV_PAGE_SCAN_REP_MODE_CHANGE_PARAM_LEN        ((CsrUint8) 7)
#define HCI_EV_FLOW_SPEC_COMPLETE_PARAM_LEN          ((CsrUint8) 22)
#define HCI_EV_INQUIRY_RESULT_WITH_RSSI_PARAM_LEN         ((CsrUint8) 15) /* Variable */
#define HCI_EV_READ_REM_EXT_FEATURES_COMPLETE_PARAM_LEN   ((CsrUint8) 13)
#define HCI_EV_FIXED_ADDRESS_PARAM_LEN                    ((CsrUint8)  9)
#define HCI_EV_ALIAS_ADDRESS_PARAM_LEN                    ((CsrUint8)  8)
#define HCI_EV_GENERATE_ALIAS_REQ_PARAM_LEN               ((CsrUint8)  2)
#define HCI_EV_ACTIVE_ADDRESS_PARAM_LEN                   ((CsrUint8) 12)
#define HCI_EV_ALLOW_PRIVATE_PAIRING_PARAM_LEN            ((CsrUint8)  2)
#define HCI_EV_ALIAS_ADDRESS_REQ_PARAM_LEN                ((CsrUint8)  6)
#define HCI_EV_ALIAS_NOT_RECOGNISED_PARAM_LEN             ((CsrUint8)  7)
#define HCI_EV_FIXED_ADDRESS_ATTEMPT_PARAM_LEN            ((CsrUint8)  4)
#define HCI_EV_SYNC_CONN_COMPLETE_PARAM_LEN               ((CsrUint8) 17)
#define HCI_EV_SYNC_CONN_CHANGED_PARAM_LEN                ((CsrUint8)  9)
#define HCI_EV_SNIFF_SUB_RATE_PARAM_LEN                   ((CsrUint8) 11)
#define HCI_EV_EXTENDED_INQUIRY_RESULT_PARAM_LEN          ((CsrUint8) 255)
#define HCI_EV_ENCRYPTION_KEY_REFRESH_COMPLETE_PARAM_LEN  ((CsrUint8) 3)
#define HCI_EV_IO_CAPABILITY_REQUEST_PARAM_LEN            ((CsrUint8) 6)
#define HCI_EV_IO_CAPABILITY_RESPONSE_PARAM_LEN           ((CsrUint8) 9)
#define HCI_EV_USER_CONFIRMATION_REQUEST_PARAM_LEN        ((CsrUint8) 10)
#define HCI_EV_USER_PASSKEY_REQUEST_PARAM_LEN             ((CsrUint8) 6)
#define HCI_EV_REMOTE_OOB_DATA_REQUEST_PARAM_LEN          ((CsrUint8) 6)
#define HCI_EV_SIMPLE_PAIRING_COMPLETE_PARAM_LEN          ((CsrUint8) 7)
#define HCI_EV_LST_CHANGE_PARAM_LEN                       ((CsrUint8) 4)
#define HCI_EV_ENHANCED_FLUSH_COMPLETE_PARAM_LEN          ((CsrUint8) 2)
#define HCI_EV_USER_PASSKEY_NOTIFICATION_PARAM_LEN        ((CsrUint8) 10)
#define HCI_EV_KEYPRESS_NOTIFICATION_PARAM_LEN            ((CsrUint8) 7)
#define HCI_EV_REM_HOST_SUPPORTED_FEATURES_PARAM_LEN      ((CsrUint8) 14)

#define HCI_EV_ULP_CONNECTION_COMPLETE_PARAM_LEN          ((CsrUint8)19)
#define HCI_EV_ULP_ADVERTISING_REPORT_PARAM_LEN           ((CsrUint8)12) /* Variable */
#define HCI_EV_ULP_CONNECTION_UPDATE_COMPLETE_PARAM_LEN   ((CsrUint8)10)
#define HCI_EV_ULP_READ_REMOTE_USED_FEATURES_COMPLETE_PARAM_LEN   ((CsrUint8)12)
#define HCI_EV_ULP_LONG_TERM_KEY_REQUESTED_PARAM_LEN      ((CsrUint8)13)

#define HCI_EV_DEBUG_PARAM_LEN                            ((CsrUint8) 20)
...
*****************************************************************************/
/* Link Control (HCI_LINK) */
#define HCI_INQUIRY_CANCEL_ARG_LEN             ((CsrUint8) 4)
#define HCI_PERIODIC_INQ_MODE_ARG_LEN          ((CsrUint8) 4)
#define HCI_EXIT_PERIODIC_INQ_MODE_ARG_LEN     ((CsrUint8) 4)
#define HCI_CREATE_CONNECTION_CANCEL_ARG_LEN   ((CsrUint8) 10)
#define HCI_LINK_KEY_REQ_REPLY_ARG_LEN         ((CsrUint8) 10)
#define HCI_LINK_KEY_REQ_NEG_REPLY_ARG_LEN     ((CsrUint8) 10)
#define HCI_PIN_CODE_REQ_REPLY_ARG_LEN         ((CsrUint8) 10)
#define HCI_PIN_CODE_REQ_NEG_REPLY_ARG_LEN     ((CsrUint8) 10)
#define HCI_REMOTE_NAME_REQ_CANCEL_ARG_LEN     ((CsrUint8) 10)
#define HCI_READ_LMP_HANDLE_ARG_LEN            ((CsrUint8) 11)
#define HCI_PRIVATE_PAIRING_REQ_REPLY_ARG_LEN  ((CsrUint8)  6)
#define HCI_PRIVATE_PAIRING_REQ_NEG_REPLY_ARG_LEN ((CsrUint8)  6)
#define HCI_GENERATED_ALIAS_ARG_LEN            ((CsrUint8)  6)
#define HCI_ALIAS_ADDRESS_REQ_REPLY_ARG_LEN    ((CsrUint8) 10)
#define HCI_ALIAS_ADDRESS_REQ_NEG_REPLY_ARG_LEN ((CsrUint8) 10)
#define HCI_IO_CAPABILITY_RESPONSE_ARG_LEN              ((CsrUint8) 10)
#define HCI_USER_CONFIRMATION_REQUEST_REPLY_ARG_LEN     ((CsrUint8) 10)
#define HCI_USER_CONFIRMATION_REQUEST_NEG_REPLY_ARG_LEN ((CsrUint8) 10)
#define HCI_USER_PASSKEY_REQUEST_REPLY_ARG_LEN          ((CsrUint8) 10)
#define HCI_USER_PASSKEY_REQUEST_NEG_REPLY_ARG_LEN      ((CsrUint8) 10)
#define HCI_REMOTE_OOB_DATA_REQUEST_REPLY_ARG_LEN       ((CsrUint8) 10)
#define HCI_REMOTE_OOB_DATA_REQUEST_NEG_REPLY_ARG_LEN   ((CsrUint8) 10)
#define HCI_IO_CAPABILITY_REQUEST_NEG_REPLY_ARG_LEN     ((CsrUint8) 10)

/* Link Policy (HCI_POLICY) */
#define HCI_ROLE_DISCOVERY_ARG_LEN             ((CsrUint8) 7)
#define HCI_READ_LINK_POLICY_SETTINGS_ARG_LEN  ((CsrUint8) 8)
#define HCI_WRITE_LINK_POLICY_SETTINGS_ARG_LEN ((CsrUint8) 6)
#define HCI_READ_DEFAULT_LINK_POLICY_SETTINGS_ARG_LEN  ((CsrUint8) 6)
#define HCI_WRITE_DEFAULT_LINK_POLICY_SETTINGS_ARG_LEN  ((CsrUint8) 4)
#define HCI_SNIFF_SUB_RATE_ARG_LEN             ((CsrUint8) 6)

/* Controller and Baseband (HCI_HOST_BB) */
#define HCI_SET_EVENT_MASK_ARG_LEN             ((CsrUint8) 4)
#define HCI_RESET_ARG_LEN                      ((CsrUint8) 4)
#define HCI_SET_EVENT_FILTER_ARG_LEN           ((CsrUint8) 4)
#define HCI_FLUSH_ARG_LEN                      ((CsrUint8) 6)
#define HCI_READ_PIN_TYPE_ARG_LEN              ((CsrUint8) 5)
#define HCI_WRITE_PIN_TYPE_ARG_LEN             ((CsrUint8) 4)
#define HCI_CREATE_NEW_UNIT_KEY_ARG_LEN        ((CsrUint8) 4)
#define HCI_READ_STORED_LINK_KEY_ARG_LEN       ((CsrUint8) 8)
#define HCI_WRITE_STORED_LINK_KEY_ARG_LEN      ((CsrUint8) 5)
#define HCI_DELETE_STORED_LINK_KEY_ARG_LEN     ((CsrUint8) 6)
#define HCI_CHANGE_LOCAL_NAME_ARG_LEN          ((CsrUint8) 4)
#define HCI_READ_LOCAL_NAME_ARG_LEN            ((CsrUint8) 252)
#define HCI_READ_CONN_ACCEPT_TIMEOUT_ARG_LEN   ((CsrUint8) 6)
#define HCI_WRITE_CONN_ACCEPT_TIMEOUT_ARG_LEN  ((CsrUint8) 4)
#define HCI_READ_PAGE_TIMEOUT_ARG_LEN          ((CsrUint8) 6)
#define HCI_WRITE_PAGE_TIMEOUT_ARG_LEN         ((CsrUint8) 4)
#define HCI_READ_SCAN_ENABLE_ARG_LEN           ((CsrUint8) 5)
#define HCI_WRITE_SCAN_ENABLE_ARG_LEN          ((CsrUint8) 4)
#define HCI_READ_PAGESCAN_ACTIVITY_ARG_LEN     ((CsrUint8) 8)
#define HCI_WRITE_PAGESCAN_ACTIVITY_ARG_LEN    ((CsrUint8) 4)
#define HCI_READ_INQUIRYSCAN_ACTIVITY_ARG_LEN  ((CsrUint8) 8)
#define HCI_WRITE_INQUIRYSCAN_ACTIVITY_ARG_LEN ((CsrUint8) 4)
#define HCI_READ_AUTH_ENABLE_ARG_LEN           ((CsrUint8) 5)
#define HCI_WRITE_AUTH_ENABLE_ARG_LEN          ((CsrUint8) 4)
#define HCI_READ_ENC_MODE_ARG_LEN              ((CsrUint8) 5)
#define HCI_WRITE_ENC_MODE_ARG_LEN             ((CsrUint8) 4)
#define HCI_READ_CLASS_OF_DEVICE_ARG_LEN       ((CsrUint8) 7)
#define HCI_WRITE_CLASS_OF_DEVICE_ARG_LEN      ((CsrUint8) 4)
#define HCI_READ_VOICE_SETTING_ARG_LEN         ((CsrUint8) 6)
#define HCI_WRITE_VOICE_SETTING_ARG_LEN        ((CsrUint8) 4)
#define HCI_READ_AUTO_FLUSH_TIMEOUT_ARG_LEN    ((CsrUint8) 8)
#define HCI_WRITE_AUTO_FLUSH_TIMEOUT_ARG_LEN   ((CsrUint8) 6)
#define HCI_READ_NUM_BCASTXS_ARG_LEN           ((CsrUint8) 5)
#define HCI_WRITE_NUM_BCASTXS_ARG_LEN          ((CsrUint8) 4)
#define HCI_READ_HOLD_MODE_ACTIVITY_ARG_LEN    ((CsrUint8) 5)
#define HCI_WRITE_HOLD_MODE_ACTIVITY_ARG_LEN   ((CsrUint8) 4)
#define HCI_READ_TX_POWER_LEVEL_ARG_LEN        ((CsrUint8) 7)
#define HCI_READ_SCO_FLOW_CON_ENABLE_ARG_LEN   ((CsrUint8) 5)
#define HCI_WRITE_SCO_FLOW_CON_ENABLE_ARG_LEN  ((CsrUint8) 4)
#define HCI_SET_HC_TO_H_FLOW_CONTROL_ARG_LEN   ((CsrUint8) 4)
#define HCI_HOST_BUFFER_SIZE_ARG_LEN           ((CsrUint8) 4)
#define HCI_HOST_NUM_COMPLETED_PKTS_ARG_LEN    ((CsrUint8) 4)
#define HCI_READ_LINK_SUPERV_TIMEOUT_ARG_LEN   ((CsrUint8) 8)
#define HCI_WRITE_LINK_SUPERV_TIMEOUT_ARG_LEN  ((CsrUint8) 6)
#define HCI_READ_NUM_SUPPORTED_IAC_ARG_LEN     ((CsrUint8) 5)
#define HCI_READ_CURRENT_IAC_LAP_ARG_LEN       ((CsrUint8) 5) /* Variable */
#define HCI_WRITE_CURRENT_IAC_LAP_ARG_LEN      ((CsrUint8) 4)
#define HCI_READ_PAGESCAN_PERIOD_MODE_ARG_LEN  ((CsrUint8) 5)
#define HCI_WRITE_PAGESCAN_PERIOD_MODE_ARG_LEN ((CsrUint8) 4)
#define HCI_READ_PAGESCAN_MODE_ARG_LEN         ((CsrUint8) 5)
#define HCI_WRITE_PAGESCAN_MODE_ARG_LEN        ((CsrUint8) 4)
#define HCI_SET_AFH_CHANNEL_CLASS_ARG_LEN      ((CsrUint8) 4)
#define HCI_READ_INQUIRY_SCAN_TYPE_ARG_LEN     ((CsrUint8) 5)
#define HCI_WRITE_INQUIRY_SCAN_TYPE_ARG_LEN    ((CsrUint8) 4)
#define HCI_READ_INQUIRY_MODE_ARG_LEN          ((CsrUint8) 5)
#define HCI_WRITE_INQUIRY_MODE_ARG_LEN         ((CsrUint8) 4)
#define HCI_READ_PAGE_SCAN_TYPE_ARG_LEN        ((CsrUint8) 5)
#define HCI_WRITE_PAGE_SCAN_TYPE_ARG_LEN       ((CsrUint8) 4)
#define HCI_READ_AFH_CHANNEL_CLASS_M_ARG_LEN   ((CsrUint8) 5)
#define HCI_WRITE_AFH_CHANNEL_CLASS_M_ARG_LEN  ((CsrUint8) 4)
#define HCI_READ_ANON_MODE_ARG_LEN             ((CsrUint8) 5)
#define HCI_WRITE_ANON_MODE_ARG_LEN            ((CsrUint8) 4)
#define HCI_READ_ALIAS_AUTH_ENABLE_ARG_LEN     ((CsrUint8) 5)
#define HCI_WRITE_ALIAS_AUTH_ENABLE_ARG_LEN    ((CsrUint8) 4)
#define HCI_READ_ANON_ADDR_CHANGE_PARAMS_ARG_LEN ((CsrUint8) 10)
#define HCI_WRITE_ANON_ADDR_CHANGE_PARAMS_ARG_LEN ((CsrUint8)  4)
#define HCI_RESET_FIXED_ADDRESS_ATTEMPTS_COUNTER_ARG_LEN ((CsrUint8) 4)
#define HCI_READ_EXTENDED_INQUIRY_RESPONSE_DATA_ARG_LEN  ((CsrUint8) 245)
#define HCI_WRITE_EXTENDED_INQUIRY_RESPONSE_DATA_ARG_LEN ((CsrUint8) 4)
#define HCI_REFRESH_ENCRYPTION_KEY_ARG_LEN     ((CsrUint8) 6)
#define HCI_WRITE_SIMPLE_PAIRING_MODE_ARG_LEN  ((CsrUint8) 4)
#define HCI_READ_SIMPLE_PAIRING_MODE_ARG_LEN   ((CsrUint8) 5)
#define HCI_READ_LOCAL_OOB_DATA_ARG_LEN        ((CsrUint8) 36)
#define HCI_READ_INQUIRY_RESPONSE_TX_POWER_LEVEL_ARG_LEN ((CsrUint8) 5)
#define HCI_WRITE_INQUIRY_TRANSMIT_POWER_LEVEL_ARG_LEN ((CsrUint8) 4)
#define HCI_SEND_KEYPRESS_NOTIFICATION_ARG_LEN ((CsrUint8) 10)
#define HCI_READ_ENH_TX_POWER_LEVEL_ARG_LEN    ((CsrUint8) 9)
#define HCI_READ_LE_HOST_SUPPORT_ARG_LEN       ((CsrUint8) 6)
#define HCI_WRITE_LE_HOST_SUPPORT_ARG_LEN      ((CsrUint8) 4)

/* Information Parameters (HCI_INFO) */
#define HCI_READ_LOCAL_VER_INFO_ARG_LEN        ((CsrUint8) 12)
#define HCI_READ_LOCAL_COMMANDS_LEN            ((CsrUint8) 68)
#define HCI_READ_LOCAL_FEATURES_LEN            ((CsrUint8) 12)
#define HCI_READ_LOCAL_EXT_FEATURES_LEN        ((CsrUint8) 14)
#define HCI_READ_BUFFER_SIZE_ARG_LEN           ((CsrUint8) 11)
#define HCI_READ_COUNTRY_CODE_ARG_LEN          ((CsrUint8) 5)
#define HCI_READ_BD_ADDR_ARG_LEN               ((CsrUint8) 10)

/* Status Parameters (HCI_STATUS) */
#define HCI_READ_FAILED_CONTACT_COUNT_ARG_LEN  ((CsrUint8) 8)
#define HCI_RESET_FAILED_CONTACT_COUNT_ARG_LEN ((CsrUint8) 6)
#define HCI_GET_LINK_QUALITY_ARG_LEN           ((CsrUint8) 7)
#define HCI_READ_RSSI_ARG_LEN                  ((CsrUint8) 7)
#define HCI_READ_AFH_CHANNEL_MAP_ARG_LEN       ((CsrUint8) 17)
#define HCI_READ_CLOCK_ARG_LEN                 ((CsrUint8) 12)
#define HCI_READ_ENCRYPTION_KEY_SIZE_ARG_LEN   ((CsrUint8) 7)

/* Testing (HCI_TEST) */
#define HCI_READ_LOOPBACK_MODE_ARG_LEN         ((CsrUint8) 5)
#define HCI_WRITE_LOOPBACK_MODE_ARG_LEN        ((CsrUint8) 4)
#define HCI_ENABLE_DUT_ARG_LEN                 ((CsrUint8) 4)
#define HCI_WRITE_SIMPLE_PAIRING_DEBUG_MODE_ARG_LEN ((CsrUint8) 4)
#define HCI_MNFR_EXTENSION_ARG_LEN             ((CsrUint8) 4)

/* ULP */
#define HCI_ULP_SET_EVENT_MASK_ARG_LEN                  ((CsrUint8)  4)
#define HCI_ULP_READ_BUFFER_SIZE_ARG_LEN                ((CsrUint8)  7)
#define HCI_ULP_READ_LOCAL_SUPPORTED_FEATURES_ARG_LEN   ((CsrUint8) 12)
#define HCI_ULP_SET_RANDOM_ADDRESS_ARG_LEN              ((CsrUint8)  4)
#define HCI_ULP_SET_ADVERTISING_PARAMETERS_ARG_LEN      ((CsrUint8)  4)
#define HCI_ULP_READ_ADVERTISING_CHANNEL_TX_POWER_ARG_LEN ((CsrUint8) 5)
#define HCI_ULP_SET_ADVERTISING_DATA_ARG_LEN            ((CsrUint8)  4)
#define HCI_ULP_SET_SCAN_RESPONSE_DATA_ARG_LEN          ((CsrUint8)  4)
#define HCI_ULP_SET_ADVERTISE_ENABLE_ARG_LEN            ((CsrUint8)  4)
#define HCI_ULP_SET_SCAN_PARAMETERS_ARG_LEN             ((CsrUint8)  4)
#define HCI_ULP_SET_SCAN_ENABLE_ARG_LEN                 ((CsrUint8)  4)
#define HCI_ULP_CREATE_CONNECTION_CANCEL_ARG_LEN        ((CsrUint8)  4)
#define HCI_ULP_READ_WHITE_LIST_SIZE_ARG_LEN            ((CsrUint8)  5)
#define HCI_ULP_CLEAR_WHITE_LIST_ARG_LEN                ((CsrUint8)  4)
#define HCI_ULP_ADD_DEVICE_TO_WHITE_LIST_ARG_LEN        ((CsrUint8)  4)
#define HCI_ULP_REMOVE_DEVICE_FROM_WHITE_LIST_ARG_LEN   ((CsrUint8)  4)
#define HCI_ULP_SET_HOST_CHANNEL_CLASSIFICATION_ARG_LEN ((CsrUint8)  4)
#define HCI_ULP_READ_CHANNEL_MAP_ARG_LEN                ((CsrUint8) 11)
#define HCI_ULP_ENCRYPT_ARG_LEN                         ((CsrUint8) 20)
#define HCI_ULP_RAND_ARG_LEN                            ((CsrUint8) 12)
#define HCI_ULP_LONG_TERM_KEY_REQUESTED_REPLY_ARG_LEN   ((CsrUint8)  6)
#define HCI_ULP_LONG_TERM_KEY_REQUESTED_NEGATIVE_REPLY_ARG_LEN  ((CsrUint8)  6)
#define HCI_ULP_READ_SUPPORTED_STATES_ARG_LEN           ((CsrUint8)  12)
#define HCI_ULP_RECEIVER_TEST_ARG_LEN                   ((CsrUint8)  4)
#define HCI_ULP_TRANSMITTER_TEST_ARG_LEN                ((CsrUint8)  4)
#define HCI_ULP_TEST_END_ARG_LEN                        ((CsrUint8)  6)
...
#define HCI_DEFAULT        ((CsrUint8)0)     /* 0 in a message field means default */
...
#define HCI_ESCO_NO_RETX            ((CsrUint8) 0x00)
#define HCI_ESCO_POWER_SAVING_RETX  ((CsrUint8) 0x01)
#define HCI_ESCO_LINK_QUALITY_RETX  ((CsrUint8) 0x02)
#define HCI_ESCO_DONT_CARE_RETX     ((CsrUint8) 0xFF)

/* Bandwidth defaults */
#define HCI_ESCO_BDW_DONT_CARE      ((CsrUint32) 0xFFFFFFFF)

/* Max latency default */
#define HCI_ESCO_MAX_LATENCY_DEFAULT ((CsrUint16) 0xFFFF)

/* Packet type defaults */
#define HCI_ESCO_DEFAULT_PKT_TYPE   ((CsrUint16) 0xFFFF)

/*----------------------------------------------------------------------------*
 *
 *  HCI event mask values
 *  As 8 byte quantity split into two CsrUint32 so require high and low
 *  part masks.
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_AUTO_ACCEPT_OFF                 ((CsrUint8)0x01)
#define HCI_AUTO_ACCEPT_ON                  ((CsrUint8)0x02)
#define HCI_AUTO_ACCEPT_WITH_ROLE_SWITCH    ((CsrUint8)0x03)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_INQUIRY_LENGTH_MIN              ((CsrUint8)0x01)
#define HCI_INQUIRY_LENGTH_MAX              ((CsrUint8)0x30)
#define HCI_INQUIRY_RESPONSES_MIN           ((CsrUint8)0x01)
#define HCI_INQUIRY_RESPONSES_MAX           ((CsrUint8)0xFF)
#define HCI_INQUIRY_MAX_PERIOD_MIN          ((CsrUint16)0x0003)
#define HCI_INQUIRY_MAX_PERIOD_MAX          ((CsrUint16)0xFFFF)
#define HCI_INQUIRY_MIN_PERIOD_MIN          ((CsrUint16)0x0002)
#define HCI_INQUIRY_MIN_PERIOD_MAX          ((CsrUint16)0xFFFE)
#define HCI_INQUIRYSCAN_INTERVAL_MIN        ((CsrUint16)0x0012)
#define HCI_INQUIRYSCAN_INTERVAL_DEFAULT    ((CsrUint16)0x1000)
#define HCI_INQUIRYSCAN_INTERVAL_MAX        ((CsrUint16)0x1000)
#define HCI_INQUIRYSCAN_WINDOW_MIN          ((CsrUint16)0x0011)
#define HCI_INQUIRYSCAN_WINDOW_DEFAULT      ((CsrUint16)0x0012)
#define HCI_INQUIRYSCAN_WINDOW_MAX          ((CsrUint16)0x1000)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_SCAN_ENABLE_OFF             ((CsrUint8)0x00) /* default */
#define HCI_SCAN_ENABLE_INQ             ((CsrUint8)0x01)
#define HCI_SCAN_ENABLE_PAGE            ((CsrUint8)0x02)
#define HCI_SCAN_ENABLE_INQ_AND_PAGE    ((CsrUint8)0x03)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_DO_NOT_ALLOW_ROLE_SWITCH    ((CsrUint8)0x00)
#define HCI_ALLOW_ROLE_SWITCH           ((CsrUint8)0x01)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_ROLE_BECOME_MASTER          ((CsrUint8)0x00)
#define HCI_ROLE_STAY_SLAVE             ((CsrUint8)0x01)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_AUTH_ENABLE_OFF             ((CsrUint8)0x00)
#define HCI_AUTH_ENABLE_ON              ((CsrUint8)0x01)    /* for all connections */
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_ENC_OFF                     ((CsrUint8)0x00)
#define HCI_ENC_ON                      ((CsrUint8)0x01)

#define HCI_ENC_MODE_OFF                ((CsrUint8)0x00)
#define HCI_ENC_MODE_PT_TO_PT           ((CsrUint8)0x01)
#define HCI_ENC_MODE_PT_TO_PT_AND_BCAST ((CsrUint8)0x02)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_VOICE_INPUT_MASK            ((CsrUint16)0x0300)
#define HCI_VOICE_INPUT_LIN             ((CsrUint16)0x0000)
#define HCI_VOICE_INPUT_MU_LAW          ((CsrUint16)0x0100)
#define HCI_VOICE_INPUT_A_LAW           ((CsrUint16)0x0200)
#define HCI_VOICE_FORMAT_MASK           ((CsrUint16)0x00C0)
#define HCI_VOICE_FORMAT_1SCOMP         ((CsrUint16)0x0000)
#define HCI_VOICE_FORMAT_2SCOMP         ((CsrUint16)0x0040)
#define HCI_VOICE_FORMAT_SMAG           ((CsrUint16)0x0080)
#define HCI_VOICE_FORMAT_UNSIGNED       ((CsrUint16)0x00C0)
#define HCI_VOICE_SAMP_SIZE_MASK        ((CsrUint16)0x0020)
#define HCI_VOICE_SAMP_SIZE_8BIT        ((CsrUint16)0x0000)
#define HCI_VOICE_SAMP_SIZE_16BIT       ((CsrUint16)0x0020)
#define HCI_VOICE_LINEAR_PCM_MASK       ((CsrUint16)0x001C)
#define HCI_VOICE_AIR_CODING_MASK       ((CsrUint16)0x0003)
#define HCI_VOICE_AIR_CODING_CVSD       ((CsrUint16)0x0000)
#define HCI_VOICE_AIR_CODING_MU_LAW     ((CsrUint16)0x0001)
#define HCI_VOICE_AIR_CODING_A_LAW      ((CsrUint16)0x0002)
#define HCI_VOICE_TRANSPARENT_DATA      ((CsrUint16)0x0003)

#define HCI_VOICE_SETTINGS_DEFAULT      ((CsrUint16)0x0060)
#define HCI_VOICE_SETTING_MAX_VALUE     ((CsrUint16)0x03FF) /* 10 bits meaningful */
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_MAX_FLUSH_TIMEOUT           ((CsrUint16)0x07FF)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_HOLD_CURR_PWR_STATE         ((CsrUint8)0x00)
#define HCI_HOLD_SUSPEND_PAGE_SCAN      ((CsrUint8)0x01)
#define HCI_HOLD_SUSPEND_INQ_SCAN       ((CsrUint8)0x02)
#define HCI_HOLD_SUSPEND_PER_INQ        ((CsrUint8)0x04)

#define HCI_HOLD_MIN_PERIOD             ((CsrUint16)0x01)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_SNIFF_MAX_INTERVAL_MIN      ((CsrUint16)0x01)
#define HCI_SNIFF_MIN_INTERVAL_MIN      ((CsrUint16)0x01)
#define HCI_SNIFF_ATTEMPT_MIN           ((CsrUint16)0x01)
#define HCI_SNIFF_ATTEMPT_MAX           ((CsrUint16)0x7FFF)
#define HCI_SNIFF_TIMEOUT_MIN           ((CsrUint16)0x00)
#define HCI_SNIFF_TIMEOUT_MAX           ((CsrUint16)0x7FFF)
#define HCI_SNIFF_SUB_RATE_LATENCY_MAX  ((CsrUint16)0xFFFE)
#define HCI_SNIFF_SUB_RATE_TIMEOUT_MAX  ((CsrUint16)0xFFFE)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_CHANNEL_CLASS_MODE_DISABLE  ((CsrUint8)0x00)
#define HCI_CHANNEL_CLASS_MODE_ENABLE   ((CsrUint8)0x01)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_CO_CODE_NA_AND_EUR     ((CsrUint8)0x00)
#define HCI_CO_CODE_FRANCE         ((CsrUint8)0x01)
#define HCI_CO_CODE_SPAIN          ((CsrUint8)0x02)
#define HCI_CO_CODE_JAPAN          ((CsrUint8)0x03)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_GEN_SELF_TEST          ((CsrUint8)0x00)
#define HCI_LOOPBACK_OFF           ((CsrUint8)0x00)
#define HCI_LOCAL_LOOPBACK         ((CsrUint8)0x01)
#define HCI_REMOTE_LOOPBACK        ((CsrUint8)0x02)
#define HCI_LOOPBACK_MODE_MAX      ((CsrUint8)0x03)
 ...
 *
 *---------------------------------------------------------------------------*/
#define HCI_LINK_TYPE_SCO          ((CsrUint8)0x00)
#define HCI_LINK_TYPE_ACL          ((CsrUint8)0x01)
#define HCI_LINK_TYPE_ESCO         ((CsrUint8)0x02)
#define HCI_LINK_TYPE_DONT_CARE    ((CsrUint8)0x03)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_PAGE_SCAN_REP_MODE_R0     ((CsrUint8)0x00)
#define HCI_PAGE_SCAN_REP_MODE_R1     ((CsrUint8)0x01)
#define HCI_PAGE_SCAN_REP_MODE_R2     ((CsrUint8)0x02)
 ...
 *
 *---------------------------------------------------------------------------*/
#define HCI_PAGE_SCAN_MODE_MANDATORY      ((CsrUint8)0x00)
#define HCI_PAGE_SCAN_MODE_OPTIONAL_1     ((CsrUint8)0x01)
#define HCI_PAGE_SCAN_MODE_OPTIONAL_2     ((CsrUint8)0x02)
#define HCI_PAGE_SCAN_MODE_OPTIONAL_3     ((CsrUint8)0x03)
 ...
 *
 *---------------------------------------------------------------------------*/
#define HCI_PAGESCAN_INTERVAL_MIN       ((CsrUint16) 0x12)
#define HCI_PAGESCAN_INTERVAL_DEFAULT   ((CsrUint16) 0x800)
#define HCI_PAGESCAN_INTERVAL_MAX       ((CsrUint16) 0x1000)
 ...
 *
 *---------------------------------------------------------------------------*/
#define HCI_PAGESCAN_WINDOW_MIN       ((CsrUint16) 0x11)
#define HCI_PAGESCAN_WINDOW_DEFAULT   ((CsrUint16) 0x12)
#define HCI_PAGESCAN_WINDOW_MAX       ((CsrUint16) 0x1000)
 ...
 *
 *---------------------------------------------------------------------------*/
#define HCI_PAGESCAN_PERIOD_MODE_P0         ((CsrUint8) 0x00)
#define HCI_PAGESCAN_PERIOD_MODE_P1         ((CsrUint8) 0x01)
#define HCI_PAGESCAN_PERIOD_MODE_P2         ((CsrUint8) 0x02)
 ...
 *
 *---------------------------------------------------------------------------*/
#define HCI_SCAN_TYPE_LEGACY           ((CsrUint8) 0x00)
#define HCI_SCAN_TYPE_INTERLACED       ((CsrUint8) 0x01)
 ...
 *
 *---------------------------------------------------------------------------*/
#define HCI_INQUIRY_MODE_STANDARD      ((CsrUint8) 0x00)
#define HCI_INQUIRY_MODE_WITH_RSSI     ((CsrUint8) 0x01)
#define HCI_INQUIRY_MODE_WITH_EIR      ((CsrUint8) 0x02)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_MIN_PIN_LENGTH  ((CsrUint8)0x01)
#define HCI_MAX_PIN_LENGTH  ((CsrUint8)0x10)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_NUM_CURRENT_IAC_MIN   ((CsrUint8)0x01)
#define HCI_NUM_CURRENT_IAC_MAX   ((CsrUint8)0x40)
#define HCI_IAC_LAP_MIN           ((CsrUint32)0x9E8B00)
#define HCI_IAC_LAP_MAX           ((CsrUint32)0x9E8B3F)

#define HCI_INQ_CODE_GIAC  ((CsrUint32)0x9e8b33)
/*-----------------------------------------------------------------------------*
 *
 *   HCI Connection Accept Timeout values
 *
 *------------------------------------------------------------------------------*/
#define HCI_CONNECTION_ACCEPT_TIMEOUT_MIN   ((CsrUint16)0x01)
#define HCI_CONNECTION_ACCEPT_TIMEOUT_MAX   ((CsrUint16)0x0B540)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_HANDLE_MAX   ((CsrUint16)0x0EFF)
#define HCI_HANDLE_INVALID ((CsrUint16) 0xffff)
 ...
 *
 *---------------------------------------------------------------------------*/
#define HCI_LINK_SUPERVISION_INFINITY   ((CsrUint16)0x0000)
#define HCI_LINK_SUPERVISION_MIN        ((CsrUint16)0x0001)
#define HCI_LINK_SUPERVISION_DEFAULT    ((CsrUint16)0x7D00)
#define HCI_LINK_SUPERVISION_MAX        ((CsrUint16)0xFFFF)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_READ_CURRENT_TX_POWER       ((CsrUint8)0x00)
#define HCI_READ_MAX_TX_POWER           ((CsrUint8)0x01)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_SCO_FLOW_CONTROL_DISABLED   ((CsrUint8)0x00)
#define HCI_SCO_FLOW_CONTROL_ENABLED    ((CsrUint8)0x01)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_HCITOH_FLOW_CONTROL_DISABLED            ((CsrUint8)0x00)
#define HCI_HCITOH_FLOW_CONTROL_ENABLED_ACL_ONLY    ((CsrUint8)0x01)
#define HCI_HCITOH_FLOW_CONTROL_ENABLED_SCO_ONLY    ((CsrUint8)0x02)
#define HCI_HCITOH_FLOW_CONTROL_ENABLED_ACL_AND_SCO ((CsrUint8)0x03)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_STORED_LINK_KEY_MAX             ((CsrUint8)10)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_COMBINATION_KEY                 ((CsrUint8)0)
#define HCI_LOCAL_UNIT_KEY                  ((CsrUint8)1)
#define HCI_REMOTE_UNIT_KEY                 ((CsrUint8)2)
#define HCI_DEBUG_COMBINATION_KEY           ((CsrUint8)3)
#define HCI_UNAUTHENTICATED_COMBINATION_KEY ((CsrUint8)4)
#define HCI_AUTHENTICATED_COMBINATION_KEY   ((CsrUint8)5)
#define HCI_CHANGED_COMBINATION_KEY         ((CsrUint8)6)
#define HCI_KEY_TYPE_UNKNOWN                ((CsrUint8)0xFF)

/*---------------------------------------------------------------------------*
 *
 *  Coding of BR/EDR Features. Features is 64 bits long, it is sent across HCI
 *  as an array of 8 CsrUint8s, hence the feature definitions are split into 8 bit
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_SIMPLE_PAIRING_MODE_NOTSET          ((CsrUint8)0x00)
#define HCI_SIMPLE_PAIRING_MODE_ENABLED         ((CsrUint8)0x01)
...
#define HCI_IO_CAP_DISPLAY_ONLY                 ((CsrUint8)0x00)
#define HCI_IO_CAP_DISPLAY_YES_NO               ((CsrUint8)0x01)
#define HCI_IO_CAP_KEYBOARD_ONLY                ((CsrUint8)0x02)
#define HCI_IO_CAP_NO_INPUT_NO_OUTPUT           ((CsrUint8)0x03)
#define HCI_IO_CAP_KEYBOARD_DISPLAY             ((CsrUint8)0x04)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_OOB_DATA_NOT_PRESENT                ((CsrUint8)0x00)
#define HCI_OOB_DATA_PRESENT                    ((CsrUint8)0x01)
...
#define HCI_MITM_NOT_REQUIRED_NO_BONDING        ((CsrUint8)0x00)
#define HCI_MITM_REQUIRED_NO_BONDING            ((CsrUint8)0x01)
#define HCI_MITM_NOT_REQUIRED_DEDICATED_BONDING ((CsrUint8)0x02)
#define HCI_MITM_REQUIRED_DEDICATED_BONDING     ((CsrUint8)0x03)
#define HCI_MITM_NOT_REQUIRED_GENERAL_BONDING   ((CsrUint8)0x04)
#define HCI_MITM_REQUIRED_GENERAL_BONDING       ((CsrUint8)0x05)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_SIMPLE_PAIRING_DEBUG_MODE_DISABLED  ((CsrUint8)0x00)
#define HCI_SIMPLE_PAIRING_DEBUG_MODE_ENABLED   ((CsrUint8)0x01)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_NOTIFICATION_TYPE_PASSKEY_STARTED         ((CsrUint8)0x00)
#define HCI_NOTIFICATION_TYPE_PASSKEY_DIGIT_ENTERED   ((CsrUint8)0x01)
#define HCI_NOTIFICATION_TYPE_PASSKEY_DIGIT_ERASED    ((CsrUint8)0x02)
#define HCI_NOTIFICATION_TYPE_PASSKEY_CLEARED         ((CsrUint8)0x03)
#define HCI_NOTIFICATION_TYPE_PASSKEY_COMPLETED       ((CsrUint8)0x04)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_LM_SCO_HANDLE_INVALID       ((CsrUint8) 0x00)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_TEST_MAX_FREQ                      ((CsrUint8)0x27)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_TEST_MAX_LEN                       ((CsrUint8)0x25)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_TEST_PATTERN_PRBS9                 ((CsrUint8)0x00)
#define HCI_ULP_TEST_PATTERN_11110000              ((CsrUint8)0x01)
#define HCI_ULP_TEST_PATTERN_10101010              ((CsrUint8)0x02)
#define HCI_ULP_TEST_PATTERN_PRBS15                ((CsrUint8)0x03)
#define HCI_ULP_TEST_PATTERN_ALL_1                 ((CsrUint8)0x04)
#define HCI_ULP_TEST_PATTERN_ALL_0                 ((CsrUint8)0x05)
#define HCI_ULP_TEST_PATTERN_00001111              ((CsrUint8)0x06)
#define HCI_ULP_TEST_PATTERN_01010101              ((CsrUint8)0x07)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_LE_SUPPORTED_HOST_DISABLED             ((CsrUint8)0x00)
#define HCI_LE_SUPPORTED_HOST_ENABLED              ((CsrUint8)0x01)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_SIMULTANEOUS_LE_HOST_DISABLED          ((CsrUint8)0x00)
#define HCI_SIMULTANEOUS_LE_HOST_ENABLED           ((CsrUint8)0x01)


/*---------------------------------------------------------------------------*
 *
 *  Coding of ULP Features. Features is 64 bits long, it is sent across HCI as
 *  an array of 8 CsrUint8s, hence the feature definitions are split into 8 bit
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_ADVERT_CONNECTABLE_UNDIRECTED      ((CsrUint8)0x00)
#define HCI_ULP_ADVERT_CONNECTABLE_DIRECTED        ((CsrUint8)0x01)
#define HCI_ULP_ADVERT_DISCOVERABLE                ((CsrUint8)0x02)
#define HCI_ULP_ADVERT_NON_CONNECTABLE             ((CsrUint8)0x03)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_ADDRESS_PUBLIC                     ((CsrUint8)0x00)
#define HCI_ULP_ADDRESS_RANDOM                     ((CsrUint8)0x01)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_ADVERT_CHANNEL_37           ((CsrUint8)0x01)
#define HCI_ULP_ADVERT_CHANNEL_38           ((CsrUint8)0x02)
#define HCI_ULP_ADVERT_CHANNEL_39           ((CsrUint8)0x04)
#define HCI_ULP_ADVERT_CHANNEL_ALL          ((CsrUint8)(HCI_ULP_ADVERT_CHANNEL_37 | \
                                                       HCI_ULP_ADVERT_CHANNEL_38 | \
                                                       HCI_ULP_ADVERT_CHANNEL_39))
#define HCI_ULP_ADVERT_CHANNEL_DEFAULT      HCI_ULP_ADVERT_CHANNEL_ALL
#define HCI_ULP_ADVERT_CHANNEL_MIN_VALUE    ((CsrUint8)0x01)
#define HCI_ULP_ADVERT_CHANNEL_MAX_VALUE    ((CsrUint8)0x07) /* 3 bits meaningful */
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_ADV_FP_ALLOW_ANY            ((CsrUint8)0x00)
#define HCI_ULP_ADV_FP_ALLOW_CONNECTIONS    ((CsrUint8)0x01)
#define HCI_ULP_ADV_FP_ALLOW_SCANNING       ((CsrUint8)0x02)
#define HCI_ULP_ADV_FP_ALLOW_WHITELIST      ((CsrUint8)0x03)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_ADVERTISING_DISABLED        ((CsrUint8)0x00)
#define HCI_ULP_ADVERTISING_ENABLED         ((CsrUint8)0x01)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_PASSIVE_SCANNING            ((CsrUint8)0x00)
#define HCI_ULP_ACTIVE_SCANNING             ((CsrUint8)0x01)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_SCAN_INTERVAL_MIN           ((CsrUint16)0x0004)
#define HCI_ULP_SCAN_INTERVAL_MAX           ((CsrUint16)0x4000)
#define HCI_ULP_SCAN_INTERVAL_DEFAULT       ((CsrUint16)0x0010)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_SCAN_WINDOW_MIN             ((CsrUint16)0x0004)
#define HCI_ULP_SCAN_WINDOW_MAX             ((CsrUint16)0x4000)
#define HCI_ULP_SCAN_WINDOW_DEFAULT         ((CsrUint16)0x0010)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_SCAN_FP_ALLOW_ALL           ((CsrUint8)0x00)
#define HCI_ULP_SCAN_FP_ALLOW_WHITELIST     ((CsrUint8)0x01)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_SCAN_DISABLED               ((CsrUint8)0x00)
#define HCI_ULP_SCAN_ENABLED                ((CsrUint8)0x01)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_FILTER_DUPLICATES_DISABLED  ((CsrUint8)0x00)
#define HCI_ULP_FILTER_DUPLICATES_ENABLED   ((CsrUint8)0x01)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_CONN_INTERVAL_MIN           ((CsrUint16)0x0006)
#define HCI_ULP_CONN_INTERVAL_MAX           ((CsrUint16)0x0C80)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_CONN_LATENCY_MAX            ((CsrUint16)0x01F4)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_SUPERVISION_TIMEOUT_MIN     ((CsrUint16)0x000A)
#define HCI_ULP_SUPERVISION_TIMEOUT_MAX     ((CsrUint16)0x0C80)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_CE_LENGTH_MIN               ((CsrUint16)0x0000)
#define HCI_ULP_CE_LENGTH_MAX               ((CsrUint16)0xFFFF)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_INITIATOR_FP_DONT_USE_WHITELIST   ((CsrUint8)0x00)
#define HCI_ULP_INITIATOR_FP_USE_WHITELIST        ((CsrUint8)0x01)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_EV_ROLE_MASTER                    ((CsrUint8)0x00)
#define HCI_ULP_EV_ROLE_SLAVE                     ((CsrUint8)0x01)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_EV_CLOCK_ACCURACY_500PPM          ((CsrUint8)0x00)
#define HCI_ULP_EV_CLOCK_ACCURACY_250PPM          ((CsrUint8)0x01)
#define HCI_ULP_EV_CLOCK_ACCURACY_150PPM          ((CsrUint8)0x02)
#define HCI_ULP_EV_CLOCK_ACCURACY_100PPM          ((CsrUint8)0x03)
#define HCI_ULP_EV_CLOCK_ACCURACY_75PPM           ((CsrUint8)0x04)
#define HCI_ULP_EV_CLOCK_ACCURACY_50PPM           ((CsrUint8)0x05)
#define HCI_ULP_EV_CLOCK_ACCURACY_30PPM           ((CsrUint8)0x06)
#define HCI_ULP_EV_CLOCK_ACCURACY_20PPM           ((CsrUint8)0x07)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_EV_ADVERT_CONNECTABLE_UNDIRECTED  ((CsrUint8)0x00)
#define HCI_ULP_EV_ADVERT_CONNECTABLE_DIRECTED    ((CsrUint8)0x01)
#define HCI_ULP_EV_ADVERT_DISCOVERABLE            ((CsrUint8)0x02)
#define HCI_ULP_EV_ADVERT_NON_CONNECTABLE         ((CsrUint8)0x03)
#define HCI_ULP_EV_ADVERT_SCAN_RESPONSE           ((CsrUint8)0x04)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_ARC_CONVERT(input_struct)           (sizeof(input_struct)*sizeof(CsrUint8)/sizeof(CsrUint16))
#define HCI_PMALLOC_ARC_CONVERT                 CsrPmemZalloc(HCI_VAR_ARG_POOL_SIZE * sizeof(CsrUint16))
...
#define HCI_IAC_LAP_PER_PTR                     (HCI_VAR_ARG_POOL_SIZE/HCI_ARC_CONVERT(CsrUint24))
...
typedef struct
{
    ...
    CsrUint8          length;              /* parameter total length */
...
typedef struct
{
    hci_op_code_t    op_code;             /* op code of command */
    CsrUint8          length;              /* parameter total length */
    CsrUint8          data ;               /* Dummy field used to determine
...
typedef struct
{
    CsrUint16         handle_plus_flags;   /* handle is 12 lsb, flags 4 msb */
    CsrUint16         length;              /* data total length */
} HCI_ACL_DATA_COMMON_T;

typedef struct
{
    CsrUint16         handle;              /* handle is 12 lsb */
    CsrUint8          length;              /* data total length */
...
typedef struct
{
    ...
    CsrUint8             link_key[SIZE_LINK_KEY];/* Link key */
...
{
    HCI_COMMAND_COMMON_T   common;
    CsrUint24               lap;             /* Lower 3 Bytes used only */
...
{
    HCI_COMMAND_COMMON_T   common;
    CsrUint16               max_period_length;  /* non zero, max_period_length > min_period_length */
    CsrUint16               min_period_length;  /* non zero, min_period_length > inquiry_length */
    CsrUint24               lap;                /* Lower 3 bytes used only */
    CsrUint8                inquiry_length;
    CsrUint8                num_responses;
...
typedef struct
{
    HCI_COMMAND_COMMON_T   common;
    BD_ADDR_T              bd_addr;
    CsrUint8                key_val[SIZE_LINK_KEY];
...
typedef struct
{
    HCI_COMMAND_COMMON_T   common;
    BD_ADDR_T              bd_addr;
    CsrUint8                pin_code_length;    /* in bytes, 1 to 16 decimal */
    CsrUint16               pin[8];             /* 8 16bit words. */
...
typedef struct
{
    HCI_COMMAND_COMMON_T   common;
    BD_ADDR_T              bd_addr;
    CsrUint8                c[SIZE_OOB_DATA];
    CsrUint8                r[SIZE_OOB_DATA];
...
typedef struct
{
    ...
    ADDED_BD_ADDRESS
    CsrUint8            flags;
    CsrUint8            flow_direction; /* 0=out (to air), 1=in (from air) */
...
typedef struct
{
    CsrUint16                max_num_keys;
    CsrUint16                num_keys_read;
...
{
    HCI_COMMAND_COMMON_T   common;
    CsrUint8                number_keys;        /* number of link keys to write */
...
typedef struct
{
     ...
     */
    CsrUint8                *name_part[HCI_LOCAL_NAME_BYTE_PACKET_PTRS];
...
typedef struct
{
    CsrUint24                 dev_class;       /* Lower 3 bytes only used */
...
{
    hci_connection_handle_t handle;
    CsrInt8                  pwr_level_GFSK;     /* Basic rate   */
    CsrInt8                  pwr_level_DQPSK;    /* EDR 2M       */
    CsrInt8                  pwr_level_8DPSK;    /* EDR 3M       */
...
typedef struct
{
    CsrUint8     sco_flow_control_enable;
...
{
    HCI_COMMAND_COMMON_T     common;
    CsrUint16                 acl_packet_len;
    CsrUint8                  sco_packet_len;
    CsrUint16                 acl_total_packets;
    CsrUint16                 sco_total_packets;
 ...
 *
 *      Max Size of HCI payload = 255, Variable Size = 255-(CsrUint8) = 254
 *
 ...
 *      Max Size of HCI payload = 255, Variable Size = 255-(CsrUint8) = 254
 *
 *      HCI_IAC_LAP_PER_PTR - Number of CsrUint24's
 *        in a pointed at block.
...
typedef struct
{
    CsrUint8              num_current_iac;
    /*
     * Array of Pointers to an array of CsrUint24
     */
    CsrUint24 *iac_lap[HCI_IAC_LAP_PTRS];
...
typedef struct
{
    ...
    CsrUint8                  mode;
#ifdef CSR_ONLY
                                    /* TODO: 0=Mandatory 1=optional1 2=opt2 3=opt3 */
#endif
...
{
    HCI_COMMAND_COMMON_T     common;
    CsrUint8                  mode;  /* 0=legacy 1=interlaced */
...
{
    HCI_COMMAND_COMMON_T     common;
    CsrUint8                  mode;  /* 0=standard 1=with rssi */
...
typedef struct
{
    CsrUint32                 addr_update_time;
    CsrUint16                 addr_inquiry_period;
...
typedef struct
{
    ...
    CsrUint8                 *eir_data_part[HCI_EIR_DATA_PACKET_PTRS];
...
typedef struct
{
    CsrUint8                  le_supported_host;
    CsrUint8                  simultaneous_le_host;
...
typedef struct
{
    ...
    CsrUint16                 hci_revision;
    CsrUint8                  lmp_version;        /* defined in LMP */
    CsrUint16                 manuf_name;         /* defined in LMP */
    CsrUint16                 lmp_subversion;
...
typedef struct
{
    CsrUint8 *supp_commands[HCI_READ_SUPP_COMMANDS_PACKET_PTRS];
...
{
    CsrUint8                  page_num;
    CsrUint8                  max_page_num;
    CsrUint8                  lmp_ext_features[8];
#ifdef CSR_ONLY
                                                    /* TODO: bit masks! */
#endif
...
typedef struct
{
    CsrUint16                 acl_data_pkt_length;
    CsrUint8                  sco_data_pkt_length;
    CsrUint16                 total_acl_data_pkts;
    CsrUint16                 total_sco_data_pkts;
...
{
    hci_connection_handle_t handle;
    CsrUint16                failed_contact_count;
...
{
    HCI_COMMAND_COMMON_T     common;
    CsrUint8                  simple_pairing_debug_mode;
...
typedef struct
{
    CsrUint16                  data_packet_length;
    CsrUint8                   num_data_packets;
...
typedef struct
{
    ...
    CsrUint8                  scan_response_data[31];
...
typedef struct
{
    ...
    CsrUint16                 scan_interval;
    CsrUint16                 scan_window;
    CsrUint8                  initiator_filter_policy;
    CsrUint8                  peer_address_type;
...
typedef struct
{
    HCI_COMMAND_COMMON_T     common;
    CsrUint8                  aes_key[16];
    CsrUint8                  plaintext_data[16];
} HCI_ULP_ENCRYPT_T;

typedef struct
{
    CsrUint8                  encrypted_data[16];
...
typedef struct
{
    ...
    hci_connection_handle_t  connection_handle;
    CsrUint8                  random_number[8];
    CsrUint16                 encrypted_diversifier;
    CsrUint8                  long_term_key[16];
...
typedef union
{
    CsrUint8              *bcf;              /* carries tunnelled primitives */
...
typedef struct
{
    BD_ADDR_T                bd_addr;
    page_scan_rep_mode_t     page_scan_rep_mode;
    CsrUint8                  page_scan_period_mode;
    page_scan_mode_t         page_scan_mode;
    CsrUint24                 dev_class;  /* Lower 3 bytes only used */
 ...
 *            handles follow and then the same number of counts.
 *
 *      Max Size of HCI payload = 256, Variable Size = 256-(CsrUint8) = 255
 *
 *      HCI_BYTE_SIZE_OF_HANDLE_COMPLETE_T  - Byte size of HANDLE_COMPLETE_T
 *        when transmitted across the HCI interface.
...
typedef struct
{
    HCI_EVENT_COMMON_T       event;
    BD_ADDR_T                bd_addr;
    CsrUint8                  link_key[SIZE_LINK_KEY];
    CsrUint8                  key_type;
...
typedef struct
{
    CsrUint8     bytes[HCI_LOOPBACK_BYTES_PER_PTR];
...
typedef struct
{
    ...
    hci_return_t             status;
    hci_connection_handle_t  handle;
    CsrUint16                 transmit_latency;
    CsrUint16                 receive_latency;
    CsrUint16                 remote_timeout;
    CsrUint16                 local_timeout;
...
typedef struct
{
    ...
    CsrUint8                 peer_address_type;
    BD_ADDR_T               peer_address;
    CsrUint16                conn_interval;
    CsrUint16                conn_latency;
    CsrUint16                supervision_timeout;
    CsrUint8                 clock_accuracy;
...
{
    HCI_ULP_EVENT_COMMON_T  event;
    CsrUint8                 num_reports;
    CsrUint8                 event_type;
    CsrUint8                 address_type;
    BD_ADDR_T               address;
    CsrUint8                 length_data;
    CsrUint8                 data[31];
    CsrInt8                  rssi;
