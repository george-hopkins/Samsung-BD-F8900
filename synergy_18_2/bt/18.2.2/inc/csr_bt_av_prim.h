...
#define CSR_BT_AV_PRIM_DOWNSTREAM_HIGHEST                    (0x0024 + CSR_BT_AV_PRIM_DOWNSTREAM_LOWEST)
...
#define CSR_BT_AV_PRIM_UPSTREAM_HIGHEST                      (0x0024 + CSR_BT_AV_PRIM_UPSTREAM_LOWEST)
...
#define CSR_BT_AV_LP_SUPERVISION_TIMER          ((CsrBtAvPrim) (0x0025 + CSR_BT_AV_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_AV_HOUSE_CLEANING                ((CsrBtAvPrim) (0x0026 + CSR_BT_AV_PRIM_UPSTREAM_LOWEST))
/*******************************************************************************
