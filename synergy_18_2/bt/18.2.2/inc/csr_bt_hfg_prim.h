...
typedef CsrUint8                         CsrBtHfgStreamType;

typedef struct
{
  CsrUint16 CsrBtHfgConfigParamId;
  CsrUint32 CsrBtHfgConfigParamVal;
} CsrBtHfgStreamConfigParam;
...
#define CSR_BT_HFG_AUDIO_CODEC_SETUP           ((CsrBtHfgAudioCodecType) 0x06)
typedef CsrUint8                        CsrBtHfgAudioCodecType;
#define CSR_BT_HFG_AUDIO_VOICE_SETTINGS        ((CsrBtHfgAudioType) 0x07)       /* Voice settings (audio codec) */
typedef CsrUint16                       CsrBtHfgAudioVoiceSettings;
#define CSR_BT_HFG_AUDIO_CODEC_STATUS          ((CsrBtHfgAudioType) 0x08)
typedef struct
{
    CsrUint8                            supportedMask;
    CsrUint8                            currentCodec;
} CsrBtHfgAudioCodecStatus;
#define CSR_BT_HFG_AUDIO_SAMPLE_RATE_SETUP     ((CsrBtHfgAudioType) 0x09)
typedef CsrUint8                        CsrBtHfgAudioSampleRateType;
#define CSR_BT_HFG_AUDIO_SAMPLE_RATE_STATUS    ((CsrBtHfgAudioType) 0x0A)
typedef struct
{
    CsrUint8                            supportedSampleRateMask;
    CsrUint8                            currentSampleRate;
} CsrBtHfgAudioSampleRateStatus;

#define CSR_BT_HFG_AUDIO_DSPM_STREAMS_CONFIG            ((CsrBtHfgAudioType) 0x0B)    /* Only relevant for chips using DSP
                                                                                            Selects which audio Source and Sink  to use when connecting Streams for a SCO connection
                                                                                            eg I2S, PCM, Codec or FM.  Default is PCM.
                                                                                            Additionally sourceConfigParams contains a pointer array to a list of parameters for 
                                                                                            HF to request the stream type to be configured with
                                                                                            By default PCM, I2S and Codecs will be configured for the correct data rates for either CVSD or WBS link
                                                                                            To retain Defaults send a"numConfigParams" of 0 and pointer ConfigParams of NULL.
                                                                                         */
typedef struct
{
    CsrBtHfgStreamType          sourceType;
    CsrUint16                   sourceInstance;
    CsrUint16                   sourceChannel;
    CsrUint16                   numSourceWbsConfigParams;
    CsrBtHfgStreamConfigParam*  sourceWbsConfigParams;
    CsrUint16                   numSourceNbConfigParams;
    CsrBtHfgStreamConfigParam*  sourceNbConfigParams;
    CsrBtHfgStreamType          sinkType;
    CsrUint16                   sinkInstance;
    CsrUint16                   sinkChannel;
    CsrUint16                   numSinkWbsConfigParams;
    CsrBtHfgStreamConfigParam*  sinkWbsConfigParams;
    CsrUint16                   numSinkNbConfigParams;
    CsrBtHfgStreamConfigParam*  sinkNbConfigParams;
} CsrBtHfgAudioDspmStreamConfig;

#define CSR_BT_HFG_AUDIO_DSPM_STREAM_SINGLE_CONFIG      ((CsrBtHfgAudioType) 0x0C)    /* Only relevant for chips using DSP
                                                                                        Sets one configuration feature/value for one established audio stream.
                                                                                         For instance, the gain */

typedef struct
{
    CsrUint16                       scoHandle;
    CsrBtHfgStreamConfigParam       configPair;
} CsrBtHfgAudioDspStreamSingleConfig;
...
#define CSR_BT_HFG_CNF_DISABLE_C2C                 0x00000004 /* Disable the CSR-2-CSR extensions completely */
#define CSR_BT_HFG_CNF_DISABLE_BIA                 0x00000008 /* Disable AT+BIA support */
#define CSR_BT_HFG_CNF_MANUAL_INDICATORS           0x00000010 /* _NOT_ recommended: Manual CIND handling in AT sequence */
#define CSR_BT_HFG_CNF_DISABLE_COPS                0x00000020 /* Disable support for "AT+COPS=" command. Recommended when no operator name is available */
#define CSR_BT_HFG_CNF_EXIT_LP_ON_AUDIO            0x00000040 /* Exit LP-mode when audio connection established */
#define CSR_BT_HFG_CNF_DISABLE_ESCO_TO_OLD_DEVICES 0x00000080 /* Do not try to establish eSCO towards pre-1.05 spec devices */
...
#define CSR_BT_HFG_C2C_SF_REQ                          ((CsrBtHfgPrim) (0x001B + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_C2C_TXT_REQ                         ((CsrBtHfgPrim) (0x001C + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_C2C_SMS_ARRIVE_REQ                  ((CsrBtHfgPrim) (0x001D + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_C2C_SMS_TXT_REQ                     ((CsrBtHfgPrim) (0x001E + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_VOICE_RECOG_RES                     ((CsrBtHfgPrim) (0x001F + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_MANUAL_INDICATOR_RES                ((CsrBtHfgPrim) (0x0020 + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_CONFIG_SINGLE_ATCMD_REQ             ((CsrBtHfgPrim) (0x0021 + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_CONFIG_ATCMD_HANDLING_REQ           ((CsrBtHfgPrim) (0x0022 + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_GET_C2C_ADPCM_LOCAL_SUPPORTED_REQ   ((CsrBtHfgPrim) (0x0023 + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_DEREGISTER_TIME_REQ                 ((CsrBtHfgPrim) (0x0024 + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))

#define CSR_BT_HFG_PRIM_DOWNSTREAM_HIGHEST                          (0x0024 + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST)
...
#define CSR_BT_HFG_C2C_SF_IND                          ((CsrBtHfgPrim) (0x001B + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_C2C_SMS_GET_IND                     ((CsrBtHfgPrim) (0x001C + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_C2C_BATTERY_IND                     ((CsrBtHfgPrim) (0x001D + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_C2C_POWER_IND                       ((CsrBtHfgPrim) (0x001E + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_MANUAL_INDICATOR_IND                ((CsrBtHfgPrim) (0x001F + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_CONFIG_SINGLE_ATCMD_CFM             ((CsrBtHfgPrim) (0x0020 + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_CONFIG_ATCMD_HANDLING_CFM           ((CsrBtHfgPrim) (0x0021 + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_GET_C2C_ADPCM_LOCAL_SUPPORTED_IND   ((CsrBtHfgPrim) (0x0022 + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_DEREGISTER_TIME_CFM                 ((CsrBtHfgPrim) (0x0023 + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))

#define CSR_BT_HFG_PRIM_UPSTREAM_HIGHEST                            (0x0023 + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST)
...
typedef struct
{
    ...
    CsrBtC2cCodecType           codecUsed;                      /* Codec used for the audio connection established */
    CsrBtC2cSamplaRateType      sampleRate;                     /* Sample rate used for the audio connection established */
...
/* CSR-2-CSR supported features update request (+CSRSF and +CSR) */
typedef struct
{
    CsrBtHfgPrim                type;                           /* primitive/message identity */
    CsrBtHfgConnectionId        connectionId;                   /* connection index */
    CsrUint8                    number;                         /* indicator to update */
    CsrUint8                    value;                          /* new value */
} CsrBtHfgC2cSfReq;

/* CSR-2-CSR supported features indication (AT+CSRSF and AT+CSR) */
typedef struct
{
    CsrBtHfgPrim                type;                           /* primitive/message identity */
    CsrBtHfgConnectionId        connectionId;                   /* connection index */
...
/* CSR-2-CSR text to speak request (+CSRTXT) */
typedef struct
{
    CsrBtHfgPrim                type;                           /* primitive/message identity */
    CsrBtHfgConnectionId        connectionId;                   /* connection index */
    CsrCharString                   *text;                          /* text to send */
} CsrBtHfgC2cTxtReq;

/* CSR-2-CSR has arrived (+CSRSMS) */
typedef struct
{
    CsrBtHfgPrim                type;                           /* primitive/message identity */
    CsrBtHfgConnectionId        connectionId;                   /* connection index */
    CsrUint16                   smsIndex;                       /* index of arrived sms */
    CsrCharString                   *number;                        /* number of sending party */
    CsrCharString                   *name;                          /* phonebook name of sending party */
} CsrBtHfgC2cSmsArriveReq;

/* CSR-2-CSR SMS-2-speech request (+CSRGETSMS) */
typedef struct
{
    CsrBtHfgPrim                type;                           /* primitive/message identity */
    CsrBtHfgConnectionId        connectionId;                   /* connection index */
    CsrCharString                   *smsText;                       /* body text of sms */
} CsrBtHfgC2cSmsTxtReq;

/* CSR-2-CSR SMS fetch indication (AT+CSRGETSMS) */
typedef struct
{
    CsrBtHfgPrim                type;                           /* primitive/message identity */
    CsrBtHfgConnectionId        connectionId;                   /* connection index */
    CsrUint16                   smsIndex;                       /* index of sms being requested */
} CsrBtHfgC2cSmsGetInd;

/* CSR-2-CSR battery level indication (AT+CSRBATT) */
typedef struct
{
    CsrBtHfgPrim                type;                           /* primitive/message identity */
    CsrBtHfgConnectionId        connectionId;                   /* connection index */
    CsrUint8                    batteryLevel;                   /* current battery level for the HF */
} CsrBtHfgC2cBatteryInd;

/* CSR-2-CSR power level indication (AT+CSRPWR) */
typedef struct
{
    CsrBtHfgPrim                type;                           /* primitive/message identity */
    CsrBtHfgConnectionId        connectionId;                   /* connection index */
    CsrUint8                    powerStatus;                    /* power status (mains, battery, etc.) */
} CsrBtHfgC2cPowerInd;
...
{
    CsrBtHfgPrim                type;                           /* primitive/message identity */
} CsrBtHfgGetC2cAdpcmLocalSupportedReq;

typedef struct
{
    CsrBtHfgPrim                type;                           /* primitive/message identity */
    CsrBool                     result;                         /* Supported or not */
} CsrBtHfgGetC2cAdpcmLocalSupportedInd;
