...
#define ETHERNET_ADAPTOR_BASEADDRESS    0x04000300
...
static VOID ethernetInterruptServiceRoutine(INT interrupt)
{
    ...
    INT_EXT_CLEAR(INT_EXT_EINT15);
    INT_CLEAR(INT_EINT15_18);
}
...
void EthernetDeinitialise()
{
    ...
    INT_EXT_MASK(INT_EXT_EINT15);
    INT_MASK(INT_EINT15_18);
    INT_EXT_CLEAR(INT_EXT_EINT15);
    INT_CLEAR(INT_EINT15_18);
    ...
    if (hisrCreated)
    {
        VOID (*previous)(INT);
        NU_Delete_HISR(&hisr);
        NU_Register_LISR(INT_EINT15_18, NULL, &previous);
        hisrCreated = FALSE;
    }
    ...
    EthernetMode mode)
{
    ...
    GPIOPinConfigure(GPIO_PIN_15, GPIO_FUNCTION_SPECIAL_1, GPIO_PULLUP_OFF, GPIO_TRIGGER_HIGHLEVEL);
    ...
    if (!hisrCreated)
    {
        ...
        NU_Register_LISR(INT_EINT15_18, &ethernetInterruptServiceRoutine, &previous);
        hisrCreated = TRUE;
    }
    ...
    INT_EXT_UNMASK(INT_EXT_EINT15);
    INT_UNMASK(INT_EINT15_18);
