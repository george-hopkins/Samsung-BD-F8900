...
#define CSR_UART_DRV_DATA_BITS_7    (2 << 0)
#define CSR_UART_DRV_DATA_BITS_8    (3 << 0)

typedef CsrUint8 CsrUartDrvParity;
#define CSR_UART_DRV_PARITY_NONE    (0 << 3)
#define CSR_UART_DRV_PARITY_EVEN    (5 << 3)

typedef CsrUint8 CsrUartDrvStopBits;
#define CSR_UART_DRV_STOP_BITS_1    (0 << 2)
#define CSR_UART_DRV_STOP_BITS_2    (1 << 2)
