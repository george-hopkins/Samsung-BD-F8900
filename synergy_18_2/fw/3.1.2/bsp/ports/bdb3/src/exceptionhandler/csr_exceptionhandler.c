    ...
    CsrUint32 theLine)
{
    ...
    sprintf(buf, "[%s:%u] State Event Exception: Task=%s, State=0x%x, EventClass=0x%x, Type=0x%x",
    ...
    CsrUint32 theLine)
{
    ...
    sprintf(buf, "[%s:%u] General Exception: Task=%s, State=0x%x, PrimType=0x%x [%s]",
    ...
    CsrUint32 theLine)
{
    ...
    sprintf(buf, "[%s:%u] General Warning: Task=%s, State=0x%x, PrimType=0x%x [%s]",
        theFile, theLine, theTask, theState, theprimType, theText);
