#ifndef CSR_LINUX_USB_EXTRA_H__
#define CSR_LINUX_USB_EXTRA_H__
/*****************************************************************************
 ...
 *
 *************************************************************/
typedef CsrBool (*probeExtraInterface_t)(csr_dev_t *csr_dev,
                                         CsrUint8 intfNumber,
 ...
 *
 *************************************************************/
typedef void (*setupExtraInterface_t)(CsrUint8 intrNr,
                                      void (*intrFunc)(void));
 ...
 *
 *************************************************************/
typedef CsrInt16 (*disconnectExtraInterface_t)(void);
 ...
 *              the extra interface and must be passed to Synergy
 ...
 *
 *************************************************************/
void SetupUsb(CsrUint8 intrNumber, void (*intrFunc)(void),
...
typedef struct
{
    CsrBool                    running_with_scheduler;
    CsrBool                    ext_iface;
