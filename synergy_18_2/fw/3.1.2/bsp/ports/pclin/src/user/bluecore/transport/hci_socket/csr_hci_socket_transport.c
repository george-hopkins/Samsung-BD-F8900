...
#define CSR_HCI_SOCKET_BUFSIZE   512
#endif
...
static void CsrTransportHciSocketMsgClean(void *unused);
...
{
    /*
     * Nothing to do here because we don't copy data
     * before passing it to HCI, and the message container
     * holding it is an automatic variable.
     */
}
