...
static void sessionDestroyHandler(CsrIpTlsInstanceData *);
...
static const CsrTlsEventHandler tlsHandler[] =
{
    ...
    configCertClientReqHandler,     /* CSR_TLS_CONFIG_CERT_CLIENT__REQ */
...
static void sessionDestroyHandler(CsrIpTlsInstanceData *instanceData)
{
