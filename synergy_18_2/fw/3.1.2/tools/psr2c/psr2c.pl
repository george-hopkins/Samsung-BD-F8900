...
print C_FILE "/*****************************************************************************\n";
print C_FILE "\n";
print C_FILE "            (c) Cambridge Silicon Radio Limited 2010\n";
print C_FILE "            All rights reserved and confidential information of CSR\n";
print C_FILE "\n";
print C_FILE "            Refer to LICENSE.txt included with this source for details\n";
print C_FILE "            on the license terms.\n";
print C_FILE "\n";
print C_FILE "*****************************************************************************/\n";
print C_FILE "\n";
