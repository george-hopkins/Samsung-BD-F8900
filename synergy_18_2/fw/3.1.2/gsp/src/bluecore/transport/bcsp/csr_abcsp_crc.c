...
static const CsrUint16 crc_table[256] =
{
...
/****************************************************************************
NAME
        CsrAbcspCrcReverse  -  get reverse of generated crc

IMPLEMENTATION NOTE
        The crc generator (CsrAbcspCrcInit() and CsrAbcspCrcUpdate())
...
CsrUint16 CsrAbcspCrcBlock(const CsrUint8 *block, CsrUint32 len)
{
    ...
    CsrAbcspCrcInit(&crc);
    CsrAbcspCrcUpdate(&crc, block, len);
    return CsrAbcspCrcReverse(crc);
}
