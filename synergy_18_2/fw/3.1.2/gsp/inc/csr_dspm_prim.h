...
#define CSR_DSPM_PRIM_DOWNSTREAM_HIGHEST                   (0x0010 + CSR_DSPM_PRIM_DOWNSTREAM_LOWEST)
...
#define CSR_DSPM_PRIM_UPSTREAM_HIGHEST                     (0x0012 + CSR_DSPM_PRIM_UPSTREAM_LOWEST)
