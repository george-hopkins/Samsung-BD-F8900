...
#define CSR_BT_RESULT_CODE_HF_C2C_REJECTED                              ((CsrBtResultCode) (0x0003))
#define CSR_BT_RESULT_CODE_HF_SYNCHRONOUS_CONNECTION_ALREADY_CONNECTING ((CsrBtResultCode) (0x0004))
#define CSR_BT_RESULT_CODE_HF_SYNCHRONOUS_CONNECTION_LIMIT_EXCEEDED     ((CsrBtResultCode) (0x0005))
#define CSR_BT_RESULT_CODE_HF_REJECTED_BY_PROFILE                       ((CsrBtResultCode) (0x0006))
#define CSR_BT_RESULT_CODE_HF_MAX_NUM_OF_CONNECTIONS                    ((CsrBtResultCode) (0x0007))
#define CSR_BT_RESULT_CODE_HF_SDC_SEARCH_FAILED                         ((CsrBtResultCode) (0x0008))
#define CSR_BT_RESULT_CODE_HF_CONNECT_ATTEMPT_FAILED                    ((CsrBtResultCode) (0x0009))
#define CSR_BT_RESULT_CODE_HF_CANCELLED_CONNECT_ATTEMPT                 ((CsrBtResultCode) (0x000A))
#define CSR_BT_RESULT_CODE_HF_CONNECTION_TERM_BY_REMOTE_HOST            ((CsrBtResultCode) (0x000B))
#define CSR_BT_RESULT_CODE_HF_REJ_RESOURCES                             ((CsrBtResultCode) (0x000C))
...
typedef CsrUint8         CsrBtHfStreamType;

typedef struct
{
  CsrUint16 CsrBtHfConfigParamId;
  CsrUint32 CsrBtHfConfigParamVal;
} CsrBtHfStreamConfigParam;
...
#define CSR_BT_HF_AUDIO_PREFERED_CODEC_SETUP                    ((CsrBtHfAudioType) 0x03)    /* set the prefered audio codec */
typedef CsrBtC2cCodecType  CsrBtHfAudioPreferedCodecType;

#define CSR_BT_HF_AUDIO_PREFERED_SAMPLE_RATE_SETUP              ((CsrBtHfAudioType) 0x04)    /* set the sample rate used for the prefered audio codec */
typedef CsrUint8         CsrBtHfAudioPreferedSampleRateType;

#define CSR_BT_HF_AUDIO_DSPM_STREAMS_CONFIG                     ((CsrBtHfAudioType) 0x05)    /* Only relevant for chips using DSP
...
typedef struct
{
    CsrBtHfStreamType sourceType;
    CsrUint16 sourceInstance;
    CsrUint16 sourceChannel;
    CsrUint16 numSourceWbsConfigParams;
    CsrBtHfStreamConfigParam* sourceWbsConfigParams;
    CsrUint16 numSourceNbConfigParams;
    CsrBtHfStreamConfigParam* sourceNbConfigParams;
    CsrBtHfStreamType sinkType;
    CsrUint16 sinkInstance;
    CsrUint16 sinkChannel;
    CsrUint16 numSinkWbsConfigParams;
    CsrBtHfStreamConfigParam* sinkWbsConfigParams;
    CsrUint16 numSinkNbConfigParams;
    CsrBtHfStreamConfigParam* sinkNbConfigParams;
} CsrBtHfAudioDspmStreamConfig;

#define CSR_BT_HF_AUDIO_DSPM_STREAM_SINGLE_CONFIG               ((CsrBtHfAudioType) 0x06)    /* Only relevant for chips using DSP
...
{
    CsrUint16                      scoHandle;
    CsrBtHfStreamConfigParam       configPair;
} CsrBtHfAudioDspStreamSingleConfig;
...
#define CSR_BT_HF_C2C_SF_REQ                               ((CsrBtHfPrim) (0x001F + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_SET_C2C_AUDIO_CODEC_REQ                  ((CsrBtHfPrim) (0x0020 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_GET_C2C_ADPCM_LOCAL_SUPPORTED_REQ        ((CsrBtHfPrim) (0x0021 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_SET_C2C_SAMPLE_RATE_REQ                  ((CsrBtHfPrim) (0x0022 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_C2C_PWR_REQ                              ((CsrBtHfPrim) (0x0023 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_C2C_BATT_REQ                             ((CsrBtHfPrim) (0x0024 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_C2C_GET_SMS_REQ                          ((CsrBtHfPrim) (0x0025 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_DEREGISTER_TIME_REQ                      ((CsrBtHfPrim) (0x0026 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_INDICATOR_ACTIVATION_REQ                 ((CsrBtHfPrim) (0x0027 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_UPDATE_SUPPORTED_CODEC_REQ               ((CsrBtHfPrim) (0x0028 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))

#define CSR_BT_HF_PRIM_DOWNSTREAM_HIGHEST                              (0x0028 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST)
...
#define CSR_BT_HF_C2C_SF_IND                               ((CsrBtHfPrim) (0x002F + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_SET_C2C_AUDIO_CODEC_IND                  ((CsrBtHfPrim) (0x0030 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_GET_C2C_ADPCM_LOCAL_SUPPORTED_IND        ((CsrBtHfPrim) (0x0031 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_SET_C2C_SAMPLE_RATE_IND                  ((CsrBtHfPrim) (0x0032 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_C2C_PWR_CFM                              ((CsrBtHfPrim) (0x0033 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_C2C_BATT_CFM                             ((CsrBtHfPrim) (0x0034 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_C2C_BATT_IND                             ((CsrBtHfPrim) (0x0035 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_C2C_GET_SMS_CFM                          ((CsrBtHfPrim) (0x0036 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_C2C_SMS_IND                              ((CsrBtHfPrim) (0x0037 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_C2C_TXT_IND                              ((CsrBtHfPrim) (0x0038 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_DEREGISTER_TIME_CFM                      ((CsrBtHfPrim) (0x0039 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_INDICATOR_ACTIVATION_CFM                 ((CsrBtHfPrim) (0x003A + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_UPDATE_SUPPORTED_CODEC_CFM               ((CsrBtHfPrim) (0x003B + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))

#define CSR_BT_HF_PRIM_UPSTREAM_HIGHEST                                (0x003B + CSR_BT_HF_PRIM_UPSTREAM_LOWEST)
...
typedef struct
{
    ...
    CsrBtHfConnectionId         connectionId;                   /* Connection indentifier */
    CsrUint8                    value;
} CsrBtHfSetC2cAudioCodecInd;

typedef struct
{
    CsrBtHfPrim                 type;                           /* Primitive/message identity */
} CsrBtHfGetC2cAdpcmLocalSupportedReq;

typedef struct
{
    CsrBtHfPrim                 type;                           /* Primitive/message identity */
    CsrBool                     result;
} CsrBtHfGetC2cAdpcmLocalSupportedInd;
...
typedef struct
{
    CsrBtHfPrim                 type;                           /* Primitive/message identity */
    CsrBtHfConnectionId         connectionId;                   /* Connection indentifier */
    CsrUint8                    index;                          /* index of the SMS to retrieve */
} CsrBtHfC2cGetSmsReq;
...
typedef struct
{
    CsrBtHfPrim                 type;                           /* Primitive/message identity */
    CsrBtHfConnectionId         connectionId;                   /* Connection indentifier */
    CsrCharString                   *txtString;                     /* Text received from the remote device */
} CsrBtHfC2cTxtInd;
