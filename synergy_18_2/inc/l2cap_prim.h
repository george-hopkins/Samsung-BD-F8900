...
#define L2CA_FLUSH_TO_MAX_HCI_LIMIT_MS   ((CsrUint16)((((CsrUint32)HCI_MAX_FLUSH_TIMEOUT)*625)/1000))
/*! \} */
...
/*! \name L2CAP support modes bitmask for the mode_mask in L2CA_REGISTER_REQ
  \{ */
#define L2CA_MODE_MASK(mode)             ((CsrUint16)(1<<(mode)))
...
/*! \name Registration flags
  ...
  \{ */
#define L2CA_REGFLAG_ALLOW_RX_UCD       ((CsrUint16)0x0001) /*!< Allow Unicast Connectionless Data Reception */
#define L2CA_REGFLAG_ALLOW_RX_BCD       ((CsrUint16)0x0002) /*!< Allow Broadcast Connectionless Data Reception */
/*! \} */

/*! \name Connection Parameter Update command limits.
  \{ */
#define L2CA_CON_INTERVAL_MIN           ((CsrUint16)6)
#define L2CA_CON_INTERVAL_MAX           ((CsrUint16)3200)
#define L2CA_CON_SLAVE_LATENCY_MAX      ((CsrUint16)499)
#define L2CA_CON_TIMEOUT_MIN            ((CsrUint16)10)
#define L2CA_CON_TIMEOUT_MAX            ((CsrUint16)3200)
/*! \} */
...
/*! \name Auto connect configuration options
  ...
  Note 1 - QOS_SERVICE: This CsrUint16 is encoded as two CsrUint8s's:
  ...
  Note 3 - FLOW_MODE: This CsrUint16 is encoded as two CsrUint8's. The
  ...
  \{ */
#define L2CA_AUTOPT_MTU_IN               ((CsrUint16)0x0001) /* 16 bit, exact - incoming MTU */
#define L2CA_AUTOPT_MTU_OUT              ((CsrUint16)0x0102) /* 16 bit, minimum - peer MTU */
#define L2CA_AUTOPT_FLUSH_IN             ((CsrUint16)0x0703) /* 32 bit, range - peer flush (us)  - note that HCI limit still applies */
#define L2CA_AUTOPT_FLUSH_OUT            ((CsrUint16)0x0704) /* 32 bit, range - local flush (us) - note that HCI limit still applies */
#define L2CA_AUTOPT_QOS_SERVICE          ((CsrUint16)0x0005) /* 16 bit, exact - shared service type (note1) */
#define L2CA_AUTOPT_QOS_RATE_IN          ((CsrUint16)0x0706) /* 32 bit, range - incoming token rate/flowspec interarrival */
#define L2CA_AUTOPT_QOS_RATE_OUT         ((CsrUint16)0x0707) /* 32 bit, range - outgoing token rate/flowspec interarrival */
#define L2CA_AUTOPT_QOS_BUCKET_IN        ((CsrUint16)0x0708) /* 32 bit, range - incoming token bucket */
#define L2CA_AUTOPT_QOS_BUCKET_OUT       ((CsrUint16)0x0709) /* 32 bit, range - outgoing token bucket */
#define L2CA_AUTOPT_QOS_PEAK_IN          ((CsrUint16)0x070a) /* 32 bit, range - incoming peak bandwidth */
#define L2CA_AUTOPT_QOS_PEAK_OUT         ((CsrUint16)0x070b) /* 32 bit, range - outgoing peak bandwidth */
#define L2CA_AUTOPT_QOS_LATENCY_IN       ((CsrUint16)0x070c) /* 32 bit, range - incoming qos/flowspec access latency */
#define L2CA_AUTOPT_QOS_LATENCY_OUT      ((CsrUint16)0x070d) /* 32 bit, range - outgoing qos/flowspec access latency */
#define L2CA_AUTOPT_QOS_DELAY_IN         ((CsrUint16)0x070e) /* 32 bit, range - incoming delay variation */
#define L2CA_AUTOPT_QOS_DELAY_OUT        ((CsrUint16)0x070f) /* 32 bit, range - outgoing delay variation */
#define L2CA_AUTOPT_FS_SDU_SIZE_IN       ((CsrUint16)0x0310) /* 16 bit, range - incoming max SDU size */
#define L2CA_AUTOPT_FS_SDU_SIZE_OUT      ((CsrUint16)0x0311) /* 16 bit, range - incoming max SDU size */
#define L2CA_AUTOPT_FLOW_MODE            ((CsrUint16)0x0012) /* 16 bit, exact - shared flow control mode (note3) */
#define L2CA_AUTOPT_FLOW_WINDOW_IN       ((CsrUint16)0x0313) /* 16 bit, range - incoming window size */
#define L2CA_AUTOPT_FLOW_WINDOW_OUT      ((CsrUint16)0x0314) /* 16 bit, range - peer window size */
#define L2CA_AUTOPT_FLOW_MAX_RETX_IN     ((CsrUint16)0x0315) /* 16 bit, range - peer maximum retransmit */
#define L2CA_AUTOPT_FLOW_MAX_RETX_OUT    ((CsrUint16)0x0316) /* 16 bit, range - this option is ignored - it's set by the peer */
#define L2CA_AUTOPT_FLOW_MAX_PDU_IN      ((CsrUint16)0x0317) /* 16 bit, range - incoming max PDU payload size */
#define L2CA_AUTOPT_FLOW_MAX_PDU_OUT     ((CsrUint16)0x0318) /* 16 bit, range - outgoing maximum PDU size */
#define L2CA_AUTOPT_FCS                  ((CsrUint16)0x0019) /* 16 bit, exact - use FCS or not (note4) */
#define L2CA_AUTOPT_FS_SERVICE           ((CsrUint16)0x001A) /* 16 bit, exact - shared flowspec service type (note2) */

#define L2CA_AUTOPT_EXT_FEATS            ((CsrUint16)0x0420) /* 32 bit, exact - cached getinfo ext.feats */
#define L2CA_AUTOPT_DISABLE_RECONF       ((CsrUint16)0x0021) /* 16 bit, exact - ward off reconfiguration attempts */
#define L2CA_AUTOPT_SECURITY_PROTOCOL    ((CsrUint16)0x0022) /* 16 bit, exact - reserved for internal use - replacement security protocol ID */
#define L2CA_AUTOPT_SECURITY_CHANNEL     ((CsrUint16)0x0023) /* 16 bit, exact - reserved for internal use - replacement security channel */
#define L2CA_AUTOPT_CHANNEL_PRIORITY     ((CsrUint16)0x0024) /* 16 bit, exact - set channel priority from 0 (highest) to L2CAP_MAX_TX_QUEUES - 1 (lowest) */
/*! \} */
...
typedef CsrUint16                        l2cap_prim_t;           /*!< Primitive identity */

typedef CsrUint16                        l2ca_conflags_t;        /*!< Special connection flags */

/*! \name Result/response code types
  \{ */
typedef CsrUint16                        l2ca_leup_result_t;     /*!< Low energy connection parameter update */
/*! \} */

typedef CsrUint16                        l2ca_raw_t;             /*!< Raw debug mode */
typedef CsrUint8                         l2ca_raw_packet_t;      /*!< Packet type - L2CA_RX/L2CA_TX_START/L2CA_TX_CONT */

/*! \name L2CAP option typedefs
  \{ */
typedef CsrUint16                        l2ca_options_t;         /*!< L2CAP options bitmask */
typedef CsrUint8                         l2ca_qos_flags_t;       /*!< QoS flags */
typedef CsrUint8                         l2ca_service_type_t;    /*!< QoS service type */
typedef CsrUint32                        l2ca_token_rate_t;      /*!< QoS token rate */
typedef CsrUint32                        l2ca_token_bucket_t;    /*!< QoS token bucket size */
typedef CsrUint32                        l2ca_variation_t;       /*!< QoS variation */
typedef CsrUint8                         l2ca_flow_mode_t;       /*!< F&EC mode */
typedef CsrUint8                         l2ca_max_retransmit_t;  /*!< F&EC max transmit counter */
typedef CsrUint16                        l2ca_mtu_t;             /*!< Maximum transmission unit */
typedef CsrUint16                        l2ca_timeout_t;         /*!< Flush timeout */
typedef CsrUint8                         l2ca_fcs_t;             /*!< F&EC optional frame check sequence */
typedef CsrUint8                         l2ca_window_size_t;     /*!< F&EC window size */
typedef CsrUint16                        l2ca_ext_window_size_t; /*!< Extended window size */
/*! \} */
...
typedef struct
{
    ...
    CsrUint8                unknown_length;    /*!< Total octet length of unknown options */
    CsrUint8               *unknown;           /*!< Pointer to unknown options */
    l2ca_mtu_t             mtu;               /*!< MTU */
...
typedef struct
{
    ...
    CsrSchedQid           phandle;        /*!< phandle for the response */
    TYPED_BD_ADDR_T     addrt;          /*!< Bluetooth device address of remote device */
    CsrUint16            min_interval;   /*!< Minimum allowed connection interval */
    CsrUint16            max_interval;   /*!< Maximum allowed connection interval */
    CsrUint16            latency;        /*!< connection slave latency */
    CsrUint16            timeout;        /*!< supervision timeout */
...
/*! \brief L2CAP accept connection update primitves exchanged between DM and L2CAP
    ...
    \msc
        ...
        L2CAP->DM                           [ label = "L2CA_CONNECTION_PAR_UPDATE_IND", URL = "\ref L2CA_CONNECTION_PAR_UPDATE_IND_T" ];
        DM->L2CAP                           [ label = "L2CA_CONNECTION_PAR_UPDATE_RSP", URL = "\ref L2CA_CONNECTION_PAR_UPDATE_RSP_T" ];
    \endmsc
...
typedef struct
{
    ...
    CsrUint16 conn_interval_min;     /*!< Minimum allowed connection interval */
    CsrUint16 conn_interval_max;     /*!< Maximum allowed connection interval */
    CsrUint16 conn_latency;          /*!< connection slave latency */
    CsrUint16 supervision_timeout;   /*!< link timeout value */
...
typedef struct
{
    ...
    CsrSchedQid phandle;              /*!< destination handle */
    ...
    CsrUint16 result;                /*!< L2CAP_CONNECTION_PARAMETER_UPDATE_ACCEPT - if parameters are acceptable,
...
typedef struct
{
    ...
    CsrSchedQid           phandle;          /*!< Protocol handle of the higher layer entity registering with L2CAP, for example RFCOMMs */
...
typedef struct
{
    ...
    CsrSchedQid           phandle;          /*!< Protocol handle of the higher layer entity as specified in request */
    psm_t               psm_local;        /*!< PSM as specified in request */
    CsrUint16            reg_ctx;          /*!< Registration context as specified in request */
    CsrUint16            mode_mask;        /*!< Mask of which L2CAP modes are acceptable */
    CsrUint16            flags;            /*!< Flags as specified in request */
...
typedef struct
{
    ...
    CsrSchedQid           phandle;          /*!< Send result to this phandle */
...
typedef struct
{
    ...
    CsrSchedQid           phandle;          /*!< Target application handle */
...
typedef struct
{
    ...
    CsrSchedQid           phandle;          /*!< Protocol handle of higher layer entity registering with L2CAP, for example AMP Manager */
    l2ca_cid_t          fixed_cid;        /*!< Channel ID of fixed channel */
    CsrUint16            reg_ctx;          /*!< Reserved - ignored by L2CAP */
...
typedef struct
{
    ...
    CsrSchedQid           phandle;          /*!< Protocol handle of higher layer entity as specified in request */
    l2ca_cid_t          fixed_cid;        /*!< Channel ID of fixed channel as specified in request */
    CsrUint16            reg_ctx;          /*!< Reserved - should be ignored */
    l2ca_misc_result_t  result;           /*!< Return code - uses L2CA_MISC range */
...
/*! \brief Automatic connection request
    ...
    otherwise the pointer must point to an array of CsrUint16's, and the length
    specified in conftab_length must be set to the number of CsrUint16's in the conftab.
...
typedef struct
{
    ...
    CsrUint16            conftab_length;   /*!< Number of CsrUint16's in the 'conftab' table */
    CsrUint16           *conftab;          /*!< Configuration table (key,value pairs) */
...
typedef struct
{
    ...
    l2ca_cid_t          cid;              /*!< Channel identifier */
    CsrUint16            reg_ctx;          /*!< Registration context */
    CsrUint16            con_ctx;          /*!< Opaque context number from connect */
    BD_ADDR_T           bd_addr;          /*!< Bluetooth address of remote device */
    ...
    CsrUint32            ext_feats;        /*!< Peer extended features */
...
typedef struct
{
    ...
    CsrUint16            reg_ctx;          /*!< Opaque context number from registration. Only valid for fixed_cid == 2 */
    TYPED_BD_ADDR_T     addrt;            /*!< Bluetooth address of remote device */
    l2ca_cid_t          fixed_cid;        /*!< Fixed channel CID */
    psm_t               cl_local_psm;     /*!< Connectionless PSM (only for fixed_cid == 2) */
...
typedef struct
{
    ...
    l2ca_cid_t          fixed_cid;        /*!< Fixed channel CID */
    psm_t               cl_local_psm;     /*!< Connectionless PSM (only for fixed_cid == 2) */
    CsrUint16            con_ctx;          /*!< Opaque context number from map request */
...
typedef struct
{
    ...
    CsrUint16            reg_ctx;          /*!< Opaque context number from registration. Only valid for connectionless channel (fixed_cid == 2) */
    CsrUint16            con_ctx;          /*!< Opaque context number from map */
...
typedef struct
{
    ...
    CsrSchedQid           phandle;          /*!< Destination phandle */
    l2ca_cid_t          cid;              /*!< CID of channel to move */
    CsrUint16            reg_ctx;          /*!< Opaque context number from registration */
    CsrUint16            con_ctx;          /*!< Opaque context number from connect/create channel */
...
typedef struct
{
    ...
    CsrUint16            reg_ctx;          /*!< Opaque context number from registration */
    CsrUint16            con_ctx;          /*!< Opaque context number from connection */
...
typedef struct
{
    ...
    l2ca_cid_t          cid;              /*!< Local channel ID */
    CsrUint16            req_ctx;          /*!< User context to be returned in L2CA_DATAWRITE_CFM */
    CsrUint16            length;           /*!< Length of data (must be 0 to indicate MBLK) */
    CsrMblk             *data;             /*!< Pointer to data/MBLK */
    CsrUint16            packets_ack;      /*!< Used to acknowledge L2CAP PDUs in earlier DATAREAD_INDs */
...
typedef struct
{
    ...
    CsrSchedQid           phandle;          /*!< Destination phandle */
    l2ca_cid_t          cid;              /*!< Local channel ID */
    CsrUint16            reg_ctx;          /*!< Opaque context number from registration. Not valid for fixed channels where fixed_cid != 2 */
    CsrUint16            con_ctx;          /*!< Opaque context number from connect */
    CsrUint16            req_ctx;          /*!< User context specified in L2CA_DATAWRITE_REQ */
    CsrUint16            length;           /*!< Length of data sent */
...
typedef struct
{
    ...
    l2ca_cid_t          cid;              /*!< Local channel ID */
    CsrBool              busy;             /*!< New status of busy (RNR) flag */
} L2CA_BUSY_REQ_T;
...
typedef struct
{
    ...
    CsrSchedQid           phandle;          /*!< Destination phandle */
    l2ca_cid_t          cid;              /*!< Local channel ID */
    CsrUint16            reg_ctx;          /*!< Opaque context number from registration. Not valid for fixed channels, except for connectionless channel */
    CsrUint16            con_ctx;          /*!< Opaque context number from connect */
    CsrUint16            length;           /*!< Length of data (must be 0 to indicate MBLK) */
    CsrMblk             *data;             /*!< Pointer to data/MBLK */
    l2ca_data_result_t  result;           /*!< Result code - uses L2CA_DATA range */
    CsrUint16            packets;          /*!< The number of L2CAP PDUs (data segments) that are attached or have been lost (depending on result). */
} L2CA_DATAREAD_IND_T;
...
typedef struct
{
    ...
    l2ca_cid_t          cid;              /*!< Local channel ID */
    CsrUint16            packets;          /*!< The number of L2CAP PDUs (data segments) that are being acknowledged */
} L2CA_DATAREAD_RSP_T;
...
typedef struct
{
    ...
    CsrSchedQid           phandle;          /*!< Handle to receive ACL data */
} L2CA_RAW_MODE_REQ_T;
...
typedef struct
{
    ...
    l2ca_cid_t          cid;              /*!< Local channel ID */
    CsrUint16            raw_length;       /*!< Length in header, 0 to automatically fill in */
    l2ca_timeout_t      flush_to;         /*!< Flush timeout for this packet */
    CsrUint16            length;           /*!< Length of data, 0 for MBLKs */
    CsrMblk             *data;             /*!< Pointer to data/MBLK */
} L2CA_RAW_DATA_REQ_T;
...
typedef struct
{
    ...
    CsrMblk             *data;             /*!< Pointer to data/MBLK, without length,cid */
} L2CA_RAW_DATA_IND_T;
...
typedef struct
{
    ...
    l2ca_cid_t          cid;              /*!< Local channel ID */
    CsrUint16            rx_interval;      /*!< Interval to drop incoming data */
    CsrUint16            rx_number;        /*!< Number of incoming packets to drop */
    CsrUint16            tx_interval;      /*!< Interval to drop outgoing data */
    CsrUint16            tx_number;        /*!< Number of outgoing packets to drop */
...
typedef struct
{
    ...
    CsrSchedQid           phandle;          /*!< phandle for requesting protocol */
    BD_ADDR_T           bd_addr;          /*!< Bluetooth device address */
    CsrUint16            length;           /*!< number of bytes pointed to by data */
    CsrUint8            *data;             /*!< data to be transmitted (and returned in PING_CFM command) */
    CsrUint16            req_ctx;          /*!< User context to be returned in L2CA_PING_CFM */
...
typedef struct
{
    ...
    BD_ADDR_T           bd_addr;          /*!< Bluetooth device address */
    CsrUint16            length;           /*!< Number of bytes pointed to by data */
    CsrUint8            *data;             /*!< Returned data (should match the PING_REQ data */
    l2ca_misc_result_t  result;           /*!< Result code - uses L2CA_MISC range */
    CsrUint16            req_ctx;          /*!< Returned req_ctx from the request signal*/
    l2ca_conflags_t     flags;            /*!< Reserved */
} L2CA_PING_CFM_T;
...
typedef struct
{
    ...
    CsrSchedQid           phandle;          /*!< phandle for requesting protocol */
    BD_ADDR_T           bd_addr;          /*!< Bluetooth device address */
    CsrUint16            info_type;        /*!< Type of information requested */
    CsrUint16            req_ctx;          /*!< User context to be returned in L2CA_GETINFO_CFM */
    l2ca_conflags_t     flags;            /*!< Reserved */
} L2CA_GETINFO_REQ_T;
...
typedef struct
{
    ...
    CsrSchedQid           phandle;          /*!< Destination phandle */
    BD_ADDR_T           bd_addr;          /*!< Bluetooth device address */
    CsrUint16            info_type;        /*!< Type of information */
    CsrUint16            length;           /*!< length of data in info_data */
    CsrUint8            *info_data;        /*!< Data payload - little endian format (as in spec) */
...
typedef struct
{
    ...
    CsrSchedQid           phandle;          /*!< Task/queue handle to send data primtives to */
...
typedef struct
{
    ...
    CsrSchedQid           phandle;          /*!< Requesting application */
...
typedef struct
{
    ...
    CsrUint16            conn_handle;      /*!< HCI connection handle */
