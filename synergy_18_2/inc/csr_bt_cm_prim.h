...
#define CSR_BT_PARK_MODE                 (0x0003)
#endif
...
#define CSR_BT_CM_NUM_OF_CM_EVENTS                                  (0x00000011)
#define CSR_BT_CM_EVENT_MASK_RESERVER_VALUES_MASK                   (0x0000FFFF)
...
#define CSR_BT_CM_LE_ADVTYPE_CONNECTABLE_DIRECTED   (HCI_ULP_ADVERT_CONNECTABLE_DIRECTED)
...
#define CSR_BT_CM_LE_MODE_IGNORE       (0x40) /* internal, do not use */
...
#define CSR_BT_CM_LE_PARCHG_PAR        (0x01) /* change HCI parameters */
...
#define CSR_BT_CM_HCI_LE_ADV_INTERVAL_MIN (0x0020)
#define CSR_BT_CM_HCI_LE_ADV_INTERVAL_MAX (0x4000)
...
#define CSR_BT_CM_DM_PRIM_DOWNSTREAM_HIGHEST                                 (0x0048 + CSR_BT_CM_DM_PRIM_DOWNSTREAM_LOWEST)
...
#define CSR_BT_CM_SM_PRIM_DOWNSTREAM_HIGHEST                                 (0x0023 + CSR_BT_CM_SM_PRIM_DOWNSTREAM_LOWEST)
...
#define CSR_BT_CM_LE_PHYSICAL_LINK_STATUS_REQ                 ((CsrBtCmPrim) (0x003D + CSR_BT_CM_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_CM_LE_RECEIVER_TEST_REQ                        ((CsrBtCmPrim) (0x003E + CSR_BT_CM_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_CM_LE_TRANSMITTER_TEST_REQ                     ((CsrBtCmPrim) (0x003F + CSR_BT_CM_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_CM_LE_TEST_END_REQ                             ((CsrBtCmPrim) (0x0040 + CSR_BT_CM_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_CM_MAP_SCO_PCM_RES                             ((CsrBtCmPrim) (0x0041 + CSR_BT_CM_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_CM_L2CA_GET_CHANNEL_INFO_REQ                   ((CsrBtCmPrim) (0x0042 + CSR_BT_CM_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_CM_SM_HOUSE_CLEANING                           ((CsrBtCmPrim) (0x0043 + CSR_BT_CM_PRIM_DOWNSTREAM_LOWEST)) /* must be last */
#define CSR_BT_CM_DM_HOUSE_CLEANING                           ((CsrBtCmPrim) (0x0044 + CSR_BT_CM_PRIM_DOWNSTREAM_LOWEST)) /* must be last */
#define CSR_BT_CM_PRIM_DOWNSTREAM_HIGHEST                                    (0x0044 + CSR_BT_CM_PRIM_DOWNSTREAM_LOWEST)
...
#define CSR_BT_CM_L2CA_PRIM_UPSTREAM_HIGHEST                                 (0x000C + CSR_BT_CM_L2CA_PRIM_UPSTREAM_LOWEST)
...
#define CSR_BT_CM_BNEP_PRIM_UPSTREAM_HIGHEST                                 (0x0006 + CSR_BT_CM_BNEP_PRIM_UPSTREAM_LOWEST)
...
#define CSR_BT_CM_BLE_CONNECTION_IND                          ((CsrBtCmPrim) (0x0036 + CSR_BT_CM_SEND_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_CM_GET_SECURITY_CONF_IND                       ((CsrBtCmPrim) (0x0037 + CSR_BT_CM_SEND_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_CM_ENCRYPT_CHANGE_IND                          ((CsrBtCmPrim) (0x0038 + CSR_BT_CM_SEND_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_CM_ALWAYS_MASTER_DEVICES_CFM                   ((CsrBtCmPrim) (0x0039 + CSR_BT_CM_SEND_PRIM_UPSTREAM_LOWEST))  
#define CSR_BT_CM_DATA_BUFFER_EMPTY_CFM                       ((CsrBtCmPrim) (0x003A + CSR_BT_CM_SEND_PRIM_UPSTREAM_LOWEST))  
#define CSR_BT_CM_DISABLE_DUT_MODE_CFM                        ((CsrBtCmPrim) (0x003B + CSR_BT_CM_SEND_PRIM_UPSTREAM_LOWEST))  
#define CSR_BT_CM_LE_SCAN_CFM                                 ((CsrBtCmPrim) (0x003C + CSR_BT_CM_SEND_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_CM_LE_ADVERTISE_CFM                            ((CsrBtCmPrim) (0x003D + CSR_BT_CM_SEND_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_CM_LE_REPORT_IND                               ((CsrBtCmPrim) (0x003E + CSR_BT_CM_SEND_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_CM_LOCAL_NAME_CHANGE_IND                       ((CsrBtCmPrim) (0x003F + CSR_BT_CM_SEND_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_CM_LE_EVENT_ADVERTISING_IND                    ((CsrBtCmPrim) (0x0040 + CSR_BT_CM_SEND_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_CM_LE_EVENT_SCAN_IND                           ((CsrBtCmPrim) (0x0041 + CSR_BT_CM_SEND_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_CM_LE_EVENT_CONNECTION_IND                     ((CsrBtCmPrim) (0x0042 + CSR_BT_CM_SEND_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_CM_EIR_FLAGS_CFM                               ((CsrBtCmPrim) (0x0043 + CSR_BT_CM_SEND_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_CM_LE_WHITELIST_SET_CFM                        ((CsrBtCmPrim) (0x0044 + CSR_BT_CM_SEND_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_CM_LE_CONNPARAM_CFM                            ((CsrBtCmPrim) (0x0045 + CSR_BT_CM_SEND_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_CM_LE_CONNPARAM_UPDATE_CMP_IND                 ((CsrBtCmPrim) (0x0046 + CSR_BT_CM_SEND_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_CM_READ_ENCRYPTION_KEY_SIZE_CFM                ((CsrBtCmPrim) (0x0047 + CSR_BT_CM_SEND_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_CM_READ_ADVERTISING_CH_TX_POWER_CFM            ((CsrBtCmPrim) (0x0048 + CSR_BT_CM_SEND_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_CM_LE_RECEIVER_TEST_CFM                        ((CsrBtCmPrim) (0x0049 + CSR_BT_CM_SEND_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_CM_LE_TRANSMITTER_TEST_CFM                     ((CsrBtCmPrim) (0x004a + CSR_BT_CM_SEND_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_CM_LE_TEST_END_CFM                             ((CsrBtCmPrim) (0x004b + CSR_BT_CM_SEND_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_CM_LE_ACCEPT_CONNPARAM_UPDATE_IND              ((CsrBtCmPrim) (0x004c + CSR_BT_CM_SEND_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_CM_HIGH_PRIORITY_DATA_IND                      ((CsrBtCmPrim) (0x004d + CSR_BT_CM_SEND_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_CM_SEND_PRIM_UPSTREAM_HIGHEST                                 (0x004d + CSR_BT_CM_SEND_PRIM_UPSTREAM_LOWEST)
...
typedef struct
{
    ...
    CsrSchedQid             appHandle;
    CsrUint8                operation; /* Use CSR_BT_CM_LE_WHITELIST_ */
...
/* This primitive is deprecated. For Low Energy COEX events, see the
 * CsrBtCmLeEvent...Ind primitives */
typedef struct
{
    CsrBtCmPrim                   type;
    CsrBtDeviceAddr               deviceAddr;
...
typedef struct
{
    ...
    CsrUint16                     connAttemptTimeout;      /* Equivalent of Page Timeout in BR/EDR */
    CsrUint16                     advIntervalMin;          /* Used when setting parameters for */
    CsrUint16                     advIntervalMax;          /* undirected connect-as-slave advertising*/
