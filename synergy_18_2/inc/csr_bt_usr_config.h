 ...
 *   - i.e. if sniff and/or park are supported or not
 ...
 *   ENABLE_PARK.            Enable local support of park mode.
 ...
 *--------------------------------------------------------------------------*/
#define CSR_BT_LE_DEFAULT_ADV_INTERVAL_MIN             (0x00A0) /* default from spec (vol2, sec 7.8, p813) */
#define CSR_BT_LE_DEFAULT_ADV_INTERVAL_MAX             (0x4000) /* default from spec (vol2, sec 7.8, p813) */

#define CSR_BT_LE_DEFAULT_SCAN_INTERVAL                (0x1004) /* good general purpose value */
#define CSR_BT_LE_DEFAULT_SCAN_WINDOW                  (0x1000) /* good general purpose value */

#define CSR_BT_LE_DEFAULT_CONN_INTERVAL_MIN            (0x000a) /* good general purpose value */
#define CSR_BT_LE_DEFAULT_CONN_INTERVAL_MAX            (0x000a) /* good general purpose value */
#define CSR_BT_LE_DEFAULT_CONN_LATENCY                 (0x0020) /* good general purpose value */
#define CSR_BT_LE_DEFAULT_CONN_LATENCY_MAX             (0x01f2) /* spec maximum, rounded */
#define CSR_BT_LE_DEFAULT_CONN_SUPERVISION_TIMEOUT     (0x0800) /* good general purpose value */
#define CSR_BT_LE_DEFAULT_CONN_SUPERVISION_TIMEOUT_MIN (0x000a) /* spec minimum */
#define CSR_BT_LE_DEFAULT_CONN_SUPERVISION_TIMEOUT_MAX (0x0c80) /* spec maximum */
#define CSR_BT_LE_DEFAULT_CONN_ATTEMPT_TIMEOUT         (0x0040) /* good general purpose value */

/*--------------------------------------------------------------------------
 * Define for the Appearance Characteristic Value for Low Energy
 *--------------------------------------------------------------------------*/
#ifndef CSR_BT_LE_APPEARANCE_VALUE
#define CSR_BT_LE_APPEARANCE_VALUE               0x0000 
#endif /* CSR_BT_LE_APPEARANCE_VALUE */

/*--------------------------------------------------------------------------
    Defines the default policy settings used for sniff and park.
----------------------------------------------------------------------------*/
...
/* Define the maximum acceptable number of baseband slots between
   consecutive beacons in park mode

   Range: 0x000E to 0xFFFE; only even values are valid
   Mandatory Range: 0x000E to 0x1000
   Time = N * 0.625 msec
   Time Range: 8.75 msec to 40.9 sec                                */
#ifndef CSR_BT_PARK_MAX_TIME_INTERVAL
#define CSR_BT_PARK_MAX_TIME_INTERVAL                           0x0190
#endif
...
/* Define the minimum acceptable number of baseband slots between
   ...
   Note that CSR_BT_PARK_MIN_TIME_INTERVAL must not be greater
   than CSR_BT_PARK_MAX_TIME_INTERVAL                               */
#ifndef CSR_BT_PARK_MIN_TIME_INTERVAL
#define CSR_BT_PARK_MIN_TIME_INTERVAL                           0x0150
#endif
 ...
 * Note: Bluetooth Low Energy requires version 4.0 */
#ifndef CSR_BT_BT_VERSION
#define CSR_BT_BT_VERSION                         (CSR_BT_BLUETOOTH_VERSION_3P0)
...
#define CSR_BT_MAJOR_MINOR_DEVICE_CLASS               0x240404 /* (CSR_BT_AV_MAJOR_DEVICE_MASK + CSR_BT_WEARABLE_HEADSET_AV_MINOR_DEVICE_CLASS) */	
...
#define CSR_BT_PAGE_SCAN_INTERVAL_DEFAULT                              (0xA0)      //(0x800)
...
#define CSR_BT_PAGE_SCAN_WINDOW_DEFAULT                                (0x11)   //(0x12)
...
#define CSR_BT_PAGE_TIMEOUT_DEFAULT                                    (16000)
...
#define CSR_BT_PAGE_SCAN_TYPE_DEFAULT                                  (HCI_SCAN_TYPE_INTERLACED)       //(HCI_SCAN_TYPE_LEGACY)
#endif /* CSR_BT_PAGE_SCAN_TYPE_DEFAULT */

#ifndef CSR_BT_INQUIRY_SCAN_TYPE_DEFAULT
#define CSR_BT_INQUIRY_SCAN_TYPE_DEFAULT                               (HCI_SCAN_TYPE_INTERLACED)       //(HCI_SCAN_TYPE_LEGACY)
...
#define CSR_BT_MAX_NUM_SCO_CONNS                                       (2)
#endif
...
#define CSR_BT_ESCO_DEFAULT_CONNECT_MAX_LATENCY                        (0x000A)
...
#define CSR_BT_ESCO_DEFAULT_CONNECT_RE_TX_EFFORT                       (HCI_ESCO_POWER_SAVING_RETX)
...
/* DSP setup for HFP 1.6 - WB/NB audio */
#ifndef CSR_BT_HFP_DEFAULT_AUDIO_ROUTE
#define CSR_BT_HFP_DEFAULT_AUDIO_CONNECTION_POINT           (3) /* CODEC */
#endif
/*----------------------------------------------------------------------------
 * Defines for JSR82
 *----------------------------------------------------------------------------*/
...
#define CSR_BT_DEFAULT_LINK_SUPERVISION_TIMEOUT                        (16000)
...
#define CSR_BT_AV_MAX_NUM_CONNECTIONS      1
...
#define CSR_BT_AV_MAX_NUM_STREAMS          1
...
#define CSR_BT_AV_QOS_LATENCY             (0x00002EE0)
#endif
...
#define CSR_BT_DEFAULT_IO_CAPABILITY                                   (HCI_IO_CAP_NO_INPUT_NO_OUTPUT)
...
#define CSR_BT_SC_AUTH_REQ_DEFAULT                                     (DM_SM_SECURITY_ENCRYPTION \
