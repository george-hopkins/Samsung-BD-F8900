...
#include "csr_wifi_pal_data_task.h"
#include "csr_wifi_pal_data_prim.h"
#else
#endif
...
/* Synergy Wifi (for AMP/COEX) */
extern CsrSchedQid CSR_WIFI_SME_IFACEQUEUE;
extern CsrSchedQid CSR_WIFI_ROUTER_IFACEQUEUE;
extern CsrSchedQid CSR_CRYPTO_IFACEQUEUE;
extern CsrSchedQid CSR_WIFI_PAL_DATA_IFACEQUEUE;
...
extern void CsrBtAppTaskInitWifi(void *data);
