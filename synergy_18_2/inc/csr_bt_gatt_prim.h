...
typedef CsrUint8        CsrBtGattAdvChannel;
...
#define CSR_BT_GATT_LOCAL_BT_CONN_ID                            ((CsrBtConnId)(CSR_BT_CONN_ID_LE_TECH_MASK | ATT_CID_LOCAL))
...
#define CSR_BT_GATT_FLAGS_WHITELIST                             ((CsrBtGattConnFlags)0x00000001) /* connect to whitelist (central/peripheral) */
#define CSR_BT_GATT_FLAGS_UNDIRECTED                            ((CsrBtGattConnFlags)0x00000002) /* use undirected connection (peripheral) */
...
#define CSR_BT_GATT_FLAGS_EXCLUSIVE                             ((CsrBtGattConnFlags)0x80000000) /* for internal use only */
...
/* LE security flags. Note bonding is control by SC though the value of keyDistribution */
#define CSR_BT_GATT_SECURITY_FLAGS_DEFAULT           ((CsrBtGattSecurityFlags) CSR_BT_SC_LE_AUTH_IGNORE) /* Default low energy authentication requirement  */
#define CSR_BT_GATT_SECURITY_FLAGS_UNAUTHENTICATED   ((CsrBtGattSecurityFlags) DM_SM_SECURITY_UNAUTHENTICATED_NO_BONDING) /* Encrypt the link */
#define CSR_BT_GATT_SECURITY_FLAGS_AUTHENTICATED     ((CsrBtGattSecurityFlags) DM_SM_SECURITY_AUTHENTICATED_NO_BONDING) /* Encrypt the link with MITM protection */
...
#define CSR_BT_GATT_RESULT_INVALID_ATTRIBUTE_VALUE_RECEIVED     ((CsrBtResultCode)0x000B) /* An invalied attribute value is received */
...
/* Encrypted link required for read access. I.e. a CSR_BT_GATT_DB_ACCESS_READ_IND it sent to the application */
#define CSR_BT_GATT_ATTR_FLAGS_READ_ENCRYPTION                  ((CsrBtGattAttrFlags) ATT_ATTR_SEC_R_ENUM(ATT_ATTR_SEC_ENCRYPTION))
/* Authenticated (MITM) link required for read access. I.e. a CSR_BT_GATT_DB_ACCESS_READ_IND it sent to the application */
#define CSR_BT_GATT_ATTR_FLAGS_READ_AUTHENTICATION              ((CsrBtGattAttrFlags) ATT_ATTR_SEC_R_ENUM(ATT_ATTR_SEC_AUTHENTICATION))
/* Encrypted link required for write access. I.e. a CSR_BT_GATT_DB_ACCESS_WRITE_IND it sent to the application */
#define CSR_BT_GATT_ATTR_FLAGS_WRITE_ENCRYPTION                 ((CsrBtGattAttrFlags) ATT_ATTR_SEC_W_ENUM(ATT_ATTR_SEC_ENCRYPTION))
/* Authenticated (MITM) link required for write access. I.e. a CSR_BT_GATT_DB_ACCESS_WRITE_IND it sent to the application */
...
#define CSR_BT_GATT_EVENT_MASK_SUBSCRIBE_WHITELIST_CHANGE       ((CsrBtGattEventMask) 0x00000002) /* Whitelist changes */
...
/* Advertising channel maps */
#define CSR_BT_GATT_ADV_CHANNEL_37                              ((CsrBtGattAdvChannel)HCI_ULP_ADVERT_CHANNEL_37)
#define CSR_BT_GATT_ADV_CHANNEL_38                              ((CsrBtGattAdvChannel)HCI_ULP_ADVERT_CHANNEL_38)
#define CSR_BT_GATT_ADV_CHANNEL_39                              ((CsrBtGattAdvChannel)HCI_ULP_ADVERT_CHANNEL_39)
#define CSR_BT_GATT_ADV_CHANNEL_ALL                             ((CsrBtGattAdvChannel)HCI_ULP_ADVERT_CHANNEL_ALL)
...
#define CSR_BT_GATT_PRIM_UPSTREAM_HIGHEST                               (0x0037 + CSR_BT_GATT_PRIM_UPSTREAM_LOWEST)
...
typedef struct
{
    ...
    CsrBtGattHandle     endGroupHandle;         /* End Group handle of of the specified characteristic */
...
typedef struct
{
    ...
    CsrBtConnId         btConnId;           /* Connection identifier */
    CsrUint16           handlesCount;       /* Num of attribute Handles */
    CsrBtGattHandle     *handles;           /* A set of two or more attribute handles */
...
typedef CsrBtGattStdBtConnIdCfm CsrBtGattReadByUuidCfm;
...
typedef CsrBtGattStdBtConnIdCfm CsrBtGattWriteCfm;
