...
#define ParkSettingsEq(set1, set2) ((CsrBool) (CsrMemCmp(set1, set2, sizeof(CsrBtParkSettings)) ? FALSE : TRUE))
...
#define CsrBtCmRfcAmpForceModeChangeReqSend(_btConnId) {                \
        CsrBtCmRfcModeChangeReq *msg__;                                 \
        msg__=CsrBtCmRfcModeChangeReq_struct(_btConnId,CSR_BT_SNIFF_MODE,TRUE); \
        CsrBtCmPutMessageDownstream(msg__);}
...
#define CsrBtCmDmModeSettingsReqSend(_btConnId,_sniffSettings,_parkSettings,_ssrSettings,_lowPowerPriority) { \
        CsrBtCmDmModeSettingsReq *msg__;                                \
        msg__=CsrBtCmDmModeSettingsReq_struct(_btConnId,_sniffSettings,_parkSettings,_ssrSettings,_lowPowerPriority); \
        CsrBtCmPutMessageDownstream(msg__);}
#else
#define CsrBtCmDmModeSettingsReqSend(_btConnId,_sniffSettings,_parkSettings,_ssrSettings,_lowPowerPriority)
#endif
...
#define CsrBtCmL2caConnectAcceptReqConftabSend(_appHandle,_localPsm,_classOfDevice,_secLevel,_profileUuid,_primaryAcceptor,_context,_conftabCount,_conftab) { \
        CsrBtCmL2caConnectAcceptReq *msg__;                             \
        msg__=CsrBtCmL2caConnectAcceptReqConftab_struct(_appHandle,_localPsm,_classOfDevice,_secLevel,_profileUuid,_primaryAcceptor,_context,_conftabCount,_conftab); \
        CsrBtCmPutMessageDownstream(msg__);}
#endif
/*----------------------------------------------------------------------------*
 *  NAME
...
#define CsrBtCml2caAmpForceModeChangeReqSend(_btConnId) {               \
        CsrBtCmL2caModeChangeReq *msg__;                                \
        msg__=CsrBtCml2caModeChangeReq_struct(_btConnId,CSR_BT_SNIFF_MODE,TRUE); \
        CsrBtCmPutMessageDownstream(msg__);}
...
#define CsrBtCmDmL2caModeSettingsReqSend(_btConnId,_sniffSettings,_parkSettings,_ssrSettings,_lowPowerPriority) { \
        CsrBtCmDmL2caModeSettingsReq *msg__;                            \
        msg__=CsrBtCmDmL2caModeSettingsReq_struct(_btConnId,_sniffSettings,_parkSettings,_ssrSettings,_lowPowerPriority); \
        CsrBtCmPutMessageDownstream(msg__);}
#endif
/*----------------------------------------------------------------------------*
 *  NAME
...
#define CsrBtCmDmBnepModeSettingsReqSend(_id,_sniffSettings,_parkSettings,_ssrSettings,_lowPowerPriority) { \
        CsrBtCmDmBnepModeSettingsReq *msg__;                            \
        msg__=CsrBtCmDmBnepModeSettingsReq_struct(_id,_sniffSettings,_parkSettings,_ssrSettings,_lowPowerPriority); \
        CsrBtCmPutMessageDownstream(msg__);}
#endif
...
#define CsrBtCmLeScanReqSend(_appHandle,_mode,_paramChange,_scanType,_scanInterval,_scanWindow,_scanningFilterPolicy,_filterDuplicates) { \
        CsrBtCmLeScanReq *msg__;                                        \
        msg__=CsrBtCmLeScanReq_struct(_appHandle,_mode,_paramChange,_scanType,_scanInterval,_scanWindow,_scanningFilterPolicy,_filterDuplicates); \
        CsrBtCmPutMessageDownstream(msg__);}

#define CsrBtCmLeScanReqCoexSend(_appHandle,_mode) CsrBtCmLeScanReqSend(_appHandle,_mode,FALSE,0,0,0,0,0)
...
#define CsrBtCmLeAdvertiseReqSend(_appHandle,_mode,_paramChange,_advertisingDataLength,_advertisingData,_scanResponseDataLength,_scanResponseData, \
                                  _advIntervalMin,_advIntervalMax,_advertisingType,_directAddress,_advertisingChannelMap,_advertisingFilterPolicy) { \
        CsrBtCmLeAdvertiseReq *msg__;                                   \
        msg__=CsrBtCmLeAdvertiseReq_struct(_appHandle,_mode,_paramChange,_advertisingDataLength,_advertisingData,_scanResponseDataLength,_scanResponseData, \
                                           _advIntervalMin,_advIntervalMax,_advertisingType,_directAddress,_advertisingChannelMap,_advertisingFilterPolicy); \
        CsrBtCmPutMessageDownstream(msg__);}

#define CsrBtCmLeAdvertiseReqCoexSend(_appHandle,_mode,_advertisingType) { \
        CsrBtTypedAddr addrz__;                                         \
        CsrBtAddrZero(&addrz__);                                        \
        CsrBtCmLeAdvertiseReqSend(_appHandle,_mode,FALSE,0,NULL,0,NULL,0,0,_advertisingType,addrz__,0,0);}
...
#define CsrBtCmLeWhitelistSetReqSend(_appHandle,_operation,_address) {  \
        CsrBtCmLeWhitelistSetReq *msg__;                                \
        msg__=CsrBtCmLeWhitelistSetReq_struct(_appHandle,_operation,_address); \
        CsrBtCmPutMessageDownstream(msg__);}
...
#define CsrBtCmLeConnparamReqSend(_appHandle,_scanInterval,_scanWindow,_connIntervalMin,_connIntervalMax,_connLatency,_supervisionTimeout,_connAttemptTimeout, \
                                  _advIntervalMin,_advIntervalMax,_connLatencyMax,_supervisionTimeoutMin,_supervisionTimeoutMax) { \
        CsrBtCmLeConnparamReq *msg__;                                   \
        msg__=CsrBtCmLeConnparamReq_struct(_appHandle,_scanInterval,_scanWindow,_connIntervalMin,_connIntervalMax,_connLatency,_supervisionTimeout, \
                                           _connAttemptTimeout,_advIntervalMin,_advIntervalMax,_connLatencyMax,_supervisionTimeoutMin,_supervisionTimeoutMax); \
        CsrBtCmPutMessageDownstream(msg__);}
...
CsrSchedMessagePut(CSR_BT_CM_IFACEQUEUE,CSR_BT_CM_PRIM, msg__);}
