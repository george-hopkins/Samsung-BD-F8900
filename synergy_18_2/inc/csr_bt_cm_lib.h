...
#define CsrBtCmReadTxPowerLevelReqSendEx(_phandle,_deviceAddr,_levelType,_addressType) { \
        CsrBtCmReadTxPowerLevelReq *__msg;                              \
        __msg=CsrBtCmReadTxPowerLevelReq_struct(_phandle,_deviceAddr,_levelType,_addressType); \
        CsrBtCmMsgTransport(__msg);}

#define CsrBtCmReadTxPowerLevelReqSend(_phandle,_deviceAddr,_levelType) CsrBtCmReadTxPowerLevelReqSendEx(_phandle, _deviceAddr, _levelType, CSR_BT_ADDR_PUBLIC)
#endif
...
#define CsrBtCmReadRssiReqSendEx(_phandle,_deviceAddr,_addressType) {   \
...
#define CsrBtCmReadRssiReqSend(_phandle,_deviceAddr) CsrBtCmReadRssiReqSendEx(_phandle,_deviceAddr,CSR_BT_ADDR_PUBLIC)
#endif
/*----------------------------------------------------------------------------*
 *  NAME
...
#define CsrBtCmWriteLinkPolicyReqSend(_appHandle, _deviceAddr, _linkPolicySetting, _parkSettings, _setupLinkPolicySetting, _sniffSettings) { \
        ...
        if (_parkSettings)                                              \
        {                                                               \
            __msg->parkSettingsCount = 1;                               \
            __msg->parkSettings = _parkSettings;                        \
        }                                                               \
        if (_sniffSettings)                                             \
        {                                                               \
 ...
 *  PARAMETERS
 *        phandle       : Protocol handle
 *        deviceAddr    : Use to identify the ACL connection which must be put
 *                        in sniff mode
 *----------------------------------------------------------------------------*/
#define CsrBtCmExitSniffModeReqSend(_phandle, _deviceAddr) CsrBtCmSniffModeReqSend(_phandle, _deviceAddr, 0, 0, 0, 0, FALSE)
/*----------------------------------------------------------------------------*
 *  NAME
