...
/* Add loglevel name/literal value (see CSR_LOG_LEVEL_TEXT_XXX defines) */
...
/* Add string provided by the caller of CsrLogTextXXX() */
#define CSR_LOG_CLEARTEXT_TEMPLATE_STRING           "$s$"
/* Add buffer provided by the caller of CsrLogTextXXX() */
