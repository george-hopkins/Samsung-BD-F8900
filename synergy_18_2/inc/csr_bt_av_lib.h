 ...
 *
 *----------------------------------------------------------------------------*/
#define CsrBtAvSetQosIntervalReq(_qosInterval) {                        \
...
#define CsrBtAvGetChannelInfoReqSend(_c) {\
CsrBtAvGetChannelInfoReq *msg; \
msg=CsrBtAvGetChannelInfoReq_struct(_c); \
CsrMsgTransport(CSR_BT_AV_IFACEQUEUE,CSR_BT_AV_PRIM,msg);}
...
CsrBtAvGetStreamChannelInfoReq *msg; \
msg=CsrBtAvGetStreamChannelInfoReq_struct(_sH); \
CsrMsgTransport(CSR_BT_AV_IFACEQUEUE,CSR_BT_AV_PRIM,msg);}
