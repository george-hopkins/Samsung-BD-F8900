...
------------------------------------*/
typedef CsrUint16        sdc_prim_t;             /* same as l2cap_prim.h */
...
typedef struct
{
    ...
    CsrUint16            con_ctx;            /* Reserved - shall be set to 0 */
    BD_ADDR_T           bd_addr;            /* Address of Bluetooth device */
                                            /* to be searched */
    CsrUint16            size_srch_pttrn;    /* size of the search pattern */
    CsrUint8             *srch_pttrn;        /* Pointer to search pattern */
                                            /* described as data element */
                                            /* sequence */
    CsrUint16            max_num_recs;       /* Maximum number of service */
...
typedef struct
{
    ...
    CsrSchedQid           phandle;        /* as supplied in REQ */
    CsrUint16            con_ctx;        /* Reserved - shall be set to 0 */
    BD_ADDR_T           bd_addr;        /* Address of Bluetooth device */
    CsrUint16            num_recs_ret;   /* Number of service records */
                                        /* returned */
    CsrUint16            size_rec_list;  /* size of the rec_list in bytes */
    CsrUint8             *rec_list;      /* Pointer to list of */
                                        /* ServiceRecordHandles */
    CsrUint16            response;       /* Indicates whether or not the */
                                        /* search was successful */
    CsrUint16            err_code;       /* Error code if one has occurred */
    CsrUint16            size_err_info;  /* size of the err_info */
    CsrUint8             *err_info;      /* Error-specific information - not*/
...
typedef struct
{
    ...
    BD_ADDR_T           bd_addr;        /* Address of Bluetooth device */
                                        /* to be searched */
    CsrUint32            svc_rec_hndl;   /* ServiceRecordHandle of */
                                        /* service being queried */
    CsrUint16            size_attr_list; /* size of the attr_list in bytes */
    CsrUint8             *attr_list;     /* Pointer to attribute list */
                                        /* described as data element */
                                        /* sequence */
...
typedef struct
{
    ...
    CsrUint16            err_code;       /* Error code if one has occurred*/
    CsrUint16            size_err_info;  /* size of the err_info */
    CsrUint8             *err_info;      /* Error-specific information - */
...
typedef struct
{
    ...
    BD_ADDR_T           bd_addr;            /* Address of Bluetooth device */
                                            /* to be searched */
    CsrUint16            size_srch_pttrn;    /* size of the search pattern - bytes */
    CsrUint8             *srch_pttrn;        /* Pointer to search pattern */
                                            /* described as data element */
                                            /* sequence */
    CsrUint16            size_attr_list;     /* size of the attr list - bytes */
    CsrUint8             *attr_list;         /* Pointer to attribute list */
                                            /* described as data element */
                                            /* sequence */
...
typedef struct
{
    ...
    CsrUint16            response;       /* Indicates whether or not the */
                                        /* search was successful */
    CsrUint16            err_code;       /* Error code if one has occurred*/
    CsrUint16            size_err_info;  /* size of the error info */
    CsrUint8             *err_info;      /* Error-specific information  */
                                        /* not used in current version */
                                        /* of spec */
...
typedef struct
{
    ...
    CsrSchedQid           phandle;  /* routing handle */
    CsrUint16            con_ctx;  /* Reserved - shall be set to 0 */
    CsrUint16            result;   /* result from open search req */
...
typedef struct
{
    ...
    CsrSchedQid           phandle;    /* routing handle */
    CsrUint16            l2cap_mtu;  /* L2CAP MTU value */
    CsrUint16            flags;      /* Bitfield - currently all bits reserved (zero) */
} SDC_CONFIG_REQ_T;
...
typedef struct
{
    ...
    CsrSchedQid           phandle;    /* routing handle */
    CsrUint16            l2cap_mtu;  /* Actual L2CAP MTU value used */
    CsrUint16            flags;      /* Bitfield - currently all bits reserved (zero) */
} SDC_CONFIG_CFM_T;
...
typedef struct
{
    ...
    CsrSchedQid           phandle;  /* routing handle */
    CsrUint16            con_ctx;  /* Reserved - shall be set to 0 */
    CsrUint16            result;   /* result connection error */
