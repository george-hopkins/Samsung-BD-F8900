...
#define CsrBtBipsPushPutImageHeaderResSend(_phandle, _imageHandle, _responseCode, _srmpOn) { \
        ...
        msg->responseCode               = _responseCode;                \
        msg->srmpOn                     = _srmpOn;                      \
        CsrStrNCpy((char*)msg->imageHandle, (char*) _imageHandle, CSR_BT_IMG_HANDLE_LENGTH); \
 ...
 *----------------------------------------------------------------------------*/
#define CsrBtBipsRcGetMonitoringImageHeaderResSend(_phandle, _responseCode, _imageHandle, _srmpOn) { \
        CsrBtBipsRcGetMonitoringImageHeaderRes *msg = (CsrBtBipsRcGetMonitoringImageHeaderRes *) CsrPmemAlloc(sizeof(CsrBtBipsRcGetMonitoringImageHeaderRes)); \
        msg->type         = CSR_BT_BIPS_RC_GET_MONITORING_IMAGE_HEADER_RES; \
        msg->responseCode = _responseCode;                              \
        msg->srmpOn       = _srmpOn;                                    \
        if(imageHandle)                                                 \
        {                                                               \
