...
//#define PTP_X6_COMPILE	/*NOTE: Delete from here and define in makefile in X6 Compilation Flag otherwise it will compilation error in VALENCIA platform*/
//#if !defined(PTP_X6_COMPILE)
#if defined(NO_INCLUDE_GPHOTO2_ENDIAN)
	//GEONAS is already included endian fct in toolchain
#else
#if !defined(PTP_PC_COMPILE)
