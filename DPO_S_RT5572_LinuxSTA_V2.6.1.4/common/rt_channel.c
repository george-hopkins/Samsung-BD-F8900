...
#ifdef CONFIG_SAMSUNG_REGULATORY_SUPPORT
CH_DESP Country_A_ChDesp[] =
{
	{ 1,   13, 20, BOTH, FALSE},	/*2402~2482MHz, Ch 1~13,   Max BW: 40 */
	{ 0},               	    	/* end*/
};

CH_DESP Country_B_ChDesp[] =
{
	{ 1,   13, 20, BOTH, FALSE},	/*2402~2482MHz, Ch 1~13,   Max BW: 40 */
	{ 36,   4, 17, BOTH, FALSE},	/* 5G band 1, ch 36~48*/
	{ 52,   4, 24, BOTH, TRUE}, 	/*5250~5330MHz, Ch 52~64, Max BW: 40 */	
	{ 100, 11, 24, BOTH, TRUE}, 	/*5490~5710MHz, Ch 100~140, Max BW: 40 */
	{ 149, 4, 30, BOTH, FALSE},	/* 5G band 4, ch 149~161*/
	{ 165, 1, 30, BOTH, FALSE},	/* 5G band 1, ch 165*/
	{ 0},               	    	/* end*/
};

CH_DESP Country_C_ChDesp[] =
{
	{ 1,   13, 20, BOTH, FALSE},	/*2402~2482MHz, Ch 1~13,   Max BW: 40 */
	{ 36,   4, 17, BOTH, FALSE},	/* 5G band 1, ch 36~48*/ 
	{ 52,   4, 23, BOTH, TRUE}, 	/*5250~5330MHz, Ch 52~64, Max BW: 40 */	
...
CH_DESP Country_F_ChDesp[] =
{
	{ 1,   13, 20, BOTH, FALSE},	/*2402~2482MHz, Ch 1~13,   Max BW: 40 */
	{ 36,   4, 21.7, BOTH, FALSE},	/* 5G band 1, ch 36~48*/
	{ 52,   4, 21.7, BOTH, TRUE}, 	/*5250~5330MHz, Ch 52~64, Max BW: 40 */	
	{ 149, 4, 21.7, BOTH, FALSE},	/* 5G band 4, ch 149~161*/
	{ 165, 1, 21.7, BOTH, FALSE},	/* 5G band 1, ch 165*/
	{ 0},               	    	/* end*/
};

CH_DESP Country_G_ChDesp[] =
{
	{ 1,   13, 27, BOTH, FALSE},	/*2402~2482MHz, Ch 1~13,   Max BW: 40 */
	{ 36,   4, 23, BOTH, FALSE},	/* 5G band 1, ch 36~48*/
	{ 52,   4, 23, BOTH, TRUE}, 	/*5250~5330MHz, Ch 52~64, Max BW: 40 */	
	{ 149, 4, 24, BOTH, FALSE},	/* 5G band 4, ch 149~161*/
	{ 0},               	    	/* end*/
};

CH_DESP Country_H_ChDesp[] =
{
	{ 1,   13, 20, BOTH, FALSE},	/*2402~2482MHz, Ch 1~13,   Max BW: 40 */
	{ 36,   4, 23, BOTH, FALSE},	/* 5G band 1, ch 36~48*/
	{ 52,   4, 23, BOTH, TRUE}, 	/*5250~5330MHz, Ch 52~64, Max BW: 40 */	
...
CH_DESP Country_I_ChDesp[] =
{
	{ 1,   13, 20, BOTH, FALSE},	/*2402~2482MHz, Ch 1~13,   Max BW: 40 */
	{ 36,   4, 20, BOTH, FALSE},	/* 5G band 1, ch 36~48*/ 
	{ 0},               	    	/* end*/
};

CH_DESP Country_J_ChDesp[] =
{
	{ 1,   13, 20, BOTH, FALSE},	/*2402~2482MHz, Ch 1~13,   Max BW: 40 */
	{ 36,   4, 23, BOTH, FALSE},	/* 5G band 1, ch 36~48*/
	{ 149, 4, 23, BOTH, FALSE},	/* 5G band 4, ch 149~161*/
	{ 165, 1, 23, BOTH, FALSE},	/* 5G band 1, ch 165*/
	{ 169, 1, 23, BOTH, FALSE},	/* 5G band 1, ch 169*/
	{ 0},               	    	/* end*/
};

CH_DESP Country_K_ChDesp[] =
{
	{ 1,   13, 20, BOTH, FALSE},	/*2402~2482MHz, Ch 1~13,   Max BW: 40 */
	{ 149, 4, 30, BOTH, FALSE},	/* 5G band 4, ch 149~161*/
	{ 165, 1, 30, BOTH, FALSE},	/* 5G band 1, ch 165*/
...
CH_DESP Country_N_ChDesp[] =
{
	{ 1,   13, 20, BOTH, FALSE},	/*2402~2482MHz, Ch 1~13,   Max BW: 40 */
	{ 149, 4, 27, BOTH, FALSE},	/* 5G band 4, ch 149~161*/
	{ 0},               	    	/* end*/
};

CH_DESP Country_O_ChDesp[] =
{
	{ 1,   13, 36, BOTH, FALSE},	/*2402~2482MHz, Ch 1~13,   Max BW: 40 */
	{ 36,   4, 23, BOTH, FALSE},	/* 5G band 1, ch 36~48*/
	{ 52,   4, 23, BOTH, TRUE}, 	/*5250~5330MHz, Ch 52~64, Max BW: 40 */	
	{ 100, 11, 30, BOTH, TRUE}, 	/*5490~5710MHz, Ch 100~140, Max BW: 40 */
	{ 149, 4, 36, BOTH, FALSE},	/* 5G band 4, ch 149~161*/
	{ 165, 1, 36, BOTH, FALSE},	/* 5G band 1, ch 165*/
	{ 0},               	    	/* end*/
};

CH_DESP Country_P_ChDesp[] =
{
	{ 1,   13, 30, BOTH, FALSE},	/*2402~2482MHz, Ch 1~13,   Max BW: 40 */
	{ 52,   4, 23, BOTH, TRUE}, 	/*5250~5330MHz, Ch 52~64, Max BW: 40 */	
	{ 100, 11, 30, BOTH, TRUE}, 	/*5490~5710MHz, Ch 100~140, Max BW: 40 */
...
CH_DESP Country_Q_ChDesp[] =
{
	{ 1,   13, 20, BOTH, FALSE},	/*2402~2482MHz, Ch 1~13,   Max BW: 40 */
	{ 36,   4, 20, BOTH, FALSE},	/* 5G band 1, ch 36~48*/
	{ 52,   4, 20, BOTH, TRUE}, 	/*5250~5330MHz, Ch 52~64, Max BW: 40 */	
	{ 100, 11, 20, BOTH, TRUE}, 	/*5490~5710MHz, Ch 100~140, Max BW: 40 */
	{ 149, 4, 20, BOTH, FALSE},	/* 5G band 4, ch 149~161*/
	{ 165, 1, 20, BOTH, FALSE},	/* 5G band 1, ch 165*/
	{ 0},               	    	/* end*/
};

CH_DESP Country_R_ChDesp[] =
{
	{ 1,   13, 20, BOTH, FALSE},	/*2402~2482MHz, Ch 1~13,   Max BW: 40 */
	{ 36,   4, 20, BOTH, FALSE},	/* 5G band 1, ch 36~48*/
	{ 52,   4, 20, BOTH, TRUE}, 	/*5250~5330MHz, Ch 52~64, Max BW: 40 */	
	...
	{ 149, 4, 30, BOTH, FALSE},	/* 5G band 4, ch 149~161*/
	{ 165, 1, 30, BOTH, FALSE},	/* 5G band 1, ch 165*/
	{ 169, 1, 30, BOTH, FALSE},	/* 5G band 1, ch 169*/
	{ 0},               	    	/* end*/
};

CH_DESP Country_S_ChDesp[] =
{
	{ 1,   11, 30, BOTH, FALSE},	/*2402~2482MHz, Ch 1~13,   Max BW: 40 */
	{ 36,   4, 17, BOTH, FALSE},	/* 5G band 1, ch 36~48*/
	{ 52,   4, 24, BOTH, TRUE}, 	/*5250~5330MHz, Ch 52~64, Max BW: 40 */	
	{ 100, 11, 24, BOTH, TRUE}, 	/*5490~5710MHz, Ch 100~140, Max BW: 40 */
	{ 149, 4, 30, BOTH, FALSE},	/* 5G band 4, ch 149~161*/
...
CH_DESP Country_T_ChDesp[] =
{
	{ 1,   14, 20, BOTH, FALSE},	/*2402~2482MHz, Ch 1~13,   Max BW: 40 */
	{ 36,   4, 23, BOTH, FALSE},	/* 5G band 1, ch 36~48*/
	{ 52,   4, 23, BOTH, TRUE}, 	/*5250~5330MHz, Ch 52~64, Max BW: 40 */	
	{ 100, 11, 23, BOTH, TRUE}, 	/*5490~5710MHz, Ch 100~140, Max BW: 40 */
	{ 0},               	    	/* end*/
...
CH_DESP Country_V_ChDesp[] =
{
	{ 1,   13, 20, BOTH, FALSE},	/*2402~2482MHz, Ch 1~13,   Max BW: 40 */
	{ 36,   4, 20, BOTH, FALSE},	/* 5G band 1, ch 36~48*/
	{ 52,   4, 20, BOTH, TRUE}, 	/*5250~5330MHz, Ch 52~64, Max BW: 40 */	
	{ 100, 7, 30, BOTH, TRUE}, 	/*5490~5710MHz, Ch 100~140, Max BW: 40 */
	{ 149, 4, 30, BOTH, FALSE},	/* 5G band 4, ch 149~161*/
	{ 0},               	    	/* end*/
};

CH_DESP Country_W_ChDesp[] =
{
	{ 1,   13, 20, BOTH, FALSE},	/*2402~2482MHz, Ch 1~13,   Max BW: 40 */
	{ 100, 11, 23, BOTH, TRUE}, 	/*5490~5710MHz, Ch 100~140, Max BW: 40 */
	{ 149, 4, 23, BOTH, FALSE},	/* 5G band 4, ch 149~161*/
...
CH_DESP Country_Z_ChDesp[] =
{
	{ 1,   13, 20, BOTH, FALSE},	/*2402~2482MHz, Ch 1~13,   Max BW: 40 */
	{ 36,   4, 23, BOTH, FALSE},	/* 5G band 1, ch 36~48*/
	{ 100, 5, 30, BOTH, TRUE}, 	/*5490~5710MHz, Ch 100~140, Max BW: 40 */
	{ 149, 3, 23, BOTH, FALSE},	/* 5G band 4, ch 149~161*/
	{ 0},               	    	/* end*/
};

CH_DESP Country_AA_ChDesp[] =
{
	{ 1,   13, 20, BOTH, FALSE},	/*2402~2482MHz, Ch 1~13,   Max BW: 40 */
	{ 36,   4, 20, BOTH, FALSE},	/* 5G band 1, ch 36~48*/
	{ 52,   4, 20, BOTH, TRUE}, 	/*5250~5330MHz, Ch 52~64, Max BW: 40 */	
...
#ifdef CONFIG_SAMSUNG_REGULATORY_SUPPORT
	{"A", CE, Country_A_ChDesp}, /* Switzerland */					
	{"B", CE, Country_B_ChDesp}, /* Syrian Arab Republic */					
	{"C", FCC,Country_C_ChDesp}, /* Taiwan */			
	{"D", CE, Country_D_ChDesp}, /* Thailand */					
	{"E", CE, Country_E_ChDesp}, /* Trinidad and Tobago */			
	{"F", CE, Country_F_ChDesp}, /* Tunisia */				
	{"G", CE, Country_G_ChDesp}, /* Turkey */					
	{"H", CE, Country_H_ChDesp}, /* Ukraine */					
	{"I", CE, Country_I_ChDesp}, /* United Arab Emirates */					
	{"J", CE, Country_J_ChDesp}, /* United Kingdom */			
	{"K", FCC,Country_K_ChDesp}, /* United States */			
	{"L", CE, Country_L_ChDesp}, /* Uruguay */					
	{"M", CE, Country_M_ChDesp}, /* Uzbekistan */				
	{"N", CE, Country_N_ChDesp}, /* Venezuela */				
	{"O", CE, Country_O_ChDesp}, /* Viet Nam */					
	{"P", CE, Country_P_ChDesp}, /* Yemen */					
	{"Q", CE, Country_Q_ChDesp}, /* Zimbabwe */	
	{"R", CE, Country_R_ChDesp}, /* Europe */
	{"S", FCC,Country_S_ChDesp}, /* North America */
	{"T", CE, Country_T_ChDesp}, /* World Wide */
	{"U", CE, Country_U_ChDesp}, /* World Wide */
	{"V", CE, Country_V_ChDesp}, /* World Wide */
	{"W", CE, Country_W_ChDesp}, /* Yemen */					
	{"X", CE, Country_X_ChDesp}, /* Zimbabwe */	
	{"Y", CE, Country_Y_ChDesp}, /* Europe */
	{"Z", FCC,Country_Z_ChDesp}, /* North America */
	{"AA", FCC,Country_AA_ChDesp}, /* North America */
	{"AB", FCC,Country_AB_ChDesp}, /* North America */
	{"AC", FCC,Country_AC_ChDesp}, /* North America */
#endif
	{""  , 0,  NULL}	     , /* End */	
};
