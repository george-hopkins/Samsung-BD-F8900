...
static bool is_rate_ht40(ULONG rate)
{
    static const ULONG ht40[] = { 135000000, 270000000, 405000000, 540000000,
    	810000000, 1080000000, 1215000000, 1350000000,
	    1500000000
    };   
    UINT i;
...
/*	if(!RTMP_TEST_FLAG(pAd, fRTMP_ADAPTER_INTERRUPT_IN_USE)) */
	...
	wrqu->bitrate.flags = 0;
	
	if (is_rate_ht40(Rate) == true)
	{
		wrqu->bitrate.flags = 1<<1;
	}
