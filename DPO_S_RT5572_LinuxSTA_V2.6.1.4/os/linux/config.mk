...
# this compile flag is use to identify P2P Customization event content,
# to Ralink wpa_supplicant. 
# Ralink wpa_supplicant need to parse related event by wpa_supplicant compile flag.
# to decide which information it needs by project requirement.
...
HAS_CONFIG_SAMSUNG_REGULATORY_SUPPORT=y

HAS_ICE_WIFI_SUPPORT=n
...
HAS_SWITCH_CHANNEL_OFFLOAD=y

HAS_RESOURCE_PRE_ALLOC=n
HAS_RESOURCE_BOOT_ALLOC=y
...
ifeq ($(HAS_CONFIG_SAMSUNG_REGULATORY_SUPPORT),y)
WFLAGS += -DCONFIG_SAMSUNG_REGULATORY_SUPPORT
endif
...
#Force Turn off NEW_MBSSID_MODE if HAS_P2P_ODD_MAC_ADJUST is on
...
ifeq ($(PLATFORM),FOXP)
EXTRA_CFLAGS :=  $(WFLAGS) -I$(RT28xx_DIR)/include
EXTRA_CFLAGS += -DDBG -DMODULE -DMODVERSIONS -D__KERNEL__ -DMSTAR_BUFSIZE_ADJUST -DMSTAR_TX_ADJUST -fno-function-sections
EXTRA_CFLAGS += -Wno-ignored-qualifiers -Wno-array-bounds -Wno-empty-body -w
endif
...
ifeq ($(PLATFORM),NVT569)
EXTRA_CFLAGS :=  $(WFLAGS) -I$(RT28xx_DIR)/include
EXTRA_CFLAGS += -DDBG -DMODULE -DMODVERSIONS -D__KERNEL__ -DMSTAR_BUFSIZE_ADJUST -DMSTAR_TX_ADJUST -DNVT569 -fno-function-sections
EXTRA_CFLAGS += -Wno-ignored-qualifiers -Wno-array-bounds -Wno-empty-body -EL -msoft-float -w
endif
