	...
	IN PNET_DEV		dev_p)
{
	...
	if (pAd->dummy_p2p_net_dev)
	{
		...
		cfg80211_disconnected(pAd->dummy_p2p_net_dev, 0, NULL, 0, GFP_KERNEL);
		synchronize_rcu();
		OPSTATUS_CLEAR_FLAG(pAd, fOP_AP_STATUS_MEDIA_STATE_CONNECTED);
...
INT CFG80211_DummyP2pIf_PacketSend(
...
#define INF_CFG80211_DUMMY_P2P_NAME "p2p"
	...
	UINT32                DevType = RT_CMD_80211_IFTYPE_STATION; //set to default!
