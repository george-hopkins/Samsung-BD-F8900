...
MODULE_PARM (mac, "s");
MODULE_PARM (CountryCode, "s");
#else
module_param (mac, charp, 0);
module_param (CountryCode, charp, 0);
#endif
MODULE_PARM_DESC (mac, "rt28xx: wireless mac addr");
MODULE_PARM_DESC (CountryCode, "Country Code");
...
/*	RTMP_IRQ_INIT(pAd); */
	...
	/* Chip & other init */
#if 1 //Country Code with module param
	if (rt28xx_init(pAd, mac, hostname, CountryCode) == FALSE)
#else
