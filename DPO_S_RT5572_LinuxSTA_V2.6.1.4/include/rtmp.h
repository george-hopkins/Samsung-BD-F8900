...
typedef ULONG ICE_WiFiChannel;
typedef UINT32 ICE_WiFiPhyNoise;
typedef UINT8 ICE_WiFiBssid[ICE_WIFI_MAC_ADDRESS_LEN];
typedef UINT32 ICE_WiFiWepIndex;
typedef ULONG ICE_WiFiKeyLength;
typedef UINT8 ICE_WiFiKey[ICE_WIFI_MAX_KEY_LEN];
typedef UINT8 ICE_WiFiSSID[ICE_WIFI_MAX_SSID_NAME_LEN];
typedef UINT8 *ICE_WiFiWPSNetIf;
