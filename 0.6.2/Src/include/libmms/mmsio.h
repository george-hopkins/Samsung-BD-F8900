...
typedef mms_off_t (*mms_io_write_func)(void *data, int socket, char *buf, mms_off_t num, int * set_stop);	/***** smins.lee : call stop, 2011-06-16 *****/
typedef mms_off_t (*mms_io_read_func)(void *data, int socket, char *buf, mms_off_t num, int * network_fail, int * set_stop);	/***** smins.lee : call stop, fallback_io_read select error, 2011-06-16 *****/
 ...
 */
typedef int (*mms_io_tcp_connect_func)(void *data, const char *host, int port, int * abort_request);	/***** smins.lee : call stop, 2011-07-18 *****/
