...
int      mms_read (mms_io_t *io, mms_t *instance, char *data, int len, int * abort_request);	/***** smins.lee : call stop, 2011-07-18 *****/
int      mms_request_time_seek (mms_io_t *io, mms_t *instance, double time_sec);
int      mms_time_seek (mms_io_t *io, mms_t *instance, double time_sec, int * abort_request);	/***** smins.lee : call stop, 2011-07-18 *****/
 ...
 */
mms_off_t mms_seek (mms_io_t *io, mms_t *instance, mms_off_t offset, int origin, int * abort_request);	/***** smins.lee : call stop, 2011-07-18 *****/
...
char * mms_get_url (mms_t * instance);	/***** smins.lee : get_url, 2011-03-25 *****/
int mms_get_network_fail (mms_t * instance);	/***** smins.lee : fallback_io_read select error, 2011-06-16 *****/
int mms_set_network_fail (mms_t * instance, int flag);	/***** smins.lee : fallback_io_read select error, 2011-06-16 *****/
